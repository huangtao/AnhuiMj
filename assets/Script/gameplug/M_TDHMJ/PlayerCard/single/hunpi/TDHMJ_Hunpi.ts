...
@ccclass
export default class TDHMJ_HunPi extends TDHMJ_SingleCardBase {
    ...
    public ShowCard(card:number):void{
        if(card==TDHMJMahjongDef.gInvalidMahjongValue){
            return;
        }
        this.ShowGreenZZ=false;//隐藏绿色遮罩
        
        let url=`gameres/gameCommonRes/Texture/Mahjong/PaiBei3/pb3_showcard_oppo_1280`;
        this.bmp_cardback.spriteFrame=TDHMJ.ins.iclass.getMahjongPaiBeiRes("pb3_showcard_oppo_1280");
