...
@ccclass
export default class MGMJ_OppoSinglePool extends MGMJ_SinglePoolBase {
    ...
    private show3DCard():void{
        ...
        switch(this._cardIndex){
            ...
            case 27:{
                ...
                this.bmp_cardHide.node.scaleY=0.35;
                this.bmp_cardHide.node.skewX=2;
                this.bmp_cardback.spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("field_oppo_27");
                this.bmp_cardcolor.spriteFrame=MGMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                break;
            }
            case 28:{
                ...
                this.bmp_cardHide.node.scaleY=0.35;
                this.bmp_cardHide.node.skewX=2.5;
                this.bmp_cardback.spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("d_pc_top_1p_03");
                this.bmp_cardcolor.spriteFrame=MGMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                break;
            }
            case 29:{
                ...
                this.bmp_cardHide.node.scaleY=0.35;
                this.bmp_cardHide.node.skewX=2.5;
                this.bmp_cardback.spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("d_pc_top_1p_02");
                this.bmp_cardcolor.spriteFrame=MGMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                break;
            }
            case 30:{
                ...
                this.bmp_cardHide.node.scaleY=0.35;
                this.bmp_cardHide.node.skewX=4;
                this.bmp_cardback.spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("d_pc_top_1p_01");
                this.bmp_cardcolor.spriteFrame=MGMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                break;
            }
        }
