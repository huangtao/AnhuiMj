...
import { enTinType, enFixedCardType } from "../ConstDef/BBMJMahjongDef";
import M_BBMJView from "../M_BBMJView";

const { ccclass, property } = cc._decorator;

	export class BBMJMahjongAlgorithm {
        ...
        public static GetMahjongLogicValue(card):number{
            return BBMJMahjongAlgorithm.GetMahjongColor(card) * 10 + BBMJMahjongAlgorithm.GetMahjongValue(card);
        }
        ...
        public static checkHaveColor(handCard: Array<number>,color:number):boolean{
            for(var i:number=0; i<handCard.length; i++){
                if(color == BBMJMahjongAlgorithm.GetMahjongColor(handCard[i])){
                    return true;
                }
            }
            return false;
        ...
        public static spiltHandCard(handCard:Array<number>,wan:Array<number>,tong:Array<number>,tiao:Array<number>,zhi:Array<number>):void{
            ...
            for(var i:number=0; i<handCard.length; i++){
                if(BBMJMahjongDef.gInvalidMahjongValue != handCard[i]){
                    switch(BBMJMahjongAlgorithm.GetMahjongColor(handCard[i])){
        ...
        public static GetLastCardToTing(srcAry:Array<number>):Array<number>{       
            ...
            //不排序，排序会打乱对应
            //BBMJMahjongAlgorithm.sortCardAry(vectorChuCard);
        }
       ...
       /// <summary>
        ...
        public static CheckIfCanTingCardArray(srcAry:Array<number>):Boolean{
            ...
            BBMJMahjongAlgorithm.sortCardAry(cardAry);
     ...
     */
        ...
        public static CheckIfTingShiSanLan(vSrc:Array<number>):boolean
        {
            ...
            BBMJMahjongAlgorithm.spiltHandCard(handCard, vWanCard, vTongCard, vTiaoCard, vZhiCard);
        ...
        private static CheckIfTingSevenPair(vSrc:Array<number>):boolean{
            ...
            BBMJMahjongAlgorithm.sortCardAry(vSrc);
