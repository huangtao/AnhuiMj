import { TDHMJ, TDHMJSoundDef } from "../ConstDef/TDHMJMahjongDef";
...
@ccclass
export default class TDHMJ_SZAni extends cc.Component {
    ...
    public playSZ(sz1:number,sz2:number,msgcode:number):void{   
        ...
        // //TDHMJ.ins.iclass.playMJSound(TDHMJSoundDef.sound_sz);
    ...
    private szComplete():void{
        ...
        if(++this._aniCompleteNum >= 2){
            ...
            console.log("骰子完毕");    
            this.node.dispatchEvent(new TDHMJEvent(this._msgCode));  
        }
    }
    public StopAni():void{
        this.unscheduleAllCallbacks();
