...
import { BBMJMahjongDef, IBBMJView, BBMJ, BBMJTableConfig, BBMJTimer, enGamePhase, BBMJOutCardPlayer, BBMJRecordCard, enBBMJAniType } from "./ConstDef/BBMJMahjongDef";
import { QL_Common } from "../../CommonSrc/QL_Common";
import { GameIF } from "../../CommonSrc/GameIF";
import M_BBMJClass from "./M_BBMJClass";
import BBMJ_ReadyStatusGameInfo from "./SkinView/BBMJ_ReadyStatusGameInfo";
import BBMJ_GameInfo from "./SkinView/BBMJ_GameInfo";
import BBMJ_ReadyStatusUserInfo from "./SkinView/BBMJ_ReadyStatusUserInfo";
...
import BBMJ_JieShuan from "./SkinView/BBMJ_JieShuan";
...
import BBMJ_DissTable from "./SkinView/BBMJ_DissTable";
import BBMJ_MsgBox from "./SkinView/BBMJ_MsgBox";
import BBMJ_Pao from "./SkinView/BBMJ_Pao";
import BBMJ_La from "./SkinView/BBMJ_La";
import BBMJ_SettingView from "./SkinView/BBMJ_SettingView";
import MJ_UserData from "../MJCommon/MJ_UserData";
import BBMJ_FenXiang from "./SkinView/BBMJ_FenXiang";
import BBMJ_Ani from "./SkinView/BBMJ_Ani";
import BBMJ_StartAni from "./SkinView/BBMJ_StartAni";

import BBMJ_OutCardView from "./SkinView/BBMJ_OutCardView";
import Global from "../../Global/Global";
import BBMJ_ReadyAndGaming from "./SkinView/BBMJ_ReadyAndGaming";
import HuDong_Animation from "../MJCommon/HuDong_Animation";
import BBMJ_Cheating from "./SkinView/BBMJ_Cheating";
import M_BBMJVoice from "./M_BBMJVoice";
import { AudioType } from "../../CustomType/Enum";
import MJ_Out from "../MJCommon/MJ_Out";

@ccclass
export default class M_BBMJView extends cc.Component implements IBBMJView {
    ...
    private static _ins: M_BBMJView;
    /**
     * BBMJView单例
     * */
    public static get ins(): M_BBMJView { return this._ins; }
    public get gameClass(): M_BBMJClass { return M_BBMJClass.ins; }
    ...
    public get GameInfo(): BBMJ_GameInfo {
        ...
        // else {
        //     cc.loader.loadRes("gameres/M_BBMJ/Prefabs/skinView/BBMJ_GameInfo", function (err, prefab) {
        //         if (err) {
        //             cc.error(err);
        //             return;
        //         }
    ...
    //准备状态时的游戏信息
    private _readyStatus_gameInfo: BBMJ_ReadyStatusGameInfo;//me
    /**
     * 准备状态游戏信息
     * */
    public get ReadyStatusGameInfo(): BBMJ_ReadyStatusGameInfo {
        return this._readyStatus_gameInfo;
    }


    // private _settingView:BBMJ_SettingView;
    // public get BBMJ_SettingView(): BBMJ_SettingView {
    ...
    // //准备状态玩家信息
    // private _readyStatus_userInfo: BBMJ_ReadyStatusUserInfo;//me
    // /**
    //  * 准备状态玩家信息
    //  * */
    // public get ReadyStatusUserInfo(): BBMJ_ReadyStatusUserInfo {
    ...
    //准备状态玩家信息
    private _rg_userInfo: BBMJ_ReadyAndGaming;//me
    /**
     * 准备状态玩家信息
     * */
    public get ReadyAndGameUserInfo(): BBMJ_ReadyAndGaming {
    ...
    public get TimerView(): BBMJ_TimerView {
      //  if (cc.isValid(this._timerView)) {
        ...
        // } else {
        //     cc.loader.loadRes("gameres/M_BBMJ/Prefabs/skinView/BBMJ_Timer3D", function (err, prefab) {
        //         if (err) {
        //             cc.error(err);
        //             return;
        //         }
    ...
    // @property(cc.Prefab)
    // BBMJ_OutCard_View: cc.Prefab = null;
    //出牌视图
    // private _outCardView: BBMJ_OutCardView;//me
    // /**
    //  * 出牌视图
    //  * */
    // public get OutCardView(): BBMJ_OutCardView {
    //     if (cc.isValid(this._outCardView)) {
    //         return this._outCardView;
    //     } else {
    //         cc.loader.loadRes("gameres/M_BBMJ/Prefabs/skinView/BBMJ_OutCardView", function (err, prefab) {
    //             if (err) {
    //                 cc.error(err);
    //                 return;
    //             }
    ...
    //                 this._outCardView = ocvnode.getComponent<BBMJ_OutCardView>(BBMJ_OutCardView);
    //                 ocvnode.zIndex = (7);
    ...
    public get OperatorView(): BBMJ_OperatorView {
        ...
        // } 
        // else {
        //     cc.loader.loadRes("gameres/M_BBMJ/Prefabs/skinView/BBMJ_OperatorView", function (err, prefab) {
        //         if (err) {
        //             cc.error(err);
        //             return;
        //         }
        ...
        //             opnode.zIndex = (9);
        //             // M_BBMJView._needDestroyNode.push(opnode);
    ...
    public get SelGangView(): BBMJ_SelGang {
        ...
        // } else {
        //     cc.loader.loadRes("gameres/M_BBMJ/Prefabs/skinView/BBMJ_SelGang", function (err, prefab) {
        //         if (err) {
        //             cc.error(err);
        //             return;
        //         }
        ...
        //             selgnode.zIndex = (10);
        //             // M_BBMJView._needDestroyNode.push(selgnode);
    ...
    // @property(cc.Prefab)
    // BBMJ_QiangGang_View: cc.Prefab=null;
    //抢杠
    ...
    public get QiangGangView(): BBMJ_QiangGangView {
        ...
        // } else {
        //     cc.loader.loadRes("gameres/M_BBMJ/Prefabs/skinView/BBMJ_QiangGangView", function (err, prefab) {
        //         if (err) {
        //             cc.error(err);
        //             return;
        //         }
        ...
        //             qianggnode.zIndex = (11);
        //             // M_BBMJView._needDestroyNode.push(qianggnode);
    ...
    @property(cc.Prefab)
    BBMJ_TingTip_View: cc.Prefab = null;
    private _tingTip: BBMJ_TingTip;
    /**
     * 听牌提示
     * */
    public get TingTip(): BBMJ_TingTip {
    ...
    @property(cc.Prefab)
    BBMJ_JieShuan_View: cc.Prefab = null;
    //结算
    private _jieShuan: BBMJ_JieShuan;//me
    /**
     * 结算视图
     * */
    public get JieShuanView(): BBMJ_JieShuan {
    ...
    // @property(cc.Prefab)
    // BBMJ_help_View: cc.Prefab = null;
    // private _help: BBMJ_HelpView;//me
    /**
     * 帮助
     * */
    // public get Help(): BBMJ_HelpView {
    //         return this._help;
    // };
    ...
    @property(cc.Prefab)
    //录音
    BBMJ_recordVideo: cc.Prefab = null;
    ...
    // @property(cc.Prefab)
    // BBMJ_DissTable_View: cc.Prefab = null;
    /**
     * 解散房间界面
     */
    private _dissTable: BBMJ_DissTable;
    /**
     * 解散房间界面
     */
    public get DissTable(): BBMJ_DissTable {
        return this._dissTable;
    }

    // @property(cc.Prefab)
    // BBMJ_MsgBox_View: cc.Prefab = null;

    private _msgBox: BBMJ_MsgBox;
    /**
     * 
     */
    public get MsgBox(): BBMJ_MsgBox {
        return this._msgBox;
    }

    // @property(cc.Prefab)
    // BBMJ_Pao_View:cc.Prefab=null;
    //跑
    private _pao: BBMJ_Pao;//me

    public get PaoView(): BBMJ_Pao {
        // if (cc.isValid(this._pao)) {
            return this._pao;
        // } else {
        //     cc.loader.loadRes("gameres/M_BBMJ/Prefabs/skinView/BBMJ_Pao", function (err, prefab) {
        //         if (err) {
        //             cc.error(err);
        //             return;
        //         }
        ...
        //             this._pao = paonode.getComponent<BBMJ_Pao>(BBMJ_Pao);
        //             paonode.zIndex = (13);
        //             // M_BBMJView._needDestroyNode.push(paonode);
    ...
    // @property(cc.Prefab)
    // BBMJ_La_View:cc.Prefab=null;
    //拉
    private _la: BBMJ_La;//me

    public get LaView(): BBMJ_La {
        // if (cc.isValid(this._la)) {
            return this._la;
        // } else {
        //     cc.loader.loadRes("gameres/M_BBMJ/Prefabs/skinView/BBMJ_La", function (err, prefab) {
        //         if (err) {
        //             cc.error(err);
        //             return;
        //         }
        ...
        //             this._la = lanode.getComponent<BBMJ_La>(BBMJ_La);
        //             lanode.zIndex = (14);
        //             // M_BBMJView._needDestroyNode.push(lanode);
    ...
    @property(cc.Prefab)
    BBMJ_UserData_View: cc.Prefab = null;
    //用户数据
    ...
    @property(cc.Prefab)
    BBMJ_FenXiang_View: cc.Prefab = null;
    //分享板
    private _fenxiang: BBMJ_FenXiang;

    public get PlayFenXiang(): BBMJ_FenXiang { return this._fenxiang }
    ...
    // @property(cc.Prefab)
    // BBMJ_Start_Ani: cc.Prefab=null;
    private _startAni: BBMJ_StartAni;
    /**
     * 帮助
     * */
    public get StartAni(): BBMJ_StartAni {
        // if (cc.isValid(this._startAni)) {
            return this._startAni;
        // } else {
        //     cc.loader.loadRes("gameres/M_BBMJ/Prefabs/skinView/BBMJ_StartAni", function (err, prefab) {
        //         if (err) {
        //             cc.error(err);
        //             return;
        //         }
        ...
        //             this._startAni = saninode.getComponent<BBMJ_StartAni>(BBMJ_StartAni);
        //             saninode.zIndex = (21);
    ...
    private _checkip:BBMJ_Cheating;
    public get CheckIp():BBMJ_Cheating{
    ...
    onLoad() {
        M_BBMJView._ins = this;
        BBMJ.ins.iview = this;
        M_BBMJView._needDestroyNode=new Array<cc.Node>();
        ...
        // this._readyStatus_gameInfo = rsgnode.getComponent<BBMJ_ReadyStatusGameInfo>(BBMJ_ReadyStatusGameInfo);
        // rsgnode.zIndex = (2);
        // // M_BBMJView._needDestroyNode.push(rsgnode);
        ...
        // this._readyStatus_userInfo = rsunode.getComponent<BBMJ_ReadyStatusUserInfo>(BBMJ_ReadyStatusUserInfo);
        // rsunode.zIndex = (3);
        // // M_BBMJView._needDestroyNode.push(rsunode);
        ...
        let cvnode = cc.instantiate(this.BBMJ_Card_View);
        this._cardView = cvnode.getComponent<BBMJ_CardView>(BBMJ_CardView);
        cvnode.zIndex = (6);
        this.group_mid.addChild(cvnode);

        // let ocvnode=cc.instantiate(this.BBMJ_OutCard_View);
        // this._outCardView=ocvnode.getComponent<BBMJ_OutCardView>(BBMJ_OutCardView);
        // ocvnode.zIndex = (7);
        // this.group_mid.addChild(ocvnode);
        ...
        // gsunode.zIndex = (8);
        // // M_BBMJView._needDestroyNode.push(gsunode);
        // this.node.addChild(gsunode);
        let rgunode = cc.instantiate(this.ReadyAndGameUserView);
        this._rg_userInfo = rgunode.getComponent<BBMJ_ReadyAndGaming>(BBMJ_ReadyAndGaming);
        rgunode.zIndex = (8);
        // M_BBMJView._needDestroyNode.push(gsunode);
        ...
        let tingtipnode = cc.instantiate(this.BBMJ_TingTip_View);
        this._tingTip = tingtipnode.getComponent<BBMJ_TingTip>(BBMJ_TingTip);
        tingtipnode.zIndex = (12);
        // M_BBMJView._needDestroyNode.push(tingtipnode);
        this.node.addChild(tingtipnode);

        // let paonode=cc.instantiate(this.BBMJ_Pao_View);
        // this._pao=paonode.getComponent<BBMJ_Pao>(BBMJ_Pao);
        // paonode.zIndex = (13);
        // // this.node.addChild(paonode);

        // let lanode=cc.instantiate(this.BBMJ_La_View);
        // this._la=lanode.getComponent<BBMJ_La>(BBMJ_La);
        // lanode.zIndex = (14);
        // // this.node.addChild(lanode);
        ...
        let recordVnode = cc.instantiate(this.BBMJ_recordVideo);
        this._recordVideo = recordVnode.getComponent<MJ_RecordVideo>(MJ_RecordVideo);
        recordVnode.zIndex = (16);
        this.node.addChild(recordVnode);

        let udnode = cc.instantiate(this.BBMJ_UserData_View);
        this._userData = udnode.getComponent<MJ_UserData>(MJ_UserData);
        udnode.zIndex = (17);
        this.node.addChild(udnode);

        // let helpnode = cc.instantiate(this.BBMJ_help_View);
        // this._help = helpnode.getComponent<BBMJ_HelpView>(BBMJ_HelpView);
        // helpnode.zIndex = (18);
        ...
        // let saninode=cc.instantiate(this.BBMJ_Start_Ani);
        // this._startAni=saninode.getComponent<BBMJ_StartAni>(BBMJ_StartAni);
        // saninode.zIndex = (21);
        // this.node.addChild(saninode);


        let jsnode = cc.instantiate(this.BBMJ_JieShuan_View);
        this._jieShuan = jsnode.getComponent<BBMJ_JieShuan>(BBMJ_JieShuan);
        jsnode.zIndex = (22);
        // M_BBMJView._needDestroyNode.push(jsnode);
        this.node.addChild(jsnode);




        // let disstablenode = cc.instantiate(this.BBMJ_DissTable_View);
        // this._dissTable = disstablenode.getComponent<BBMJ_DissTable>(BBMJ_DissTable);
        // disstablenode.zIndex = (23);
        // // M_BBMJView._needDestroyNode.push(disstablenode);
        // this.node.addChild(disstablenode);

        let fxnode = cc.instantiate(this.BBMJ_FenXiang_View);
        this._fenxiang = fxnode.getComponent<BBMJ_FenXiang>(BBMJ_FenXiang);
        fxnode.zIndex = (24);
        // M_BBMJView._needDestroyNode.push(fxnode);
        this.node.addChild(fxnode);



        // let msgboxnode = cc.instantiate(this.BBMJ_MsgBox_View);
        // this._msgBox = msgboxnode.getComponent<BBMJ_MsgBox>(BBMJ_MsgBox);
        // msgboxnode.zIndex = (26);
    ...
    public Init(): void {
        ...
        // else {
        //     cc.loader.loadRes("gameres/M_BBMJ/Prefabs/skinView/BBMJ_Ani", function (err, prefab) {
        //         if (err) {
        //             cc.error(err);
        //             return;
        //         }
    ...
    public DestroyView() {
        ...
        //销毁孤立节点
        while(M_BBMJView._needDestroyNode.length>0){
            let node = M_BBMJView._needDestroyNode.pop();
            if(cc.isValid(node)){
        ...
        //释放预制体资源
        var des= cc.loader.getDependsRecursively("gameres/M_BBMJ/Prefabs/skinView/BBMJ_GameInfo");
        cc.loader.release(des);
        var des= cc.loader.getDependsRecursively("gameres/M_BBMJ/Prefabs/skinView/BBMJ_Timer3D");
        cc.loader.release(des);
        var des= cc.loader.getDependsRecursively("gameres/M_BBMJ/Prefabs/skinView/BBMJ_SZani");
        cc.loader.release(des);
        // var des= cc.loader.getDependsRecursively("gameres/M_BBMJ/Prefabs/skinView/BBMJ_OutCardView");
        // cc.loader.release(des);
        var des= cc.loader.getDependsRecursively("gameres/M_BBMJ/Prefabs/skinView/BBMJ_OperatorView");
        cc.loader.release(des);
        var des= cc.loader.getDependsRecursively("gameres/M_BBMJ/Prefabs/skinView/BBMJ_SelGang");
        cc.loader.release(des);

        var des= cc.loader.getDependsRecursively("gameres/M_BBMJ/Prefabs/skinView/BBMJ_QiangGangView");
        cc.loader.release(des);
        var des= cc.loader.getDependsRecursively("gameres/M_BBMJ/Prefabs/skinView/BBMJ_HelpView");
        cc.loader.release(des);
        var des= cc.loader.getDependsRecursively("gameres/M_BBMJ/Prefabs/skinView/BBMJ_Pao");
        cc.loader.release(des);
        var des= cc.loader.getDependsRecursively("gameres/M_BBMJ/Prefabs/skinView/BBMJ_La");
        cc.loader.release(des);
        var des= cc.loader.getDependsRecursively("gameres/M_BBMJ/Prefabs/skinView/BBMJ_StartAni");
        cc.loader.release(des);
        var des= cc.loader.getDependsRecursively("gameres/M_BBMJ/Prefabs/skinView/BBMJ_Ani");
        cc.loader.release(des);

        //额外的销毁
        // var des= cc.loader.getDependsRecursively("gameres/M_BBMJ/Prefabs/skinView/BBMJ_CardView");
        // cc.loader.release(des);
        // var des= cc.loader.getDependsRecursively("gameres/M_BBMJ/Prefabs/skinView/BBMJ_GameStatusUserInfo");
        // cc.loader.release(des);
        var des= cc.loader.getDependsRecursively("gameres/M_BBMJ/Prefabs/skinView/BBMJ_MsgBox");
        cc.loader.release(des);
        var des= cc.loader.getDependsRecursively("gameres/M_BBMJ/Prefabs/skinView/BBMJ_ReadyStatusGameInfo");
        cc.loader.release(des);
        // var des= cc.loader.getDependsRecursively("gameres/M_BBMJ/Prefabs/skinView/BBMJ_ReadyStatusUserInfo");
        // cc.loader.release(des);
        var des= cc.loader.getDependsRecursively("gameres/M_BBMJ/Prefabs/skinView/BBMJ_SettingView");
        cc.loader.release(des);

        // var des= cc.loader.getDependsRecursively("gameres/M_BBMJ/Prefabs/skinView/BBMJ_JiFenBanX");
        // cc.loader.release(des);
        // var des= cc.loader.getDependsRecursively("gameres/M_BBMJ/Prefabs/skinView/BBMJ_JieShuan");
        // cc.loader.release(des);
        // var des= cc.loader.getDependsRecursively("gameres/M_BBMJ/Prefabs/skinView/BBMJ_FenXiang");
        // cc.loader.release(des);
        var des= cc.loader.getDependsRecursively("gameres/M_BBMJ/Prefabs/skinView/BBMJ_TingTip");
        cc.loader.release(des);
        var des= cc.loader.getDependsRecursively("gameres/M_BBMJ/Prefabs/skinView/BBMJ_TipMsg");
        cc.loader.release(des);
        var des= cc.loader.getDependsRecursively("gameres/M_BBMJ/Prefabs/skinView/BBMJ_DissTable");
        cc.loader.release(des);
    ...
    public OnButtonShare() {
        ...
        var curPlayer = M_BBMJClass.ins.getTablePlayerAry();
        let curPlayerCount:number=0;//查看当前桌上玩家数
        for(let i:number=0;i<curPlayer.length;i++){
            if(null != curPlayer[i])
                curPlayerCount++;
        }
        var selfChair = M_BBMJClass.ins.SelfChair;
        var playerName = curPlayer[selfChair].NickName;//发送邀请玩家的name

        let title : string;
        let context : string;
        let tableID : number = M_BBMJClass.ins.TableID;
        title = "蚌埠麻将 房间号:" + tableID + " "+curPlayerCount+"缺"+(4-curPlayerCount);

        let wanfa:string=  "";

        if(M_BBMJClass.ins.TableConfig.IsTableCreatorPay == 1)
            wanfa = "AA支付,";
        if(M_BBMJClass.ins.TableConfig.IsTableCreatorPay == 2)
            wanfa = "房主支付,";
        if(M_BBMJClass.ins.TableConfig.IsTableCreatorPay == 3)
            wanfa = "圈主支付,";
          if(M_BBMJClass.ins.TableConfig._MaShu == 0)
            wanfa += "东风令带花 ";
        else if(M_BBMJClass.ins.TableConfig._MaShu == 1)
            wanfa += "无花 ";
 

        if(M_BBMJClass.ins.TableConfig.IfCanHu7Dui)
            wanfa += "可点炮 ";
        if(M_BBMJClass.ins.TableConfig._isGangLeJiuYou)
            wanfa += "一炮多响 ";
        if(M_BBMJClass.ins.TableConfig._BuBuGao)
            wanfa += "步步高 ";
            
        context = "玩法:"+ wanfa + playerName + "邀请你";
        M_BBMJClass.ins.ShowShare(null,tableID,title,context);
        this.gameClass.ShowShare(0, this.gameClass.TableID,title, context);
    }
    public GetMashu():number{
        return (M_BBMJClass.ins.TableConfig._MaShu+1)*2;
    }
    ...
    private onShowMenu() {
        ...
        if (cc.isValid(this._setting)) {
            ...
            cc.loader.loadRes("gameres/M_BBMJ/Prefabs/skinView/BBMJ_SettingView", function (err, prefab) {
                if (err) {
                    cc.error(err);
                    return;
                }
    ...
    public playerComeing(): void {
        cc.log("玩家进入响应");
        this.clear();
        this.btn_recordVideo.node.active = M_BBMJClass.ins.isSelfCreateRoom;
        //this.btn_location.node.active = M_BBMJClass.ins.isSelfCreateRoom;
    ...
    public GameStart(): void {
        ...
        this._rg_userInfo.tableOwener = BBMJ.ins.iclass.getTableConfig().tableCreatorChair;
    ...
    public nextAction (): void{
        ...
        this.scheduleOnce(()=>{
            this._cardView.selfActive.refreshHandCardData(BBMJ.ins.iclass.getSelfHandCardData());
            this._cardView.selfActive.arrangeHandCard();      
            if(M_BBMJClass.ins.oncebuhua){
    ...
    private onGameEvent(e: BBMJEvent): void {
        switch (e.msgCode) {
            ...
            case BBMJEvent.msg_goongame: {
                ...
                this.GameInfo.leftCardNum = BBMJMahjongDef.gCardCount_Package;
               // this.group_gameNum.active = true;
                //如果余额够,自动发送准备
                if (M_BBMJClass.ins.checkMoneyCanGame) {
                    cc.log(`isSelfCreateRoom=${this.gameClass.isSelfCreateRoom}`);
                    cc.log(`alreadyGameNum=${M_BBMJClass.ins.TableConfig.alreadyGameNum}`);
                    cc.log(`isPlayEnoughGameNum=${M_BBMJClass.ins.TableConfig.isPlayEnoughGameNum}`);

                    if (this.gameClass.isSelfCreateRoom && (M_BBMJClass.ins.TableConfig.alreadyGameNum > 0) && !M_BBMJClass.ins.TableConfig.isPlayEnoughGameNum) {
                        // this.ReadyStatusUserInfo.OnPlayerStatusChange(M_BBMJClass.ins.SelfChair, QL_Common.GState.PlayerReady);
                        this.ReadyAndGameUserInfo.OnPlayerStatusChange(M_BBMJClass.ins.SelfChair, QL_Common.GState.PlayerReady);

                        this.gameClass.SendGameData(new M_BBMJ_GameMessage.CMD_C_NextGame());
                    } else {
                        M_BBMJClass.ins.SendUserReady();
                    }
                }
                else {
    ...
    public OnReady() {
        ...
        if (BBMJ.ins.iclass.getTableConfig().alreadyGameNum == 0) {
    ...
    public playBBMJAni(chair: number, aniType: enBBMJAniType): void {
        ...
        if (cc.isValid(this._aniPanel)) {
            switch (aniType) {
                ...
                // case enBBMJAniType.aniType_start:{
            ...
            cc.loader.loadRes("gameres/M_BBMJ/Prefabs/skinView/BBMJ_Ani", function (err, prefab) {
                ...
                if (!cc.isValid(this._aniPanel)) {
                    ...
                    this.node.addChild(aninode);
                    this._aniPanel.init();
                    this.playBBMJAni(chair, aniType);
                }else{
                    this.playBBMJAni(chair, aniType);
                }
            }.bind(this));
    ...
    public ShowChatItem(spschair:number,rechair:number,index:string){
        ...
        if(idx!=4){
           ...
           M_BBMJClass.ins.PlaySound(path,AudioType.Effect,false);
    ...
    public OnButtonExit() {
        if (!BBMJ.ins.iclass.ifCanExitGame(BBMJ.ins.iclass.getSelfChair())) {
            ...
            if (!BBMJ.ins.iclass.isVideo() && BBMJ.ins.iclass.isCreateRoom() && BBMJ.ins.iclass.getTableConfig().alreadyGameNum==0
    ...
    public StartCheckIP(msgStr:string[]):void{
        if(cc.isValid(this._checkip)){
            ...
            cc.loader.loadRes("gameres/M_BBMJ/Prefabs/skinView/BBMJ_Cheating", function (err, prefab) {
                if (err) {
                    cc.error(err);
                    return;
                }
                if (!cc.isValid(this._checkip)) {
                    ...
                    this._checkip = ipnode.getComponent<BBMJ_Cheating>(BBMJ_Cheating);
                    ipnode.zIndex = (25);
    ...
    public SZPlay(sz1:number,sz2:number,msgcode:number):void{   
        if (cc.isValid(this._szAni)) {
            ...
            cc.loader.loadRes("gameres/M_BBMJ/Prefabs/skinView/BBMJ_SZani", function (err, prefab) {
                if (err) {
                    cc.error(err);
                    return;
                }
    ...
    public ReFlashGameInfo():void{
        if(cc.isValid(this._readyStatus_gameInfo)){
            ...
            cc.loader.loadRes("gameres/M_BBMJ/Prefabs/skinView/BBMJ_ReadyStatusGameInfo", function (err, prefab) {
                if (err) {
                    cc.error(err);
                    return;
                }
    ...
    public TipMsgShow(tip: string, autoHide: boolean = true, waitTimer: number = 4): void {
        if(cc.isValid(this._tipMsg)){
            ...
            cc.loader.loadRes("gameres/M_BBMJ/Prefabs/skinView/BBMJ_TipMsg", function (err, prefab) {
                if (err) {
                    cc.error(err);
                    return;
                }
                if(!cc.isValid(this._tipMsg)){
                    ...
                    this._tipMsg = tipmsgnode.getComponent<BBMJ_TipMsg>(BBMJ_TipMsg);
                    tipmsgnode.zIndex = (19);
    ...
    public ShowMsgBox(msg: string,lbl1: string = "",fun1: () => void = null,obj1: any = null,lbl2: string = "",fun2: () => void = null,obj2: any = null,fun_close: () => void = null,obj_close: any = null):void{
        if(cc.isValid(this._msgBox)){
            ...
            cc.loader.loadRes("gameres/M_BBMJ/Prefabs/skinView/BBMJ_MsgBox", function (err, prefab) {
                if (err) {
                    cc.error(err);
                    return;
                }
     ...
     public DissTableShow(funName: string, args:any, fun?: Function): void {
        if(cc.isValid(this._dissTable)){
            ...
            cc.loader.loadRes("gameres/M_BBMJ/Prefabs/skinView/BBMJ_DissTable", function (err, prefab) {
                if (err) {
                    cc.error(err);
                    return;
                }
                if(!cc.isValid(this._dissTable)){
                    ...
                    this._dissTable = dissablenode.getComponent<BBMJ_DissTable>(BBMJ_DissTable);
                    dissablenode.zIndex = (23);
