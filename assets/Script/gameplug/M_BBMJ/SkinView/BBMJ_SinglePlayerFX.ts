...
export default class HBMJ_SinglePlayerFX extends cc.Component {
    ...
    public SetPlayer(playidx:number):void{
        ...
        this._idx = playidx;
        this.lbl_play.string = BBMJ.ins.iclass.getTablePlayerAry()[this._idx].NickName;
        this._player="ID:" + `${BBMJ.ins.iclass.getTablePlayerAry()[this._idx].PlayerID}`;
        LoadHeader(BBMJ.ins.iclass.getTablePlayerAry()[this._idx].FaceID, this.img_play);
    }
}
