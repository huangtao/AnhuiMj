        ...
        if(_jzmj.is2D()){
            ...
            if(isLie) {
                if(JZMJMahjongDef.gBackMahjongValue != card){
                    ...
                    this.bmp_liecardback.spriteFrame=_jzmj.getMahjongPaiBeiRes("shangdp_back@2x");
                    ...
                    this.bmp_liecardback.spriteFrame=_jzmj.getMahjongPaiBeiRes("shangdp_fan@2x");
                } 
                ...
                this.bmp_cardback.spriteFrame=_jzmj.getMahjongPaiBeiRes("shang_back@2x");
