...
import { TingCardTip, BBMJ } from "../ConstDef/BBMJMahjongDef";
 ...
 * */
@ccclass
export default class BBMJ_SingleTingCardTip extends cc.Component {
    ...
    protected setTexture(): void {
        cc.log("显示单个听牌！！！");
        //var sFrame = new cc.SpriteFrame(M_BBMJClass.ins.getMahjongResName(this._data.tingCard));
        //this.img_cardColor.spriteFrame = sFrame;
        cc.log(`听的牌为：${this._data.tingCard}`);
        // let url = BBMJ.ins.iclass.getMahjongResName(this._data.tingCard);
        // SetTextureRes(url,this.img_cardColor);
         this.img_cardColor.spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this._data.tingCard);
