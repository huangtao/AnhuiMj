...
export default class MGMJEvent extends cc.Event.EventCustom {


    /**
         * 消息标识
         * */
        public static MGMJ_EVENT_TYPE: string = "event_hnmj_event_type";
        ...
        public constructor(msgCode: number,parm?: any,data?: any) {
            ...
            super(MGMJEvent.MGMJ_EVENT_TYPE,true);
         ...
         * 克隆一个
         * */
        public clone(): MGMJEvent {
            return new MGMJEvent(this._msgCode,this._parm,this.getUserData());
        }
}
