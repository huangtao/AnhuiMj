import LQMJ_SingleFixedBase from "../LQMJ_SingleFixedBase";
import { enFixedCardType, LQMJ } from "../../../ConstDef/LQMJMahjongDef";
...
@ccclass
export default class LQMJ_SelfSingleFixed extends LQMJ_SingleFixedBase {
     ...
     * 显示定牌
     * */
    public showCard(card: number,fixedType: enFixedCardType,index:number,chiType:number,pos:number,_lqmj=LQMJ.ins.iclass): void {
        super.showCard(card,fixedType,index,chiType,pos,_lqmj);
        this.arrangeCard(_lqmj);
    }
    /**
     * 碰转杠
     * */
    public changePeng2Gang(card: number,_lqmj): boolean {
        if(super.changePeng2Gang(card,_lqmj)) {
            this.arrangeCard(_lqmj);
            return true;
        }
        ...
        if(_lqmj.is2D()){
            ...
            switch(this.fixedType) {
                case enFixedCardType.FixedCardType_AGang: {
                    ...
                    this.bmp_cardbackAry[0].spriteFrame=_lqmj.getMahjongPaiBeiRes("shoupaipg_back@2x");
                    this.bmp_cardbackAry[1].spriteFrame=_lqmj.getMahjongPaiBeiRes("shoupaipg_back@2x");
                    this.bmp_cardbackAry[2].spriteFrame=_lqmj.getMahjongPaiBeiRes("shoupaipg_back@2x");
                    this.bmp_cardbackAry[3].spriteFrame=_lqmj.getMahjongPaiBeiRes("shoupaipg@2x");
                    this.bmp_cardcolorAry[3].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue);
                ...
                case enFixedCardType.FixedCardType_BGang: {
                    url=`gameres/gameCommonRes/Texture/Mahjong/PaiBei3/pb3_showcard_self_1280`;
                    this.bmp_cardbackAry[0].spriteFrame=_lqmj.getMahjongPaiBeiRes("shoupaipg@2x");
                    this.bmp_cardbackAry[1].spriteFrame=_lqmj.getMahjongPaiBeiRes("shoupaipg@2x");
                    this.bmp_cardbackAry[2].spriteFrame=_lqmj.getMahjongPaiBeiRes("shoupaipg@2x");
                    this.bmp_cardbackAry[3].spriteFrame=_lqmj.getMahjongPaiBeiRes("shoupaipg@2x");
                    this.bmp_cardcolorAry[0].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue);
                    this.bmp_cardcolorAry[1].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue);
                    this.bmp_cardcolorAry[2].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue);
                    this.bmp_cardcolorAry[3].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue);
                ...
                case enFixedCardType.FixedCardType_Chi: {
                    ...
                    this.bmp_cardbackAry[1].spriteFrame=_lqmj.getMahjongPaiBeiRes("shoupaipg@2x");
                    this.bmp_cardbackAry[2].spriteFrame=_lqmj.getMahjongPaiBeiRes("shoupaipg@2x");
                    this.bmp_cardcolorAry[0].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue + this._chiType - 2);
                    this.bmp_cardcolorAry[1].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue + this._chiType - 1);
                    this.bmp_cardcolorAry[2].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue + this._chiType);
            ...
            switch(this.fixedType) {
                case enFixedCardType.FixedCardType_AGang: {
                    ...
                    if(this._cardIndex==1){
                        this.bmp_cardbackAry[0].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_self_2_17");
                        this.bmp_cardbackAry[1].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_self_2_16");
                        this.bmp_cardbackAry[2].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_self_2_15");
                        this.bmp_cardbackAry[3].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_self_1_16");
                        this.bmp_cardcolorAry[3].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue);
                    }else if(this._cardIndex==2){
                        this.bmp_cardbackAry[0].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_self_2_14");
                        this.bmp_cardbackAry[1].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_self_2_13");
                        this.bmp_cardbackAry[2].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_self_2_12");
                        this.bmp_cardbackAry[3].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_self_1_13");
                        this.bmp_cardcolorAry[3].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue);
                    }else if(this._cardIndex==3){
                        this.bmp_cardbackAry[0].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_self_2_11");
                        this.bmp_cardbackAry[1].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_self_2_10");
                        this.bmp_cardbackAry[2].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_self_2_9");
                        this.bmp_cardbackAry[3].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_self_1_10");
                        this.bmp_cardcolorAry[3].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue);
                    }else if(this._cardIndex==4){
                        this.bmp_cardbackAry[0].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_self_2_8");
                        this.bmp_cardbackAry[1].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_self_2_7");
                        this.bmp_cardbackAry[2].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_self_2_6");
                        this.bmp_cardbackAry[3].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_self_1_7");
                        this.bmp_cardcolorAry[3].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue);
                    }else{
                ...
                case enFixedCardType.FixedCardType_BGang: {
                    if(this._cardIndex==1){
                        this.bmp_cardbackAry[0].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_self_1_17");
                        this.bmp_cardbackAry[1].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_self_1_16");
                        this.bmp_cardbackAry[2].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_self_1_15");
                        this.bmp_cardbackAry[3].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_self_1_16");
                        this.bmp_cardcolorAry[0].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[1].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[2].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue);
                        ...
                        this.bmp_cardbackAry[0].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_self_1_14");
                        this.bmp_cardbackAry[1].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_self_1_13");
                        this.bmp_cardbackAry[2].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_self_1_12");
                        this.bmp_cardbackAry[3].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_self_1_13");
                        this.bmp_cardcolorAry[0].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[1].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[2].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue);
                        ...
                        this.bmp_cardbackAry[0].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_self_1_11");
                        this.bmp_cardbackAry[1].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_self_1_10");
                        this.bmp_cardbackAry[2].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_self_1_9");
                        this.bmp_cardbackAry[3].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_self_1_10");
                        this.bmp_cardcolorAry[0].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[1].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[2].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue);
                        ...
                        this.bmp_cardbackAry[0].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_self_1_8");
                        this.bmp_cardbackAry[1].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_self_1_7");
                        this.bmp_cardbackAry[2].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_self_1_6");
                        this.bmp_cardbackAry[3].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_self_1_7");
                        this.bmp_cardcolorAry[0].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[1].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[2].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue);
                ...
                case enFixedCardType.FixedCardType_Peng: {                  
                    if(this._cardIndex==1){
                        ...
                        this.bmp_cardbackAry[0].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_self_1_7");
                        this.bmp_cardbackAry[1].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_self_1_7");
                        this.bmp_cardbackAry[2].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_self_1_7");
                        this.bmp_cardcolorAry[0].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[1].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[2].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue);
                    }else{
                ...
                case enFixedCardType.FixedCardType_Chi: {                     
                    ...
                    if(this._cardIndex==1){
                        ...
                        this.bmp_cardbackAry[1].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_self_1_16");
                        this.bmp_cardbackAry[2].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_self_1_15");
                        //this.bmp_cardbackAry[3].spriteFrame=_lqmj.getMahjongPaiBeiRes("pb3_showcard_self_1280");
                        this.bmp_cardcolorAry[0].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue + this._chiType -2);
                        this.bmp_cardcolorAry[1].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue + this._chiType -1);
                        this.bmp_cardcolorAry[2].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue + this._chiType);
                    }else if(this._cardIndex==2){
    ...
    private setPos(_lqmj):void{
        if(_lqmj == LQMJ.ins.iclass && LQMJ.ins.iclass.is2D()){
