import { HQMJ, HQMJSoundDef } from "../ConstDef/HQMJMahjongDef";
...
@ccclass
export default class HQMJ_SZAni extends cc.Component {
    ...
    public playSZ(sz1:number,sz2:number,msgcode:number):void{   
        ...
        // //HQMJ.ins.iclass.playMJSound(HQMJSoundDef.sound_sz);
    ...
    private szComplete():void{
        ...
        if(++this._aniCompleteNum >= 2){
            ...
            console.log("骰子完毕");    
            this.node.dispatchEvent(new HQMJEvent(this._msgCode));  
        }
    }
    public StopAni():void{
        this.unscheduleAllCallbacks();
