...
@ccclass
export default class BBMJ_OppoVideoActive extends BBMJ_VideoActiveBase {
    ...
    //     //起始位置
    //     var startPos: number = BBMJ_OppoVideoActive.ArrangeStartPos_lie[this.fixedCardNum];
    ...
    protected refreshHandCard(): void {
        if(BBMJ.ins.iclass.is2D()){
            //起始位置
            let startPos: number = BBMJ_OppoVideoActive.ArrangeStartPos_lie[this.fixedCardNum];
            ...
            //起始位置
            let startPos: number = BBMJ_OppoVideoActive.ArrangeStartPos3D_lie[this.fixedCardNum];
            this.resetZ();
