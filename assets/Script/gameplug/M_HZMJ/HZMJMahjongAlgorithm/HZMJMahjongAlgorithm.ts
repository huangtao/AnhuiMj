...
import { enTinType, enFixedCardType } from "../ConstDef/HZMJMahjongDef";
import M_HZMJView from "../M_HZMJView";

const { ccclass, property } = cc._decorator;

	export class HZMJMahjongAlgorithm {
        ...
        public static GetMahjongLogicValue(card):number{
            return HZMJMahjongAlgorithm.GetMahjongColor(card) * 10 + HZMJMahjongAlgorithm.GetMahjongValue(card);
        }
        ...
        public static checkHaveColor(handCard: Array<number>,color:number):boolean{
            for(var i:number=0; i<handCard.length; i++){
                if(color == HZMJMahjongAlgorithm.GetMahjongColor(handCard[i])){
                    return true;
                }
            }
            return false;
        ...
        public static spiltHandCard(handCard:Array<number>,wan:Array<number>,tong:Array<number>,tiao:Array<number>,zhi:Array<number>):void{
            ...
            for(var i:number=0; i<handCard.length; i++){
                if(HZMJMahjongDef.gInvalidMahjongValue != handCard[i]){
                    switch(HZMJMahjongAlgorithm.GetMahjongColor(handCard[i])){
        ...
        public static GetLastCardToTing(srcAry:Array<number>):Array<number>{       
            ...
            //不排序，排序会打乱对应
            //HZMJMahjongAlgorithm.sortCardAry(vectorChuCard);
        }
        /**
		 * 检查是否听牌
		 */
        public static CheckIfCanTingCardArray(srcAry:Array<number>):Boolean{
            ...
            HZMJMahjongAlgorithm.sortCardAry(cardAry);
     ...
     */
        ...
        public static CheckIfTingShiSanLan(vSrc:Array<number>):boolean
        {
            ...
            HZMJMahjongAlgorithm.spiltHandCard(handCard, vWanCard, vTongCard, vTiaoCard, vZhiCard);
        ...
        private static CheckIfTingSevenPair(vSrc:Array<number>):boolean{
            ...
            HZMJMahjongAlgorithm.sortCardAry(vSrc);
