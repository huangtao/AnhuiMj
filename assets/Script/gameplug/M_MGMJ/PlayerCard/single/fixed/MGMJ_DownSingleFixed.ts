...
@ccclass
export default class MGMJ_DownSingleFixed extends MGMJ_SingleFixedBase {
        ...
        if(MGMJ.ins.iclass.is2D()){
            ...
            switch(this.fixedType) {
                case enFixedCardType.FixedCardType_AGang: {
                    ...
                    this.bmp_cardbackAry[0].spriteFrame=MGMJ.ins.iclass.getMahjongPaiBeiRes("zuoyou_back@2x");
                    this.bmp_cardbackAry[1].spriteFrame=MGMJ.ins.iclass.getMahjongPaiBeiRes("zuoyou_back@2x");
                    this.bmp_cardbackAry[2].spriteFrame=MGMJ.ins.iclass.getMahjongPaiBeiRes("zuoyou_back@2x");
                    this.bmp_cardbackAry[3].spriteFrame=MGMJ.ins.iclass.getMahjongPaiBeiRes("zuoyoupg@2x");
                ...
                case enFixedCardType.FixedCardType_BGang: {
                    url=`gameres/gameCommonRes/Texture/Mahjong/PaiBei3/pb3_showcard_left_right_1280`;
                    this.bmp_cardbackAry[0].spriteFrame=MGMJ.ins.iclass.getMahjongPaiBeiRes("zuoyoupg@2x");
                    this.bmp_cardbackAry[1].spriteFrame=MGMJ.ins.iclass.getMahjongPaiBeiRes("zuoyoupg@2x");
                    this.bmp_cardbackAry[2].spriteFrame=MGMJ.ins.iclass.getMahjongPaiBeiRes("zuoyoupg@2x");
                    this.bmp_cardbackAry[3].spriteFrame=MGMJ.ins.iclass.getMahjongPaiBeiRes("zuoyoupg@2x");
            ...
            switch(this.fixedType) {
                case enFixedCardType.FixedCardType_AGang: {                   
                    ...
                    if(this._cardIndex==1){
                        this.bmp_cardbackAry[0].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_right_2_17");
                        this.bmp_cardbackAry[1].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_right_2_16");
                        this.bmp_cardbackAry[2].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_right_2_15");
                        this.bmp_cardbackAry[3].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_right_1_16");
                        ...
                        this.bmp_cardbackAry[0].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_right_2_14");
                        this.bmp_cardbackAry[1].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_right_2_13");
                        this.bmp_cardbackAry[2].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_right_2_12");
                        this.bmp_cardbackAry[3].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_right_1_13");
                        ...
                        this.bmp_cardbackAry[0].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_right_2_11");
                        this.bmp_cardbackAry[1].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_right_2_10");
                        this.bmp_cardbackAry[2].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_right_2_9");
                        this.bmp_cardbackAry[3].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_right_1_10");
                        ...
                        this.bmp_cardbackAry[0].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_right_2_8");
                        this.bmp_cardbackAry[1].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_right_2_7");
                        this.bmp_cardbackAry[2].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_right_2_6");
                        this.bmp_cardbackAry[3].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_right_1_7");
                ...
                case enFixedCardType.FixedCardType_BGang: {
                    ...
                    if(this._cardIndex==1){
                        this.bmp_cardbackAry[0].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_right_1_17");
                        this.bmp_cardbackAry[1].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_right_1_16");
                        this.bmp_cardbackAry[2].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_right_1_15");
                        this.bmp_cardbackAry[3].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_right_1_16");
                        this.bmp_cardcolorAry[0].spriteFrame=MGMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[1].spriteFrame=MGMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[2].spriteFrame=MGMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        ...
                        this.bmp_cardbackAry[0].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_right_1_14");
                        this.bmp_cardbackAry[1].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_right_1_13");
                        this.bmp_cardbackAry[2].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_right_1_12");
                        this.bmp_cardbackAry[3].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_right_1_13");
                        this.bmp_cardcolorAry[0].spriteFrame=MGMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[1].spriteFrame=MGMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[2].spriteFrame=MGMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        ...
                        this.bmp_cardbackAry[0].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_right_1_11");
                        this.bmp_cardbackAry[1].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_right_1_10");
                        this.bmp_cardbackAry[2].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_right_1_9");
                        this.bmp_cardbackAry[3].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_right_1_10");
                        this.bmp_cardcolorAry[0].spriteFrame=MGMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[1].spriteFrame=MGMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[2].spriteFrame=MGMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        ...
                        this.bmp_cardbackAry[0].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_right_1_8");
                        this.bmp_cardbackAry[1].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_right_1_7");
                        this.bmp_cardbackAry[2].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_right_1_6");
                        this.bmp_cardbackAry[3].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_right_1_7");
                        this.bmp_cardcolorAry[0].spriteFrame=MGMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[1].spriteFrame=MGMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[2].spriteFrame=MGMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
    ...
    private setPos(type:number = 0):void{
        if(MGMJ.ins.iclass.is2D()){
            this.bmp_lightArt[0].node.x = -30;
            this.bmp_lightArt[0].node.y = 2;
            this.bmp_lightArt[1].node.x = -30;
            this.bmp_lightArt[1].node.y = 3;
            this.bmp_lightArt[2].node.x = -30;
            this.bmp_lightArt[2].node.y = 4;
            this.bmp_lightArt[0].node.rotation = 90;
            this.bmp_lightArt[1].node.rotation = 90;
            this.bmp_lightArt[2].node.rotation = 90;

        }else{
            this.bmp_lightArt[0].node.x = -30;
            this.bmp_lightArt[0].node.y = -6;
            this.bmp_lightArt[1].node.x = -30;
            this.bmp_lightArt[1].node.y = -5;
            this.bmp_lightArt[2].node.x = -30;
            this.bmp_lightArt[2].node.y = -2;
            this.bmp_lightArt[0].node.rotation = 260;
            this.bmp_lightArt[1].node.rotation = 260;
            this.bmp_lightArt[2].node.rotation =258;
        }
    }
