...
@ccclass
export default class LQMJ_OppoActive extends LQMJ_OtherActive {
    ...
    //
        ...
        if(LQMJ.ins.iclass.is2D()){
            if(this.isLie) {
                ...
                var startPos: number = LQMJ_OppoActive.ArrangeStartPos_lie[this.fixedCardNum];
                //开始排版
                ...
                //起始位置
                var startPos: number = LQMJ_OppoActive.ArrangeStartPos_stand[this.fixedCardNum];
                //开始排版
                for(var i: number = 0;i < this._cardData.length;i++) {
                    this._cardData[i].node.setLocalZOrder(i+1);
            ...
            if(this.isLie) {
            //起始位置
                let startPos: number = LQMJ_OppoActive.ArrangeStartPos3D_lie[this.fixedCardNum];
                //this.resetZ();
                ...
                //起始位置
                let startPos: number = LQMJ_OppoActive.ArrangeStartPos3D_stand[this.fixedCardNum];
