...
@ccclass
export default class BBMJ_OppoSingleActive extends BBMJ_SingleActiveBase {
    @property(cc.Sprite)
...
/**
        ...
        if(BBMJ.ins.iclass.is2D()){
            ...
            if(isLie) {
               this.HuiCardShowGreenZZ(card);
                if(BBMJMahjongDef.gBackMahjongValue != card){
                    ...
                    this.bmp_liecardback.spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("shangdp_back@2x");
                    ...
                    this.bmp_liecardback.spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("shangdp_fan@2x");
                ...
                this.bmp_cardback.spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("shang_back@2x");
                //SetTextureRes(url,this.bmp_cardback);
            ...
            if(isLie) {
                ...
                if(BBMJMahjongDef.gBackMahjongValue != card){
                    ...
                    // url=`gameres/gameCommonRes/Texture/Mahjong/PaiBei3/pb3_showcard_oppo_1280`;
                    // //url1=BBMJ.ins.iclass.getMahjongResName(card);
                    // this.bmp_liecardback.spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("pb3_showcard_oppo_1280");
                    // this.bmp_cardcolor.spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(card);
                    // //SetTextureResAry([url,url1],[this.bmp_liecardback,this.bmp_cardcolor]);
                    ...
                    // url=`gameres/gameCommonRes/Texture/Mahjong/PaiBei3/pb3_showcardback_oppo_self_1280`;
                    // this.bmp_liecardback.spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("pb3_showcardback_oppo_self_1280");
                    // //SetTextureRes(url,this.bmp_liecardback);
                    this.showDaoPai();
                } 
    ...
    //         url=`gameres/gameCommonRes/Texture/Mahjong/PaiBei3/pb3_active_oppo_1280`;
    //         // SetTextureRes(url,this.bmp_cardback);
    //         this.bmp_cardback.spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("pb3_active_oppo_1280");
    //         this.bmp_cardback.node.active=true;
    ...
    private showDaoPai():void{
        ...
        switch(this._cardIndex){
            case 1:{
                this.node.x=271.8;
                this.node.y=285;
                this.bmp_liecardback.spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_top_mj_bg_01");
            ...
            case 2:{
                this.node.x=230.8;
                this.node.y=285;
                this.bmp_liecardback.spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_top_mj_bg_02");
            ...
            case 3:{
                this.node.x=188.8;
                this.node.y=285;
                this.bmp_liecardback.spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_top_mj_bg_03");
            ...
            case 4:{
                this.node.x=145.8;
                this.node.y=285;
                this.bmp_liecardback.spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_top_mj_bg_04");
            ...
            case 5:{
                this.node.x=104.8;
                this.node.y=285;
                this.bmp_liecardback.spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_top_mj_bg_05");
            ...
            case 6:{
                this.node.x=63.8;
                this.node.y=285;
                this.bmp_liecardback.spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_top_mj_bg_06");
            ...
            case 7:{
                this.node.x=21.9;
                this.node.y=285;
                this.bmp_liecardback.spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_top_mj_bg_07");
