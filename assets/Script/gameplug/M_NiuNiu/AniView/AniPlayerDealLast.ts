...
import { StageHeight, StageWidth, PlayerCount, LastCardIndex } from "../GameHelp/GameHelp";
...
export default class AniPlayerDealLast extends cc.Component {
    ...
    public ShowAni(data: M_NiuNiu_GameMessage.CMD_S_SelectCardsStart) {
        ...
        this.index = 0;
        this.aniIndex = 0;
        //this.schedule(this.AniChild, 0.2 * NiuNiu.ins.iclass.GetSpeed());
    ...
    private DealLast(chair: number) {
        ...
        var time = 0.3 * NiuNiu.ins.iclass.GetSpeed();
