...
export default class JZMJEvent extends cc.Event.EventCustom {


    /**
         * 消息标识
         * */
        public static JZMJ_EVENT_TYPE: string = "event_hnmj_event_type";
        ...
        public constructor(msgCode: number,parm?: any,data?: any) {
            ...
            super(JZMJEvent.JZMJ_EVENT_TYPE,true);
         ...
         * 克隆一个
         * */
        public clone(): JZMJEvent {
            return new JZMJEvent(this._msgCode,this._parm,this.getUserData());
        }
}
