import AniPlayerDeal from "./BJ_AniPlayerDeal";
import { M_BiJi_GameMessage } from "../../../CommonSrc/M_BiJi_GameMessage";
import { StageWidth, StageHeight, PlayerCount, GameModel, StartMasterModel } from "../GameHelp/BJ_GameHelp";
...
export default class AniDealControl extends cc.Component {
     ...
     * 游戏开始消息
     */
    private msg_gameStart: M_BiJi_GameMessage.CMD_S_GameStart;
    ...
    public Destroy() {
        ...
        if (this.msg_gameStart != null) {
            BiJi.ins.iview.Rec_GameStart(this.msg_gameStart, true);
            this.msg_gameStart = null;
        }
    }
    /**
     * 显示动画
     */
    public ShowAni(data: M_BiJi_GameMessage.CMD_S_GameStart) {
        ...
        this.aniChair = 0;
        this.aniDealIndex = 0;
        //this.schedule(this.AniChild, 0.3 * BiJi.ins.iclass.GetSpeed());
    ...
    private AniDealOver() {
        ...
        //  //   M_BiJiView.Instance.tableInfo.startMasterModel = StartMasterModel.TableOwner
        //     var master = BiJi.ins.iclass.GetClientChair(this.msg_gameStart.master);
