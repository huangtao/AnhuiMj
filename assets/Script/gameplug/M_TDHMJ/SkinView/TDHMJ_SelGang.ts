...
@ccclass
export default class TDHMJ_SelGang extends cc.Component {
     ...
     */
    private Gang_1(){
        // this.btn_gang_0.node.dispatchEvent(new TDHMJEvent(TDHMJEvent.msg_gangCard, this._gangCard[0]));
        M_TDHMJClass.ins.OnGangSel(this._gangCard[0]);
        this.node.active = false;
    }
     ...
     */
    private Gang_2(){
        // this.btn_gang_1.node.dispatchEvent(new TDHMJEvent(TDHMJEvent.msg_gangCard, this._gangCard[1]));
        M_TDHMJClass.ins.OnGangSel(this._gangCard[1]);
        this.node.active = false;
    }
     ...
     */
    private Gang_3(){
        // this.btn_gang_0.node.dispatchEvent(new TDHMJEvent(TDHMJEvent.msg_gangCard, this._gangCard[2]));
        M_TDHMJClass.ins.OnGangSel(this._gangCard[2]);
        this.node.active = false;
    }
    ...
    public showGang(gangCard: Array<number>): void {
        ...
        for (var i: number = 0; i < gangCard.length; i++) {
            if (TDHMJMahjongDef.gInvalidMahjongValue != gangCard[i]) {
        ...
        if(2 == this._gangCard.length){
            ...
            for(var i:number = 0;i<4;i++){
                this.img_0[i].spriteFrame = TDHMJ.ins.iclass.getMahjongPaiHuaRes(this._gangCard[0]);
                this.img_1[i].spriteFrame = TDHMJ.ins.iclass.getMahjongPaiHuaRes(this._gangCard[1]);
            }                  
        }
        if(3 == this._gangCard.length){
            ...
            for(var i:number = 0;i<4;i++){
                this.img_0[i].spriteFrame = TDHMJ.ins.iclass.getMahjongPaiHuaRes(this._gangCard[0]);
                this.img_1[i].spriteFrame = TDHMJ.ins.iclass.getMahjongPaiHuaRes(this._gangCard[1]);
                this.img_2[i].spriteFrame = TDHMJ.ins.iclass.getMahjongPaiHuaRes(this._gangCard[2]);
            }
        }
        ...
        //     if(3 == this._gangCard.length){
        //         // url=TDHMJ.ins.iclass.getMahjongResName(this._gangCard[2]);
        //         // SetTextureRes(url,this.img_2);
        //    //     this.img_2.spriteFrame=TDHMJ.ins.iclass.getMahjongPaiHuaRes(this._gangCard[2]);
        //     }
        //    // this.img_0.spriteFrame=TDHMJ.ins.iclass.getMahjongPaiHuaRes(this._gangCard[0]);

        //    // this.img_1.spriteFrame=TDHMJ.ins.iclass.getMahjongPaiHuaRes(this._gangCard[1]);
        //     this.node.active = true;
        // }
    }
}
