...
@ccclass
export default class M_LQMJView extends cc.Component implements ILQMJView {
        ...
        private static _ins: M_LQMJView;
        /**
         * LQMJView单例
         * */
        public static get ins(): M_LQMJView { return this._ins; }
        public get gameClass(): M_LQMJClass { return M_LQMJClass.ins; }
        ...
        @property(cc.Prefab)
        LQMJ_SelGang_View: cc.Prefab=null;
        //选择杠
        private _selGang: LQMJ_SelGang;
        /**
         * 选择杠视图
         * */
        public get SelGangView(): LQMJ_SelGang {
            return this._selGang;
        }

        @property(cc.Prefab)
        LQMJ_SelChi_View: cc.Prefab=null;
        //选择吃
        private _selChi: LQMJ_SelChi;
        /**
         * 选择吃视图
         * */
        public get SelChiView(): LQMJ_SelChi {
            return this._selChi;
        }

         @property(cc.Prefab)
        LQMJ_BaoTing_View: cc.Prefab=null;
        //选择豹听
        private _BaoTing: LQMJ_BaoTing;
        /**
         * 选择豹听视图
         * */
        public get SelBaoTing(): LQMJ_BaoTing {
            return this._BaoTing;
        }
        
        @property(cc.Prefab)
        LQMJ_QiangGang_View: cc.Prefab=null;
        //抢杠
        private _qiangGang: LQMJ_QiangGangView;
        /**
         * 抢杠视图
         * */
        public get QiangGangView(): LQMJ_QiangGangView {
        ...
        @property(cc.Prefab)
        LQMJ_help_View: cc.Prefab=null;
        private _help:LQMJ_HelpView;//me
        /**
         * 帮助
         * */
        public get Help():LQMJ_HelpView{
            return this._help;
        };
        ...
        @property(cc.Prefab)
        //录音
        LQMJ_recordVideo: cc.Prefab=null;
        ...
        @property(cc.Prefab)
        LQMJ_Pao_View:cc.Prefab=null;
        //跑
        private _pao:LQMJ_Pao;//me

        public get PaoView():LQMJ_Pao{
            return this._pao;
        }

        @property(cc.Prefab)
        LQMJ_La_View:cc.Prefab=null;
        //拉
        private _la:LQMJ_La;//me

        public get LaView():LQMJ_La{
            return this._la;
        }
        ...
        @property(cc.Prefab)
        LQMJ_JiFenBan_View:cc.Prefab=null;
        //记分板
        private _jifenban:LQMJ_JiFenBanX;
        /**
         * 游戏记分板
         * */
        public get GameJiFenBan(): LQMJ_JiFenBanX{
        ...
        onLoad(){
            ...
            let baocnode=cc.instantiate(this.LQMJ_BaoTing_View);
            this._BaoTing=baocnode.getComponent<LQMJ_BaoTing>(LQMJ_BaoTing);
            ...
            let selcnode=cc.instantiate(this.LQMJ_SelChi_View);
            this._selChi=selcnode.getComponent<LQMJ_SelChi>(LQMJ_SelChi);
            this.node.addChild(selcnode);


            let selgnode=cc.instantiate(this.LQMJ_SelGang_View);
            this._selGang=selgnode.getComponent<LQMJ_SelGang>(LQMJ_SelGang);
            this.node.addChild(selgnode);

            let qianggnode=cc.instantiate(this.LQMJ_QiangGang_View);
            this._qiangGang=qianggnode.getComponent<LQMJ_QiangGangView>(LQMJ_QiangGangView);
            this.node.addChild(qianggnode);


            let paonode=cc.instantiate(this.LQMJ_Pao_View);
            this._pao=paonode.getComponent<LQMJ_Pao>(LQMJ_Pao);
            this.node.addChild(paonode);

            let lanode=cc.instantiate(this.LQMJ_La_View);
            this._la=lanode.getComponent<LQMJ_La>(LQMJ_La);
            ...
            let recordVnode=cc.instantiate(this.LQMJ_recordVideo);
            ...
            let helpnode=cc.instantiate(this.LQMJ_help_View);
            this._help=helpnode.getComponent<LQMJ_HelpView>(LQMJ_HelpView);
            ...
            let jfbnode=cc.instantiate(this.LQMJ_JiFenBan_View);
            this._jifenban=jfbnode.getComponent<LQMJ_JiFenBanX>(LQMJ_JiFenBanX);
            ...
            this.node.on(LQMJEvent.LQMJ_EVENT_TYPE,this.onGameEvent,this);
            ...
            //     if(0 == M_LQMJClass.ins.TableConfig.alreadyGameNum){
        ...
        public Init():void{
            ...
            //this._operatorView.node.on(LQMJEvent.LQMJ_EVENT_TYPE,this.onGameEvent,this);
            //this._selGang.node.on(LQMJEvent.LQMJ_EVENT_TYPE,this.onGameEvent,this);
            //this._cardView.node.on(LQMJEvent.LQMJ_EVENT_TYPE,this.onGameEvent,this);
            // this._qiangGang.node.on(LQMJEvent.LQMJ_EVENT_TYPE,this.onGameEvent,this);
            // this._jieShuan.node.on(LQMJEvent.LQMJ_EVENT_TYPE,this.onGameEvent,this);
            
            //this._readyStatus_userInfo.node.on(LQMJEvent.LQMJ_EVENT_TYPE,this.onGameEvent,this);
            //this._szAni.node.on(LQMJEvent.LQMJ_EVENT_TYPE,this.onGameEvent,this);
        }
        private onMap():void{
        ...
        public OnButtonShare() {
         //   this.gameClass.ShowShare(0, this.gameClass.TableID, this.gameClass.WebConfigName() + "麻将分享",LQMJ.ins.iclass.getTableConfig().shareContext);
        this.gameClass.ShowShare(0, this.gameClass.TableID, this.gameClass.WebConfigName() + "【临泉麻将】房号："+LQMJ.ins.iclass.getTableConfig().TableCode,LQMJ.ins.iclass.getTableConfig().shareContext);

        }

        private onshowSetting(e:cc.Event.EventTouch):void{
            // this._setting.showView();
            //M_LQMJClass.ins.ShowSettingForm();
     ...
     */
        ...
        //     console.log("gameview === LQMJView InitUiClass");
        //     M_LQMJView._ins = this;
        //     this._sendCardEngine = new LQMJSendCardEngine();
        //     this.TingTip;
        //     this.UserData;
        //     this.Help;
        //     this.JieShuanView;
        ...
        //     console.log("gameview === LQMJView InitGameView");
        //     super.InitGameView();
        //     this.touchEnabled = true;

        //     this.gameClass.addEventListener(LQMJEvent.LQMJ_EVENT_TYPE,this.onGameEvent,this);
        //     this._operatorView.addEventListener(LQMJEvent.LQMJ_EVENT_TYPE,this.onGameEvent,this);
        //     this._selGang.addEventListener(LQMJEvent.LQMJ_EVENT_TYPE,this.onGameEvent,this);
        //     this._cardView.addEventListener(LQMJEvent.LQMJ_EVENT_TYPE,this.onGameEvent,this);
        //     this._qiangGang.addEventListener(LQMJEvent.LQMJ_EVENT_TYPE,this.onGameEvent,this);
        //     this._jieShuan.addEventListener(LQMJEvent.LQMJ_EVENT_TYPE,this.onGameEvent,this);
        //     this._sendCardEngine.addEventListener(LQMJEvent.LQMJ_EVENT_TYPE,this.onGameEvent,this);
        //     this._readyStatus_userInfo.addEventListener(LQMJEvent.LQMJ_EVENT_TYPE,this.onGameEvent,this);
        //     this._szAni.addEventListener(LQMJEvent.LQMJ_EVENT_TYPE,this.onGameEvent,this);
        //     this._pao.addEventListener(LQMJEvent.LQMJ_EVENT_TYPE,this.onGameEvent,this);
        //     this._la.addEventListener(LQMJEvent.LQMJ_EVENT_TYPE,this.onGameEvent,this);
        ...
        //         M_LQMJClass.ins.showChat();
        //         M_LQMJView.ins.showCtlChat=true;
        //     },this);
        ...
        //     this.gameClass.removeEventListener(LQMJEvent.LQMJ_EVENT_TYPE,this.onGameEvent,this);
        //     //this._dingQue.removeEventListener(LQMJEvent.LQMJ_EVENT_TYPE,this.onGameEvent,this);
        //     this._operatorView.removeEventListener(LQMJEvent.LQMJ_EVENT_TYPE,this.onGameEvent,this);
        //     this._selGang.removeEventListener(LQMJEvent.LQMJ_EVENT_TYPE,this.onGameEvent,this);
        //     this._cardView.removeEventListener(LQMJEvent.LQMJ_EVENT_TYPE,this.onGameEvent,this);
        //     this._qiangGang.removeEventListener(LQMJEvent.LQMJ_EVENT_TYPE,this.onGameEvent,this);
        //     this._jieShuan.removeEventListener(LQMJEvent.LQMJ_EVENT_TYPE,this.onGameEvent,this);
        //     this._sendCardEngine.removeEventListener(LQMJEvent.LQMJ_EVENT_TYPE,this.onGameEvent,this);
        //     this._readyStatus_userInfo.removeEventListener(LQMJEvent.LQMJ_EVENT_TYPE,this.onGameEvent,this);
        //     this._szAni.removeEventListener(LQMJEvent.LQMJ_EVENT_TYPE,this.onGameEvent,this);
        //     this._pao.removeEventListener(LQMJEvent.LQMJ_EVENT_TYPE,this.onGameEvent,this);
        //     this._la.removeEventListener(LQMJEvent.LQMJ_EVENT_TYPE,this.onGameEvent,this);
        // }
        ...
        public playerComeing():void{
            console.log("玩家进入响应");
            this.clear();
            // this.btn_queryRecord.node.active = M_LQMJClass.ins.isSelfCreateRoom;
            this.btn_recordVideo.node.active = M_LQMJClass.ins.isSelfCreateRoom;
            this.btn_location.node.active = M_LQMJClass.ins.isSelfCreateRoom;
        ...
        public GameStart():void{
            ...
            this._gameStatus_userInfo.tableOwener = LQMJ.ins.iclass.getTableConfig().tableCreatorChair;
            this._timerView.timerNum = 0;
            this._timerView.showArrow = LQMJ.ins.iclass.getSelfChair();
            this._timerView.showArr(255,LQMJ.ins.iclass.getSelfChair());
        ...
        public StartSendCard():void{
            ...
            this.scheduleOnce(()=>{
                //  this._startAni.node.active=false;
                 this._szAni.playSZ(M_LQMJClass.ins.SZ1,M_LQMJClass.ins.SZ2,LQMJEvent.msg_holdCardSZComplete);
             },0.25);
        }
    ...
    public ShowChatItem(spschair:number,rechair:number,index:string){
        ...
        if(idx!=4){
            ...
            // if(idx == 0)
            //     M_LQMJVoice.playDaoJu("eggs.mp3");
            // if(idx == 1)
            //     M_LQMJVoice.playDaoJu("zuichun.mp3");
            // if(idx == 2)
            //     M_LQMJVoice.playDaoJu("banzhuan.mp3");
            // if(idx == 3)
            //     M_LQMJVoice.playDaoJu("zhadan.mp3");
        }else{
            this.ReadyStatusUserInfo.ShowGuZhang(spschair);
            this.GameStatusUserInfo.ShowGuZhang(spschair);
            //M_LQMJVoice.playDaoJu("guzhang.mp3");
            var path = cc.url.raw("resources/Sound/Item/guzhang.mp3");
            M_LQMJClass.ins.PlaySound(path,1,false);
        }
        // if(idx==4){
        ...
        private onGameEvent(e: LQMJEvent): void {
            switch(e.msgCode) {
                //玩家进入    
                // case LQMJEvent.msg_playerComeing: {
                //     console.log("玩家进入响应");
                //     e.stopPropagation();
                //     this.clear();
                //     // this._btn_queryRecord.visible = M_LQMJClass.ins.isSelfCreateRoom;
                //     // this._btn_recordVideo.visible = M_LQMJClass.ins.isSelfCreateRoom;
                //     this.group_gameNum.active=false;
                //     break;
                // }
                //游戏开始
                // case LQMJEvent.msg_gameStart: {
                //     this._readyStatus_gameInfo.node.active = false;
                //     this._readyStatus_userInfo.node.active = false;
                ...
                // }
                //开始发牌
                // case LQMJEvent.msg_startSendCard: {
                //     //this._startAni.Play();
                //     // egret.setTimeout(()=>{
                ...
                case LQMJEvent.msg_holdCardSZComplete: {
                    ...
                    // }
                    //this._gameInfo.holdCardOver();
                    this._cardView.selfActive.refreshHandCardData(LQMJ.ins.iclass.getSelfHandCardData());
                    this._cardView.selfActive.arrangeHandCard();
                    this._szAni.node.active = false;
                    M_LQMJClass.ins.fankai=false;
                    //  this.CardView.hunPi.ShowCard(M_LQMJClass.ins._hunPiCard);             
                    //  this.CardView.hunPi.ShowCardHaveZZ(M_LQMJClass.ins._hunPiCard);
                    //this._sendCardEngine.start(M_LQMJClass.ins.BankerChair);
                    e.stopPropagation();
                    break;
                }
                ...
                case LQMJEvent.msg_goongame: {
                    ...
                    //}else{
                        this._gameInfo.leftCardNum=LQMJMahjongDef.gCardCount_Package;
                    //}
                    ...
                    if(M_LQMJClass.ins.checkMoneyCanGame()){
                        ...
                        console.log(`alreadyGameNum=${M_LQMJClass.ins.TableConfig.alreadyGameNum}`);
                        console.log(`isPlayEnoughGameNum=${M_LQMJClass.ins.TableConfig.isPlayEnoughGameNum(M_LQMJClass.ins._addNum)}`);
                        
                        if(this.gameClass.isSelfCreateRoom && (M_LQMJClass.ins.TableConfig.alreadyGameNum > 0) && !M_LQMJClass.ins.TableConfig.isPlayEnoughGameNum(M_LQMJClass.ins._addNum)){
                            this.ReadyStatusUserInfo.OnPlayerStatusChange(M_LQMJClass.ins.SelfChair,QL_Common.GState.PlayerReady);
                            
                            this.gameClass.SendGameData(new M_LQMJ_GameMessage.CMD_C_NextGame());                       
                        }else{
                            M_LQMJClass.ins.SendUserReady();
                        }
                    }
                    // else{
                    //     this._readyStatus_userInfo.initHelpNum();
                    //     //发起求助
                    //     var tipMsg: string = `您的游戏币已经不足,无法继续游戏,共次共需要:${TranslateMoneyTypeName(LQMJ.ins.iclass.getRoomData().TableCostMoneyType)}X${M_LQMJClass.ins.gameMoneyNum},点击关闭将会返回大厅。您还可以选择：`;
                ...
                //房主
                // case LQMJEvent.msg_tableCreatorInfo:{
        ...
        public OnReady() {
            ...
            if (LQMJ.ins.iclass.getTableConfig().alreadyGameNum==0) {
        ...
        private On2d():void{//2D切换
            ...
            M_LQMJClass.ins.canvaSwitchClickEvent("2D");
        }

        private On3d():void{//3D切换
            this.btn_3d.node.active = false;
            this.btn_2d.node.active = true;
            M_LQMJClass.ins.canvaSwitchClickEvent("3D");
        }
        ...
        public playLQMJAni(chair: number,aniType: enLQMJAniType): void {
            var logicChair: number = LQMJ.ins.iclass.physical2logicChair(chair);
    ...
    public OnButtonExit() {
        if (!LQMJ.ins.iclass.ifCanExitGame(LQMJ.ins.iclass.getSelfChair())) {
            ...
            // }
            // else {
            //     M_LQMJView.ins.MsgBox.showMsgBox('是否退出霍邱麻将？', "确定", () => {
                    //打开充值
                    LQMJ.ins.iclass.exit();
            //     }, this);
            //     //LQMJ.ins.iclass.exit();
