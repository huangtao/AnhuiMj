...
@ccclass
export default class MGMJ_UpSingleFixed extends MGMJ_SingleFixedBase {
            ...
            switch(this.fixedType) {
                case enFixedCardType.FixedCardType_AGang: {                 
                    ...
                    if(this._cardIndex==1){
                        this.bmp_cardbackAry[0].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_left_2_17");
                        this.bmp_cardbackAry[1].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_left_2_16");
                        this.bmp_cardbackAry[2].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_left_2_15");
                        this.bmp_cardbackAry[3].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_left_1_16");
                        this.bmp_cardcolorAry[3].spriteFrame=MGMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        ...
                        this.bmp_cardbackAry[0].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_left_2_14");
                        this.bmp_cardbackAry[1].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_left_2_13");
                        this.bmp_cardbackAry[2].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_left_2_12");
                        this.bmp_cardbackAry[3].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_left_1_13");
                        this.bmp_cardcolorAry[3].spriteFrame=MGMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        ...
                        this.bmp_cardbackAry[0].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_left_2_11");
                        this.bmp_cardbackAry[1].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_left_2_10");
                        this.bmp_cardbackAry[2].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_left_2_9");
                        this.bmp_cardbackAry[3].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_left_1_10");
                        this.bmp_cardcolorAry[3].spriteFrame=MGMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        ...
                        this.bmp_cardbackAry[0].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_left_2_8");
                        this.bmp_cardbackAry[1].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_left_2_7");
                        this.bmp_cardbackAry[2].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_left_2_6");
                        this.bmp_cardbackAry[3].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_left_1_7");
                        this.bmp_cardcolorAry[3].spriteFrame=MGMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                ...
                case enFixedCardType.FixedCardType_MGang: {
                    if(this._cardIndex==1){
                        this.bmp_cardbackAry[0].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_left_1_17");
                        this.bmp_cardbackAry[1].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_left_1_16");
                        this.bmp_cardbackAry[2].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_left_1_15");
                        this.bmp_cardbackAry[3].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_left_1_16");
                        this.bmp_cardcolorAry[0].spriteFrame=MGMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[1].spriteFrame=MGMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[2].spriteFrame=MGMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        ...
                        this.bmp_cardbackAry[0].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_left_1_14");
                        this.bmp_cardbackAry[1].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_left_1_13");
                        this.bmp_cardbackAry[2].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_left_1_12");
                        this.bmp_cardbackAry[3].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_left_1_13");
                        this.bmp_cardcolorAry[0].spriteFrame=MGMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[1].spriteFrame=MGMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[2].spriteFrame=MGMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        ...
                        this.bmp_cardbackAry[0].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_left_1_11");
                        this.bmp_cardbackAry[1].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_left_1_10");
                        this.bmp_cardbackAry[2].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_left_1_9");
                        this.bmp_cardbackAry[3].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_left_1_10");
                        this.bmp_cardcolorAry[0].spriteFrame=MGMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[1].spriteFrame=MGMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[2].spriteFrame=MGMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        ...
                        this.bmp_cardbackAry[0].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_left_1_8");
                        this.bmp_cardbackAry[1].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_left_1_7");
                        this.bmp_cardbackAry[2].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_left_1_6");
                        this.bmp_cardbackAry[3].spriteFrame=MGMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_left_1_7");
                        this.bmp_cardcolorAry[0].spriteFrame=MGMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[1].spriteFrame=MGMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[2].spriteFrame=MGMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
    ...
    private setPos():void{
        if(MGMJ.ins.iclass.is2D()){
            this.bmp_lightArt[0].node.x = 33.3;
            this.bmp_lightArt[0].node.y = -5.7;
            this.bmp_lightArt[1].node.x = 32.8;
            this.bmp_lightArt[1].node.y = -5.5;
            this.bmp_lightArt[2].node.x = 33.2;
            this.bmp_lightArt[2].node.y = -6.7;
            this.bmp_lightArt[0].node.rotation = 90;
            this.bmp_lightArt[1].node.rotation = 90;
            this.bmp_lightArt[2].node.rotation = 90;

        }else{
            this.bmp_lightArt[0].node.x = 29.3;
            this.bmp_lightArt[0].node.y = -5.7;
            this.bmp_lightArt[1].node.x = 28.8;
            this.bmp_lightArt[1].node.y = -5.5;
            this.bmp_lightArt[2].node.x = 29.2;
            this.bmp_lightArt[2].node.y = -6.7;
            this.bmp_lightArt[0].node.rotation = 102;
            this.bmp_lightArt[1].node.rotation = 102;
            this.bmp_lightArt[2].node.rotation = 102;
        }
    }
    private set3DSize(){
