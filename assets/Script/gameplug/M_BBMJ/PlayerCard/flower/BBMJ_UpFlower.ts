...
import BBMJ_UpSingleFlower from "../single/flower/BBMJ_UpSingleFlower";

const { ccclass, property } = cc._decorator;

@ccclass
export default class BBMJ_UpFlower extends BBMJ_FlowerBase {
    ...
    protected refreshPoolCard(): {x:number,y:number} {
        ...
        // var locX:number=-425;//140是BBMJ_UpActive里面拷过来的x值(从理论上说还得加上BBMJ_UpActive里面麻将的宽度)
        ...
        if (!BBMJ.ins.iclass.is2D()) {
            ...
            for (var i: number = 0; i < this._flowerCard.length; i++) {
                this._flowerCard[i].node.x = -425;
                this._flowerCard[i].node.y = -133 + i * 26;
                this._flowerCard[i].showCard(this._cardAry[i]);
            this._flowerCard[i].bmp_cardcolor.node.skewX = 0;
            this._flowerCard[i].bmp_cardcolor.node.skewY = 0;
            this._flowerCard[i].bmp_cardcolor.node.x = 4;
            this._flowerCard[i].bmp_cardcolor.node.y = 6;
     ...
     * @param flag 第几个补花
     */
    public UpHua(up: BBMJ_UpSingleFlower, flag: number){
        switch(flag){
            case 1:
                up.node.x = -518;
                up.node.y = -164.3;
             ...
             //   up.bmp_cardback.spriteFrame = BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_bh_bg_20");
            ...
            case 2:
             ...
             //   up.node.zIndex = (19);
                ...
                up.bmp_cardback.node.height = 50;
              //  up.bmp_cardback.spriteFrame = BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_bh_bg_19");
            ...
            case 3:
              ...
              //  up.bmp_cardback.spriteFrame = BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_bh_bg_18");
            ...
            case 4:
              ...
              //  up.node.zIndex = (17);
                ...
                up.bmp_cardback.node.height = 47;
               // up.bmp_cardback.spriteFrame = BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_bh_bg_17");
            ...
            case 5:
             ...
             //   up.bmp_cardback.spriteFrame = BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_bh_bg_16");
            ...
            case 6:
              ...
              //  up.node.zIndex = (15);
                ...
                up.bmp_cardback.node.height = 46;
             //   up.bmp_cardback.spriteFrame = BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_bh_bg_15");
            ...
            case 7:
             ...
             //   up.bmp_cardback.spriteFrame = BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_bh_bg_14");
            ...
            case 8:
              ...
              //  up.node.zIndex = (13);
                ...
                up.bmp_cardback.node.height = 44;
             //   up.bmp_cardback.spriteFrame = BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_bh_bg_13");
            ...
            case 9:
             ...
             //   up.bmp_cardback.spriteFrame = BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_bh_bg_12");
            ...
            //    up.node.zIndex = (11);
                ...
                up.bmp_cardback.node.height = 43;
             //   up.bmp_cardback.spriteFrame = BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_bh_bg_11");
            ...
            //    up.node.zIndex = (10);
             ...
             //   up.bmp_cardback.spriteFrame = BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_bh_bg_10");
            ...
            case 12:
              ...
              //  up.bmp_cardback.spriteFrame = BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_bh_bg_09");
            ...
            //    up.bmp_cardback.spriteFrame = BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_bh_bg_08");
           ...
           //     up.bmp_cardback.spriteFrame = BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_bh_bg_07");
            ...
            case 15:
             ...
             //   up.node.zIndex = (6);
                ...
                up.bmp_cardback.node.height = 38;
             //   up.bmp_cardback.spriteFrame = BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_bh_bg_06");
            ...
            //    up.node.zIndex = (5);
                ...
                up.bmp_cardback.node.height = 38;
              //  up.bmp_cardback.spriteFrame = BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_bh_bg_05");
            ...
            //    up.node.zIndex = (4);
                ...
                up.bmp_cardback.node.width = 50;
                up.bmp_cardback.node.height = 38;
             //   up.bmp_cardback.spriteFrame = BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_bh_bg_04");
            ...
            case 18:
             ...
             //   up.node.zIndex = (3);
                ...
                up.bmp_cardback.node.height = 38;
              //  up.bmp_cardback.spriteFrame = BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_bh_bg_03");
            ...
            case 19:
             ...
             //   up.node.zIndex = (2);
                ...
                up.bmp_cardback.node.height = 38;
             //   up.bmp_cardback.spriteFrame = BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_bh_bg_02");
            ...
            case 20:
             ...
             //   up.node.zIndex = (1);
                ...
                up.bmp_cardback.node.height = 38;
             //   up.bmp_cardback.spriteFrame = BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_bh_bg_01");
