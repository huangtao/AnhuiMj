import { LQMJ, LQMJSoundDef } from "../ConstDef/LQMJMahjongDef";
...
@ccclass
export default class LQMJ_SZAni extends cc.Component {
    ...
    public playSZ(sz1:number,sz2:number,msgcode:number):void{   
        ...
        // //LQMJ.ins.iclass.playMJSound(LQMJSoundDef.sound_sz);
    ...
    private szComplete():void{
        ...
        if(++this._aniCompleteNum >= 2){
            ...
            console.log("骰子完毕");    
            this.node.dispatchEvent(new LQMJEvent(this._msgCode));  
        }
    }
    public StopAni():void{
        this.unscheduleAllCallbacks();
