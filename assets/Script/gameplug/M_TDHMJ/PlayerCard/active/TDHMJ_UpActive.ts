...
@ccclass
export default class TDHMJ_UpActive extends TDHMJ_OtherActive {
    ...
    protected refreshHandCard(): void {
        ...
        if(TDHMJ.ins.iclass.is2D()){
            if(this.isLie) {
            //起始位置
            var startPos: number = TDHMJ_UpActive.ArrangeStartPos_lie[this.fixedCardNum];
            ...
            //起始位置
            var startPos: number = TDHMJ_UpActive.ArrangeStartPos_stand[this.fixedCardNum];
