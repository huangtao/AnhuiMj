...
@ccclass
export default class HZMJ_DownVideoActive extends HZMJ_VideoActiveBase {
    ...
    protected refreshHandCard(): void {   
        ...
        if(HZMJ.ins.iclass.is2D()){
            //起始位置
            let startPos: number = HZMJ_DownVideoActive.ArrangeStartPos_lie[this.fixedCardNum];
            ...
            //起始位置
            let startPos: number = HZMJ_DownVideoActive.ArrangeStartPos3D_lie[this.fixedCardNum];
