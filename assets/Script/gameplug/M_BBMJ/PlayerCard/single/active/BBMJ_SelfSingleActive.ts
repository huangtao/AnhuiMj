...
@ccclass
export default class BBMJ_SelfSingleActive extends BBMJ_SingleActiveBase {
    ...
    private _selfPoint=cc.v2(0,0);
    private _touchBeginPoint=cc.v2(0,0);
    ...
    public init() {
        ...
        //this.onAdd2Stage();
        this._selfPoint = cc.v2(0,0);
        this._touchBeginPoint = cc.v2(0,0);
        this._isTouch=false;
    ...
    private onTouchBegin(e:cc.Event.EventTouch):void{
        //console.log("1111111");
        // if(M_BBMJClass.ins._canVote){
        //     this.down();
        //     return;
        // }
        //  if(!M_BBMJClass.ins.ifCanOutCardFlower(this.cardValue)){
        //     this.down();
        //    // this.node.dispatchEvent(new BBMJEvent(BBMJEvent.msg_reflashHandCard));
        //     return;

        // }
        if(M_BBMJClass.ins.ifCanOp && M_BBMJClass.ins.IfCanOutACard(this._cardValue) && cc.isValid(e)){
            this._selfPoint=cc.v2(this.node.x,this.node.y);
            this._touchBeginPoint==cc.v2(e.getLocationX(),e.getLocationY());
            this._isTouch = true;
            this._moveMax=0;
    ...
    private onTouchEnd(e:cc.Event.EventTouch):void{
        ...
        if(this._isTouch){
            ...
            if(tempY >=30 ) {
                ...
                if(M_BBMJClass.ins.ifCanOp)
                {   
                    //console.log("33333");
                    this.node.opacity=0;
                    this.down();
                    this._isValid=false;
                    this.node.dispatchEvent(new BBMJEvent(BBMJEvent.msg_outACard,this._cardValue));
    ...
    public onClick():void{
        ...
        //如果已经胡牌
        if(BBMJ.ins.iclass.isAlreadyHu()){
            return;
        }
        ...
        if(BBMJMahjongDef.gInvalidMahjongValue != this._cardValue){
            
            
                if(M_BBMJClass.ins.ifCanOp && M_BBMJClass.ins.IfCanOutACard(this._cardValue)){
                    ...
                    if(this._isUp){//如果已经站立,打出去
                        ...
                        M_BBMJClass.ins.showHideCard(this._cardValue);
                        if(this._ifCanTingAfterOutThisCard) {
                            //显示听牌
                            M_BBMJClass.ins.showTingCard(this.cardValue,this.node.x,false);
                        }else{
    ...
    //   this.bmp_cardback.spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("pb3_backcard_self_1280");
     if(BBMJ.ins.iclass.is2D()){
            this.bmp_cardback.spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("shoupaipg_back@2x");
        }
        else{
            this.bmp_cardback.spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("b_btm_self_mj_bg");
        }
        ...
        if(BBMJ.ins.iclass.is2D()){
           // this.HuiCardShowGreenZZ(card);
            ...
            if(isLie){
                ...
                //url1=BBMJ.ins.iclass.getMahjongResName(card);
                this.bmp_cardback.spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("shoupai2@2x");
                this.bmp_cardcolor.spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(card);
                //SetTextureResAry([url,url1],[this.bmp_cardback,this.bmp_cardcolor]);
                this.bmp_cardback.node.width=92;
                this.bmp_cardback.node.height=132;
        ...
        //    this.HuiCardShowGreenZZ(card);
            ...
            if(isLie){
                ...
                if(BBMJMahjongDef.gBackMahjongValue != card){
                    ...
                    // url=`gameres/gameCommonRes/Texture/Mahjong/PaiBei3/pb3_showcard_self_1280`;
                    // //url1=BBMJ.ins.iclass.getMahjongResName(card);
                    // this.bmp_cardback.spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("pb3_showcard_self_1280");
                    // this.bmp_cardcolor.spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(card);
                    // //SetTextureResAry([url,url1],[this.bmp_cardback,this.bmp_cardcolor]);
                    // //this.bmp_cardcolor.node.x = 0;//9;
                    ...
                    url=`gameres/gameCommonRes/Texture/Mahjong/PaiBei3/pb3_backcard_self_1280`;
                    this.bmp_cardback.spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("s_top_self_showcardback_bg");
                    //SetTextureRes(url,this.bmp_cardback);
                    //this._bmp_cardback.texture = <egret.Texture>RES.getRes(switchResName("xzmj_backcard_self_png"));
                    this.bmp_cardback.node.active = true;
                    this.bmp_cardcolor.node.active=false;
                ...
                // SetTextureRes(url,this.bmp_cardcolor);
                //url1=BBMJ.ins.iclass.getMahjongResName(card);
                this.bmp_cardback.spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("s_btm_self_mj_bg");
                this.bmp_cardcolor.spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(card);
                //SetTextureResAry([url,url1],[this.bmp_cardback,this.bmp_cardcolor]);
                this.bmp_cardcolor.node.width=68;
                this.bmp_cardcolor.node.height=97;    
    ...
    private showSelfDaoPai():void{
        ...
        switch(this._cardIndex){
            case 1:{
                this.node.x=-514;
                this.node.y=-298;
                this.bmp_cardback.spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_btm_mj_bg_01");
            ...
            case 2:{
                this.node.x=-434;
                this.node.y=-298;
                this.bmp_cardback.spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_btm_mj_bg_02");
            ...
            case 3:{
                this.node.x=-354;
                this.node.y=-298;
                this.bmp_cardback.spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_btm_mj_bg_03");
            ...
            case 5:{
                this.node.x=-196;
                this.node.y=-298;
                this.bmp_cardback.spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_btm_mj_bg_05");
            ...
            case 6:{
                this.node.x=-118;
                this.node.y=-298;
                this.bmp_cardback.spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_btm_mj_bg_06");
            ...
            case 7:{
                this.node.x=-39;
                this.node.y=-298;
                this.bmp_cardback.spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_btm_mj_bg_07");
