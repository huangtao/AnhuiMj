...
@ccclass
export default class MGMJ_UpActive extends MGMJ_OtherActive {
    ...
    protected refreshHandCard(): void {
        ...
        if(MGMJ.ins.iclass.is2D()){
            if(this.isLie) {
            //起始位置
            var startPos: number = MGMJ_UpActive.ArrangeStartPos_lie[this.fixedCardNum];
            ...
            //起始位置
            var startPos: number = MGMJ_UpActive.ArrangeStartPos_stand[this.fixedCardNum];
