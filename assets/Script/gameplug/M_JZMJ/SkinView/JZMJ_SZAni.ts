import { JZMJ, JZMJSoundDef } from "../ConstDef/JZMJMahjongDef";
...
@ccclass
export default class JZMJ_SZAni extends cc.Component {
    ...
    public playSZ(sz1:number,sz2:number,msgcode:number):void{   
        ...
        // //JZMJ.ins.iclass.playMJSound(JZMJSoundDef.sound_sz);
    ...
    private szComplete():void{
        ...
        if(++this._aniCompleteNum >= 2){
            ...
            console.log("骰子完毕");    
            this.node.dispatchEvent(new JZMJEvent(this._msgCode));  
        }
    }
    public StopAni():void{
        this.unscheduleAllCallbacks();
