...
import { TingCardTip, JZMJ } from "../ConstDef/JZMJMahjongDef";
 ...
 * */
@ccclass
export default class JZMJ_SingleTingCardTip extends cc.Component {
    ...
    protected setTexture(): void {
        // cc.log("显示单个听牌！！！"); 
        // var sFrame = new cc.SpriteFrame(M_JZMJClass.ins.getMahjongResName(this._data.tingCard));
