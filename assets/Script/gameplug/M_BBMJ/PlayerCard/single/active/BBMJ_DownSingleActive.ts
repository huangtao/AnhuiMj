...
@ccclass
export default class BBMJ_DownSingleActive extends BBMJ_SingleActiveBase {
    @property(cc.Sprite)
    ...
    //         if(BBMJMahjongDef.gBackMahjongValue != card){
           
    //             // url=`gameres/gameCommonRes/Texture/Mahjong/PaiBei3/pb3_showcard_left_right_1280`;
    //             // url1=BBMJ.ins.iclass.getMahjongResName(card);
    //             url=`gameres/gameCommonRes/Texture/Mahjong/PaiBei3/pb3_showcard_left_right_1280`;
    //               this.bmp_liecardback.spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("pb3_showcard_left_right_1280");
    ...
    //             url=`gameres/gameCommonRes/Texture/Mahjong/PaiBei3/pb3_showcardback_left_right_1280`;
    //             // SetTextureRes(url,this.bmp_liecardback);
    //             this.bmp_liecardback.spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("pb3_showcardback_left_right_1280");
    //         }
            
    //         this.bmp_liecardback.node.active=true;
    //         this.bmp_cardcolor.node.active = BBMJMahjongDef.gBackMahjongValue != card;
    ...
    //           url=`gameres/gameCommonRes/Texture/Mahjong/PaiBei3/pb3_active_right_1280`;
    //         // SetTextureRes(url,this.bmp_cardback);
    //         this.bmp_cardback.spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("pb3_active_right_1280");
    //         this.bmp_cardback.node.active=true;
    //         //this.bmp_cardcolor.node.active=false;
        ...
        if(BBMJ.ins.iclass.is2D()){
            ...
            if(isLie) {
                if(BBMJMahjongDef.gBackMahjongValue != card){
                    ...
                    url=`gameres/gameCommonRes/Texture/Mahjong/PaiBei3/pb3_showcard_left_right_1280`;
                    //url1=BBMJ.ins.iclass.getMahjongResName(card);
                    this.bmp_liecardback.spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("zuoyoupg@2x");
                    this.bmp_cardcolor.spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(card);
                    //SetTextureResAry([url,url1],[this.bmp_liecardback,this.bmp_cardcolor]);
                    // this.bmp_cardcolor.node.x = 0;
                    ...
                    url=`gameres/gameCommonRes/Texture/Mahjong/PaiBei3/pb3_showcardback_left_right_1280`;
                    this.bmp_liecardback.spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("zuoyou_back@2x");
                ...
                url=`gameres/gameCommonRes/Texture/Mahjong/PaiBei3/pb3_active_right_1280`;
                cc.log("显示下家");
                this.bmp_cardback.spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("you_pai@2x");
                //SetTextureRes(url,this.bmp_cardback);
                this.bmp_cardback.node.active=true;
                //this.bmp_cardcolor.node.active=false;
            }
     ...
     private showShuPai():void{
        ...
        switch(this._cardIndex){
            case 1:{
                this.node.x=467;
                this.node.y=40;
                this.bmp_cardback.spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("s_left_mj_bg_01");
            ...
            case 2:{
                this.node.x=477.5;
                this.node.y=20;
                this.bmp_cardback.spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("s_left_mj_bg_02");
            ...
            case 3:{
                this.node.x=481.5;
                this.node.y=20;
                this.bmp_cardback.spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("s_left_mj_bg_03");
            ...
            case 4:{
                this.node.x=485.5;
                this.node.y=20;
                this.bmp_cardback.spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("s_left_mj_bg_04");
            ...
            case 5:{
                this.node.x=490;
                this.node.y=20;
                this.bmp_cardback.spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("s_left_mj_bg_05");
            ...
            case 6:{
                this.node.x=494.5;
                this.node.y=20;
                this.bmp_cardback.spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("s_left_mj_bg_06");
            ...
            case 7:{
                this.node.x=498.5;
                this.node.y=20;
                this.bmp_cardback.spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("s_left_mj_bg_07");
            ...
            case 8:{
                this.node.x=502.5;
                this.node.y=20;
                this.bmp_cardback.spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("s_left_mj_bg_08");
            ...
            case 9:{
                this.node.x=507;
                this.node.y=20;
                this.bmp_cardback.spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("s_left_mj_bg_09");
            ...
            case 10:{
                this.node.x=511.5;
                this.node.y=20;
                this.bmp_cardback.spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("s_left_mj_bg_10");
            ...
            case 11:{
                this.node.x=516.5;
                this.node.y=20;
                this.bmp_cardback.spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("s_left_mj_bg_11");
            ...
            case 12:{
                this.node.x=521;
                this.node.y=20;
                this.bmp_cardback.spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("s_left_mj_bg_12");
            ...
            case 13:{
                this.node.x=525.5;
                this.node.y=20;
                this.bmp_cardback.spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("s_left_mj_bg_13");
            ...
            case 14:{
                this.node.x=530.5;
                this.node.y=20;
                this.bmp_cardback.spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("s_left_mj_bg_14");
        ...
        switch(this._cardIndex){
            case 1:{
                this.node.x=444;
                this.node.y=295;
                this.bmp_liecardback.spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_mj_bg_01");
                this.bmp_liecardback.node.width=59;
                this.bmp_liecardback.node.height=42;
                this.bmp_liecardback.node.scaleX=-1;
                this.bmp_cardcolor.spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this._cardValue);
            ...
            case 2:{
                this.node.x=456;
                this.node.y=255;
                this.bmp_liecardback.spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_mj_bg_02");
            ...
            case 3:{
                this.node.x=463.7;
                this.node.y=227;
                this.bmp_liecardback.spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_mj_bg_03");
                this.bmp_liecardback.node.width=60;
                this.bmp_liecardback.node.height=45;
                this.bmp_liecardback.node.scaleX=-1;
                this.bmp_cardcolor.spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this._cardValue);
            ...
            case 4:{
                this.node.x=473;
                this.node.y=199.5;
                this.bmp_liecardback.spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_mj_bg_04");
            ...
            case 5:{
                this.node.x=482.3;
                this.node.y=172;
                this.bmp_liecardback.spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_mj_bg_05");
            ...
            case 6:{
                this.node.x=490.5;
                this.node.y=144;
                this.bmp_liecardback.spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_mj_bg_06");
                this.bmp_liecardback.node.width=63;
                this.bmp_liecardback.node.height=47;
                this.bmp_liecardback.node.scaleX=-1;
                this.bmp_cardcolor.spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this._cardValue);
            ...
            case 7:{
                this.node.x=500.3;
                this.node.y=115.3;
                this.bmp_liecardback.spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_mj_bg_07");
            ...
            case 8:{
                this.node.x=508.8;
                this.node.y=85.6;
                this.bmp_liecardback.spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_mj_bg_08");
            ...
            case 9:{
                this.node.x=518.2;
                this.node.y=55.3;
                this.bmp_liecardback.spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_mj_bg_09");
            ...
            case 10:{
                this.node.x=529.1;
                this.node.y=24;
                this.bmp_liecardback.spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_mj_bg_10");
            ...
            case 11:{
                this.node.x=539;
                this.node.y=-8;
                this.bmp_liecardback.spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_mj_bg_11");
            ...
            case 12:{
                this.node.x=549.7;
                this.node.y=-40;
                this.bmp_liecardback.spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_mj_bg_12");
            ...
            case 13:{
                this.node.x=560.4;
                this.node.y=-73;
                this.bmp_liecardback.spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_mj_bg_13");
            ...
            case 14:{
                this.node.x=572;
                this.node.y=-106.7;
                this.bmp_liecardback.spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_mj_bg_14");
