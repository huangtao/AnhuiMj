...
@ccclass
export default class TDHMJ_SelChi extends cc.Component {
    ...
    private Chi_1(){
        ...
        M_TDHMJClass.ins.OnChiSel(this.chiNum,this.chiSel);      
        this.node.active = false;
    }
    /**
     * 吃2
    ...
    public showChi(countChi: number,leftChi:boolean,midChi:boolean,rightChi:boolean,card:number): void {
        ...
        if(2 == countChi){
            ...
            //吃牌赋值
            if(!leftChi){//中 右
                this.img_0[0].spriteFrame=TDHMJ.ins.iclass.getMahjongPaiHuaRes(card-1);
                this.img_0[1].spriteFrame=TDHMJ.ins.iclass.getMahjongPaiHuaRes(card);
                this.img_0[2].spriteFrame=TDHMJ.ins.iclass.getMahjongPaiHuaRes(card+1);

                this.img_1[0].spriteFrame=TDHMJ.ins.iclass.getMahjongPaiHuaRes(card);
                this.img_1[1].spriteFrame=TDHMJ.ins.iclass.getMahjongPaiHuaRes(card+1);
                this.img_1[2].spriteFrame=TDHMJ.ins.iclass.getMahjongPaiHuaRes(card+2);
            }
            if(!midChi){//左 右
                this.img_0[0].spriteFrame=TDHMJ.ins.iclass.getMahjongPaiHuaRes(card-2);
                this.img_0[1].spriteFrame=TDHMJ.ins.iclass.getMahjongPaiHuaRes(card-1);
                this.img_0[2].spriteFrame=TDHMJ.ins.iclass.getMahjongPaiHuaRes(card);
            ...
            if(!rightChi){//左 中
                ...
                this.img_1[0].spriteFrame=TDHMJ.ins.iclass.getMahjongPaiHuaRes(card-1);
                this.img_1[1].spriteFrame=TDHMJ.ins.iclass.getMahjongPaiHuaRes(card);
                this.img_1[2].spriteFrame=TDHMJ.ins.iclass.getMahjongPaiHuaRes(card+1);
            }   
        }
        //三种吃法
        if(3 == countChi){
            ...
            this.img_1[2].spriteFrame=TDHMJ.ins.iclass.getMahjongPaiHuaRes(card+1);
            //右
            this.img_2[0].spriteFrame=TDHMJ.ins.iclass.getMahjongPaiHuaRes(card);
            this.img_2[1].spriteFrame=TDHMJ.ins.iclass.getMahjongPaiHuaRes(card+1);
            this.img_2[2].spriteFrame=TDHMJ.ins.iclass.getMahjongPaiHuaRes(card+2);
        }
