...
export default class HZMJEvent extends cc.Event.EventCustom {


    /**
         * 消息标识
         * */
        public static HZMJ_EVENT_TYPE: string = "event_hnmj_event_type";
        ...
        public constructor(msgCode: number,parm?: any,data?: any) {
            ...
            super(HZMJEvent.HZMJ_EVENT_TYPE,true);
         ...
         * 克隆一个
         * */
        public clone(): HZMJEvent {
            return new HZMJEvent(this._msgCode,this._parm,this.getUserData());
        }
}
