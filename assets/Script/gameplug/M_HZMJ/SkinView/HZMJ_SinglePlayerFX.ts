...
export default class HBMJ_SinglePlayerFX extends cc.Component {
    ...
    public SetPlayer(playidx:number):void{
        ...
        this._idx = playidx;
        this.lbl_play.string = HZMJ.ins.iclass.getTablePlayerAry()[this._idx].NickName;
        this._player="ID:" + `${HZMJ.ins.iclass.getTablePlayerAry()[this._idx].PlayerID}`;
        LoadHeader(HZMJ.ins.iclass.getTablePlayerAry()[this._idx].FaceID, this.img_play);
    }
}
