...
const { ccclass, property } = cc._decorator;
    ...
    export interface IBBMJClass {
        ...
        getTableConfig():BBMJTableConfig;
    ...
    export class BBMJ{
        ...
        private static _ins:BBMJ=null;
        private _icalss:IBBMJClass=null;
        private _iview:IBBMJView=null;
         ...
         * 逻辑
         * */
        public get iclass():IBBMJClass{
            return this._icalss;
        }
        public set iclass(value:IBBMJClass){
            this._icalss = value;
        }
         ...
         * 视图
         * */
        public get iview():IBBMJView{
            return this._iview;
        }
        public set iview(value:IBBMJView){
            this._iview = value;
        }
    }


	export class BBMJMahjongDef {

        public static gameID:number=106;
        /// <summary>
        /// 花色掩码
        /// </summary>
        ...
        public static gCardWalls_number:number = 34;
        /// <summary>
        /// 无效的麻将牌数值
        /// </summary>
    ...
    export class BBMJTableConfig{
        ...
        public constructor(){    
            ...
            this._tableCreatorChair = BBMJMahjongDef.gInvalidChar;
            this._tableCode = "";
            this._setGameNum=1;
        ...
        public get cellScore():number{
            if(BBMJ.ins.iclass.isCreateRoom()){
             ...
             if(BBMJ.ins.iclass.getRoomData()){
                return BBMJ.ins.iclass.getRoomData().BaseMoney;
            }
            else{
    ...
    export class BBMJTimer{
        ...
        public clear():void{
            ...
            this._curTime=0;
            this._triggerTime=0;
            this._chair = BBMJMahjongDef.gInvalidChar;
     ...
     * 合肥麻将打牌玩家
     * */
    export class BBMJOutCardPlayer{
        private _chair:number;
         ...
         * */
        public get isValid():boolean{
            if((BBMJMahjongDef.gInvalidChar != this._chair) && (BBMJMahjongDef.gInvalidMahjongValue != this._card)){
                return true;
            }
            return false;
        }
        ...
        public clear():void{
            this._chair = BBMJMahjongDef.gInvalidChar;
            this._card = BBMJMahjongDef.gInvalidMahjongValue;
        }
    }
    ...
    export class BBMJRecordCard{
        ...
        public getCardLeftNum(card:number,checkAry:Array<number> = null):number{
            var logicValue: number = BBMJMahjongAlgorithm.GetMahjongLogicValue(card);
    ...
    export class clsParseTriple
    {
        ...
        public Clear():void
        {
            this.cTokenCard = BBMJMahjongDef.gInvalidMahjongValue;
        ...
        public GetTokenNum():number
        {
            ...
            return (wBaseNum + BBMJMahjongAlgorithm.GetMahjongLogicValue(this.cTokenCard));
        }
        ...
        public get isValid():boolean
        {
                if ((BBMJMahjongDef.gInvalidMahjongValue != this.cTokenCard) && (enTripleType.TripleType_Unknown != this.enTripleType)){
                    return true;
                }
                return false;
        }
   ...
   /// <summary>
    ...
    export class clsNormalParseStruct
    {
        ...
        public Clear():void
        {
            this.pair = BBMJMahjongDef.gInvalidMahjongValue;
        ...
        public get isValid():boolean
        {
            ...
            return this.pair != BBMJMahjongDef.gInvalidMahjongValue;
    ...
    export class clsParseResult
    {
        ...
        public Clear():void
        {
            this.isValid = false;
            this.is7Pair = false;
            this.huCard = BBMJMahjongDef.gInvalidMahjongValue;
    ...
    export class clsSingleFixedCard
    {
	    ...
	    public Clear():void
	    {
            this.card = BBMJMahjongDef.gInvalidMahjongValue;
    ...
    export class clsPairTripleWrapper
    {
        ...
        public Clear():void
        {
            this.cPair = BBMJMahjongDef.gInvalidMahjongValue;
            this.wTripleCount = 0;
    ...
    //                 return false;
    //             }
    //             if (BBMJMahjongDef.gMahjongColor_Zhi == BBMJMahjongAlgorithm1.GetMahjongColor(this.cTokenCard))
    //             {
    //                 return false;
    //             }
    //             for (var i = 0; i < this.cCardAry.length; i++)
    //             {
    //                 if ((1 == BBMJMahjongAlgorithm.GetMahjongValue(this.cCardAry[i])) || (9 == BBMJMahjongAlgorithm1.GetMahjongValue(this.cCardAry[i])))
    //                 {
    //                     return true;
    //                 }
    //             }
