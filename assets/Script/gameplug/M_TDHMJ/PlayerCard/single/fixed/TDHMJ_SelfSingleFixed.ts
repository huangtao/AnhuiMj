import TDHMJ_SingleFixedBase from "../TDHMJ_SingleFixedBase";
...
@ccclass
export default class TDHMJ_SelfSingleFixed extends TDHMJ_SingleFixedBase {
     ...
     * 显示定牌
     * */
    public showCard(card: number,fixedType: enFixedCardType,index:number,chiType:number,pos:number,_lqmj=TDHMJ.ins.iclass): void {
    ...
    private setPos(_lqmj):void{
        if(_lqmj == TDHMJ.ins.iclass && TDHMJ.ins.iclass.is2D()){
