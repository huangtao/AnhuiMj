...
export default class JZMJ_SelfSingleFixed extends JZMJ_SingleFixedBase {
    ...
    protected arrangeCard(_jzmj){
        ...
        if(_jzmj.is2D()){
            ...
            for(let i=0;i<4;i++){
                ...
                this.bmp_cardcolorAry[i].node.y=10;
            ...
            switch(this.fixedType) {
                case enFixedCardType.FixedCardType_AGang: {
                    ...
                    this.bmp_cardbackAry[0].spriteFrame=_jzmj.getMahjongPaiBeiRes("shoupaipg_back@2x");
                    this.bmp_cardbackAry[1].spriteFrame=_jzmj.getMahjongPaiBeiRes("shoupaipg_back@2x");
                    this.bmp_cardbackAry[2].spriteFrame=_jzmj.getMahjongPaiBeiRes("shoupaipg_back@2x");
                    this.bmp_cardbackAry[3].spriteFrame=_jzmj.getMahjongPaiBeiRes("shoupaipg@2x");
                ...
                case enFixedCardType.FixedCardType_BGang: {
                    url=`gameres/gameCommonRes/Texture/Mahjong/PaiBei3/pb3_showcard_self_1280`;
                    this.bmp_cardbackAry[0].spriteFrame=_jzmj.getMahjongPaiBeiRes("shoupaipg@2x");
                    this.bmp_cardbackAry[1].spriteFrame=_jzmj.getMahjongPaiBeiRes("shoupaipg@2x");
                    this.bmp_cardbackAry[2].spriteFrame=_jzmj.getMahjongPaiBeiRes("shoupaipg@2x");
                    this.bmp_cardbackAry[3].spriteFrame=_jzmj.getMahjongPaiBeiRes("shoupaipg@2x");
            ...
            switch(this.fixedType) {
                ...
                case enFixedCardType.FixedCardType_Peng: {                  
                    if(this._cardIndex==1){
                        ...
                        this.bmp_cardbackAry[1].spriteFrame=_jzmj.getMahjong3DPaiBeiRes("chi_self_1_7");
                        this.bmp_cardbackAry[2].spriteFrame=_jzmj.getMahjong3DPaiBeiRes("chi_self_1_7");
                        this.bmp_cardcolorAry[0].spriteFrame=_jzmj.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[1].spriteFrame=_jzmj.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[2].spriteFrame=_jzmj.getMahjongPaiHuaRes(this.cardValue);
                    }else{
    ...
    private setPos(_hqmj):void{
        if(_hqmj == JZMJ.ins.iclass && JZMJ.ins.iclass.is2D()){
