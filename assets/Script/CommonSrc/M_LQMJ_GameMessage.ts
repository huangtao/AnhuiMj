...
export module M_LQMJ_GameMessage {
    ...
    TSRH.RSerializer("M_LQMJ_GameMessage.SingleFixedCard", "1|tokenCard&1|type&1|pos&1|chiType", "M_LQMJ_GameMessage.SingleFixedCard");
    ...
    TSRH.RSerializer("M_LQMJ_GameMessage.PlayerBalance", "4|HuType&4|FangPao&4|TotalScore&13|JieSuan&12|vecType", "M_LQMJ_GameMessage.PlayerBalance");
    ...
    TSRH.RSerializer("M_LQMJ_GameMessage.GameRecordResult", "!4|PlayerScore&1|ScoreType&1|Banker&!13|huGangCount", "M_LQMJ_GameMessage.GameRecordResult");
    ...
    TSRH.RSerializer("M_LQMJ_GameMessage.ORCFixedCard", "1|fixedType&1|fixedCard&1|outChair&1|chiType", "M_LQMJ_GameMessage.ORCFixedCard");
    ...
    export class PaiWalls extends UyiObject {
        ...
        {
            super();
            this.$T="M_LQMJ_GameMessage.PaiWalls"; 
        }
       /**
        *
        */
    ...
    SerializerCreator.Register("M_LQMJ_GameMessage.PaiWalls", function () {return new PaiWalls()})
    TSRH.RSerializer("M_LQMJ_GameMessage.PaiWalls", "1|banker&1|paiCount&1|houPai", "M_LQMJ_GameMessage.PaiWalls");
    ...
    TSRH.RSerializer("27492", "4|gameNum&4|totalGameNum&4|realGameNum&4|reMain", "M_LQMJ_GameMessage.CMD_S_Start");
    ...
    TSRH.RSerializer("27498", "1|playerChair&1|timer", "M_LQMJ_GameMessage.CMD_S_ActivePlayer");
    ...
    TSRH.RSerializer("27507", "", "M_LQMJ_GameMessage.CMD_S_StartSendCard");
    ...
    TSRH.RSerializer("27508", "1|chair", "M_LQMJ_GameMessage.CMD_S_PlayerOffline");
    ...
    export class CMD_S_AddGameOutTime extends GameIF.GameMessage {
        public constructor()
        {
            ...
            this.wMainCmdID = 107;
            this.wSubCmdID = 167;
            this.$T="M_LQMJ_GameMessage.CMD_S_AddGameOutTime"; 
        }
   
    }
    SerializerCreator.Register("M_LQMJ_GameMessage.CMD_S_AddGameOutTime", function () {return new CMD_S_AddGameOutTime()})
    TSRH.RSerializer("27559", "", "M_LQMJ_GameMessage.CMD_S_AddGameOutTime");
    ...
    TSRH.RSerializer("27509", "1|chair", "M_LQMJ_GameMessage.CMD_S_PlayerOfflineCome");
    ...
    TSRH.RSerializer("27493", "1|sz1&1|sz2&1|bankerChair&1|lianBanker", "M_LQMJ_GameMessage.CMD_S_SZInfo");
    ...
    TSRH.RSerializer("27495", "12|gameid", "M_LQMJ_GameMessage.CMD_S_GameID");
    ...
    TSRH.RSerializer("27494", "13|cardAry", "M_LQMJ_GameMessage.CMD_S_InitCard");
    ...
    TSRH.RSerializer("27554", "1|card", "M_LQMJ_GameMessage.CMD_S_FanKaiHun");
    ...
    TSRH.RSerializer("27500", "1|chair&1|card", "M_LQMJ_GameMessage.CMD_S_PlayerOutCard");
    ...
    TSRH.RSerializer("27497", "1|chair&1|card&1|countPai&1|gangNum&14|usual", "M_LQMJ_GameMessage.CMD_S_PlayerHoldCard");
    ...
    export class CMD_S_PlayerBaoTing extends GameIF.GameMessage {
        public constructor()
        {
            ...
            this.wMainCmdID = 107;
            this.wSubCmdID = 163;
            this.$T="M_LQMJ_GameMessage.CMD_S_PlayerBaoTing"; 
        }
       /**
        *
        */
    ...
    SerializerCreator.Register("M_LQMJ_GameMessage.CMD_S_PlayerBaoTing", function () {return new CMD_S_PlayerBaoTing()})
    TSRH.RSerializer("27555", "1|chair", "M_LQMJ_GameMessage.CMD_S_PlayerBaoTing");
    ...
    TSRH.RSerializer("27502", "1|chair&1|card", "M_LQMJ_GameMessage.CMD_S_PlayerAnGangCard");
    ...
    TSRH.RSerializer("27504", "1|chair&1|card", "M_LQMJ_GameMessage.CMD_S_PlayerBuGangCard");
    ...
    TSRH.RSerializer("27503", "1|chair&1|outChair&1|card", "M_LQMJ_GameMessage.CMD_S_PlayerMingGang");
    ...
    TSRH.RSerializer("27513", "1|chair&1|card", "M_LQMJ_GameMessage.CMD_S_QiangGang");
    ...
    export class CMD_S_PlayerChiCard extends GameIF.GameMessage {
        public constructor()
        {
            ...
            this.wMainCmdID = 107;
            this.wSubCmdID = 104;
            this.$T="M_LQMJ_GameMessage.CMD_S_PlayerChiCard"; 
        }
       /**
        *
        */
    ...
    SerializerCreator.Register("M_LQMJ_GameMessage.CMD_S_PlayerChiCard", function () {return new CMD_S_PlayerChiCard()})
    TSRH.RSerializer("27496", "1|chair&1|outChair&1|card&1|chi_type", "M_LQMJ_GameMessage.CMD_S_PlayerChiCard");
    ...
    TSRH.RSerializer("27501", "1|chair&1|outChair&1|card", "M_LQMJ_GameMessage.CMD_S_PlayerPengCard");
    ...
    export class CMD_S_PlayerBao extends GameIF.GameMessage {
        public constructor()
        {
            ...
            this.wMainCmdID = 107;
            this.wSubCmdID = 164;
            this.$T="M_LQMJ_GameMessage.CMD_S_PlayerBao"; 
        }
       /**
        *
        */
    ...
    SerializerCreator.Register("M_LQMJ_GameMessage.CMD_S_PlayerBao", function () {return new CMD_S_PlayerBao()})
    TSRH.RSerializer("27556", "1|chair", "M_LQMJ_GameMessage.CMD_S_PlayerBao");
    ...
    TSRH.RSerializer("27505", "1|chair&1|card&1|huType&!4|huScore&12|vecHuType", "M_LQMJ_GameMessage.CMD_S_PlayerHuCard");
    ...
    TSRH.RSerializer("27506", "1|ifCanZiMo&13|gangCard", "M_LQMJ_GameMessage.CMD_S_OpPlayer");
    ...
    TSRH.RSerializer("27499", "1|voteCard&1|voteRight", "M_LQMJ_GameMessage.CMD_S_VoteRight");
    ...
    TSRH.RSerializer("27514", "1|chair&1|huCard&13|handCard", "M_LQMJ_GameMessage.CMD_S_PlayerCardData");
    ...
    TSRH.RSerializer("27516", "!M_LQMJ_GameMessage.PlayerCard|playerCard&!M_LQMJ_GameMessage.PlayerBalance|playerBalance&1|isPlayEnougnGameNum&14|liuju", "M_LQMJ_GameMessage.CMD_S_Balance");
    ...
    export class CMD_S_AddGameNum extends GameIF.GameMessage {
        public constructor()
        {
            ...
            this.wMainCmdID = 107;
            this.wSubCmdID = 166;
            this.$T="M_LQMJ_GameMessage.CMD_S_AddGameNum"; 
        }
       /**
        *
        */
    ...
    SerializerCreator.Register("M_LQMJ_GameMessage.CMD_S_AddGameNum", function () {return new CMD_S_AddGameNum()})
    TSRH.RSerializer("27558", "1|gameNum&1|chair&1|addNum", "M_LQMJ_GameMessage.CMD_S_AddGameNum");
    ...
    TSRH.RSerializer("27517", "!M_LQMJ_GameMessage.GameFlowDetail|gameFlow", "M_LQMJ_GameMessage.CMD_S_GameFlow");
    ...
    TSRH.RSerializer("27519", "13|handCardData", "M_LQMJ_GameMessage.CMD_S_HandCardData");
    ...
    TSRH.RSerializer("27521", "1|card", "M_LQMJ_GameMessage.CMD_S_DelQiangGangCard");
    ...
    TSRH.RSerializer("27522", "", "M_LQMJ_GameMessage.CMD_S_ForceLeftSuccess");
    ...
    TSRH.RSerializer("27523", "", "M_LQMJ_GameMessage.CMD_S_CreateTableSuccess");
    ...
    TSRH.RSerializer("27524", "13|payKa&13|juShu&1|defaultJuShu&12|Version", "M_LQMJ_GameMessage.CMD_S_StartCreateTable");
    ...
    TSRH.RSerializer("27525", "5|plyaerID&1|chair", "M_LQMJ_GameMessage.CMD_S_TableCreatorInfo");
    ...
    TSRH.RSerializer("27526", "12|msg&4|cost", "M_LQMJ_GameMessage.CMD_S_ForceUserLeft");
    ...
    TSRH.RSerializer("27527", "12|msg&1|tipType", "M_LQMJ_GameMessage.CMD_S_ShowMsg");
    ...
    TSRH.RSerializer("27530", "1|friendChair&5|friendID&1|moneyType&4|moneyNum", "M_LQMJ_GameMessage.CMD_S_FriendHelpInfo");
    ...
    TSRH.RSerializer("27528", "1|friendChair&5|friendID", "M_LQMJ_GameMessage.CMD_S_FriendReject");
    ...
    TSRH.RSerializer("27529", "1|friendChair&5|friendID&1|result", "M_LQMJ_GameMessage.CMD_S_FriendHelpSuccess");
    ...
    TSRH.RSerializer("27532", "!M_LQMJ_GameMessage.GameRecordResult|record", "M_LQMJ_GameMessage.CMD_S_GameRecordResult");
    ...
    export class CMD_S_QuitCreator extends GameIF.GameMessage {
        public constructor()
        {
            ...
            this.wMainCmdID = 107;
            this.wSubCmdID = 165;
            this.$T="M_LQMJ_GameMessage.CMD_S_QuitCreator"; 
        }
   
    }
    SerializerCreator.Register("M_LQMJ_GameMessage.CMD_S_QuitCreator", function () {return new CMD_S_QuitCreator()})
    TSRH.RSerializer("27557", "", "M_LQMJ_GameMessage.CMD_S_QuitCreator");
    ...
    TSRH.RSerializer("27533", "", "M_LQMJ_GameMessage.CMD_S_NewGameRound");
    ...
    TSRH.RSerializer("27535", "1|voteqg", "M_LQMJ_GameMessage.CMD_S_VoteQGResult");
    ...
    TSRH.RSerializer("27536", "1|chair&5|userID&4|gold&4|goldCard&4|diamond", "M_LQMJ_GameMessage.CMD_S_PlayerMoney");
    ...
    TSRH.RSerializer("27537", "1|sponsorChair", "M_LQMJ_GameMessage.CMD_S_PlayerDissTable");
    ...
    TSRH.RSerializer("27538", "1|chair&1|vote", "M_LQMJ_GameMessage.CMD_S_PlayerVoteDissTable");
    ...
    TSRH.RSerializer("27539", "1|gameing", "M_LQMJ_GameMessage.CMD_S_DissTableSuccess");
    ...
    TSRH.RSerializer("27541", "1|chair", "M_LQMJ_GameMessage.CMD_S_UseReady");
    ...
    TSRH.RSerializer("27542", "", "M_LQMJ_GameMessage.CMD_S_SaveTableSuccess");
    ...
    TSRH.RSerializer("27543", "1|chair&1|card&1|cardnum", "M_LQMJ_GameMessage.CMD_S_DelPoolCard");
    ...
    TSRH.RSerializer("27544", "14|pao", "M_LQMJ_GameMessage.CMD_S_StartPao");
    ...
    TSRH.RSerializer("27545", "", "M_LQMJ_GameMessage.CMD_S_StartLa");
    ...
    TSRH.RSerializer("27546", "1|point", "M_LQMJ_GameMessage.CMD_S_SelfPao");
    ...
    TSRH.RSerializer("27547", "1|point", "M_LQMJ_GameMessage.CMD_S_SelfLa");
    ...
    TSRH.RSerializer("27548", "13|points", "M_LQMJ_GameMessage.CMD_S_PlayerPaoInfo");
    ...
    TSRH.RSerializer("27549", "13|points", "M_LQMJ_GameMessage.CMD_S_PlayerLaInfo");
    ...
    TSRH.RSerializer("27592", "1|bankerChair&1|lianBanker&12|gameid&1|gamePhase&1|selfIsAlreadyHu", "M_LQMJ_GameMessage.CMD_S_ORC_GameInfo");
    ...
    TSRH.RSerializer("27593", "M_LQMJ_GameMessage.ORCSelfCard|selfCard&!M_LQMJ_GameMessage.ORCOtherPlayerCard|otherPlayerCard&M_LQMJ_GameMessage.PaiWalls|paiWall", "M_LQMJ_GameMessage.CMD_S_ORC_PlayerCard");
    ...
    TSRH.RSerializer("27596", "1|chair&1|card", "M_LQMJ_GameMessage.CMD_S_ORC_Vote");
    ...
    TSRH.RSerializer("27597", "1|leftCardNum", "M_LQMJ_GameMessage.CMD_S_ORC_Over");
    ...
    TSRH.RSerializer("27599", "1|sponsor&13|playerVote&1|leftTime", "M_LQMJ_GameMessage.CMD_S_ORC_DissTable");
    ...
    export class CMD_S_ORC_AddGameNum extends GameIF.GameMessage {
        public constructor()
        {
            ...
            this.wMainCmdID = 107;
            this.wSubCmdID = 210;
            this.$T="M_LQMJ_GameMessage.CMD_S_ORC_AddGameNum"; 
        }
       /**
        *
        */
    ...
    SerializerCreator.Register("M_LQMJ_GameMessage.CMD_S_ORC_AddGameNum", function () {return new CMD_S_ORC_AddGameNum()})
    TSRH.RSerializer("27602", "1|chair&13|playerVote&1|leftTime&!4|tempScore", "M_LQMJ_GameMessage.CMD_S_ORC_AddGameNum");
    ...
    export class CMD_S_ORC_BaoTing extends GameIF.GameMessage {
        public constructor()
        {
            ...
            this.wMainCmdID = 107;
            this.wSubCmdID = 211;
            this.$T="M_LQMJ_GameMessage.CMD_S_ORC_BaoTing"; 
        }
       /**
        *
        */
    ...
    SerializerCreator.Register("M_LQMJ_GameMessage.CMD_S_ORC_BaoTing", function () {return new CMD_S_ORC_BaoTing()})
    TSRH.RSerializer("27603", "1|chair", "M_LQMJ_GameMessage.CMD_S_ORC_BaoTing");
    ...
    TSRH.RSerializer("27600", "1|isXuJu&1|addNum", "M_LQMJ_GameMessage.CMD_S_ORC_TableFree");
    ...
    TSRH.RSerializer("27601", "!4|PlayerScoreChange", "M_LQMJ_GameMessage.CMD_S_ORC_GameScoreChange");
    ...
    TSRH.RSerializer("27402", "", "M_LQMJ_GameMessage.CMD_C_HoldCardComplete");
    ...
    TSRH.RSerializer("27408", "", "M_LQMJ_GameMessage.CMD_C_ZiMo");
    ...
    TSRH.RSerializer("27407", "1|gangCard", "M_LQMJ_GameMessage.CMD_C_Gang");
    ...
    export class CMD_C_Chi extends GameIF.GameMessage {
        public constructor()
        {
            ...
            this.wMainCmdID = 107;
            this.wSubCmdID = 31;
            this.$T="M_LQMJ_GameMessage.CMD_C_Chi"; 
        }
       /**
        *
        */
    ...
    SerializerCreator.Register("M_LQMJ_GameMessage.CMD_C_Chi", function () {return new CMD_C_Chi()})
    TSRH.RSerializer("27423", "1|chiCard&1|chiType", "M_LQMJ_GameMessage.CMD_C_Chi");
    ...
    TSRH.RSerializer("27406", "1|outCard", "M_LQMJ_GameMessage.CMD_C_OutCard");
    ...
    TSRH.RSerializer("27409", "1|voteResult", "M_LQMJ_GameMessage.CMD_C_Vote");
    ...
    TSRH.RSerializer("27410", "1|qiangGang", "M_LQMJ_GameMessage.CMD_C_QiangGang");
    ...
    TSRH.RSerializer("27411", "5|PlayerID", "M_LQMJ_GameMessage.CMD_C_ForceLeft");
    ...
    TSRH.RSerializer("27412", "1|LaPaoZuo&4|SetGameNum&4|GoldRoomBaseIdx&1|isOutTimeOp&1|isTableCreatorPay&1|isYiPaoDuoXiang&1|IfCanSameIp&1|whoLose&1|zhanZhuang&1|gangFen&1|canChi&1|QiDuiJia&1|IfCheckGps&14|IfCanHu7Dui&1|daiDaPai&4|GangKaiJia&4|BuKaoJia&4|TableCost&1|IsRecordScoreRoom&12|TableCode", "M_LQMJ_GameMessage.CMD_C_CreateTable");
    ...
    TSRH.RSerializer("27551", "14|IsDissolution", "M_LQMJ_GameMessage.CMD_S_IsDissolution");
    ...
    TSRH.RSerializer("27413", "1|friendChair&5|friendID&1|moneyType&4|moneyNum", "M_LQMJ_GameMessage.CMD_C_FriendHelp");
    ...
    TSRH.RSerializer("27414", "1|friendChair&5|friendID", "M_LQMJ_GameMessage.CMD_C_RejectHelp");
    ...
    TSRH.RSerializer("27415", "1|friendChair&5|friendID&1|moneyType&4|moneyNum", "M_LQMJ_GameMessage.CMD_C_HelpFriend");
    ...
    TSRH.RSerializer("27417", "1|queryNum", "M_LQMJ_GameMessage.CMD_C_QueryGameRecord");
    ...
    TSRH.RSerializer("27418", "", "M_LQMJ_GameMessage.CMD_C_OfferDissTable");
    ...
    TSRH.RSerializer("27419", "1|voteResult", "M_LQMJ_GameMessage.CMD_C_VoteDissTable");
    ...
    TSRH.RSerializer("27420", "", "M_LQMJ_GameMessage.CMD_C_NextGame");
    ...
    TSRH.RSerializer("27421", "", "M_LQMJ_GameMessage.CMD_C_ReSetScene");
    ...
    TSRH.RSerializer("27422", "", "M_LQMJ_GameMessage.CMD_C_SaveTable");
    ...
    TSRH.RSerializer("27403", "1|point", "M_LQMJ_GameMessage.CMD_C_Pao");
    ...
    TSRH.RSerializer("27404", "1|point", "M_LQMJ_GameMessage.CMD_C_La");
    ...
    export class CMD_C_AddGameNum extends GameIF.GameMessage {
        public constructor()
        {
            ...
            this.wMainCmdID = 107;
            this.wSubCmdID = 34;
            this.$T="M_LQMJ_GameMessage.CMD_C_AddGameNum"; 
        }
       /**
        *
        */
    ...
    SerializerCreator.Register("M_LQMJ_GameMessage.CMD_C_AddGameNum", function () {return new CMD_C_AddGameNum()})
    TSRH.RSerializer("27426", "1|point", "M_LQMJ_GameMessage.CMD_C_AddGameNum");
    ...
    export class CMD_C_BaoTing extends GameIF.GameMessage {
        public constructor()
        {
            ...
            this.wMainCmdID = 107;
            this.wSubCmdID = 32;
            this.$T="M_LQMJ_GameMessage.CMD_C_BaoTing"; 
        }
       /**
        *
        */
    ...
    SerializerCreator.Register("M_LQMJ_GameMessage.CMD_C_BaoTing", function () {return new CMD_C_BaoTing()})
    TSRH.RSerializer("27424", "1|point", "M_LQMJ_GameMessage.CMD_C_BaoTing");
    ...
    export class CMD_C_GiveUpBaoTing extends GameIF.GameMessage {
        public constructor()
        {
            ...
            this.wMainCmdID = 107;
            this.wSubCmdID = 33;
            this.$T="M_LQMJ_GameMessage.CMD_C_GiveUpBaoTing"; 
        }
       /**
        *
        */
    ...
    SerializerCreator.Register("M_LQMJ_GameMessage.CMD_C_GiveUpBaoTing", function () {return new CMD_C_GiveUpBaoTing()})
    TSRH.RSerializer("27425", "1|point", "M_LQMJ_GameMessage.CMD_C_GiveUpBaoTing");
    ...
    TSRH.RSerializer("27550", "3|TingNum", "M_LQMJ_GameMessage.CMD_S_Ting");
    ...
    TSRH.RSerializer("27552", "12|Version", "M_LQMJ_GameMessage.CMD_S_Version");
