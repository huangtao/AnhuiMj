...
@ccclass
export default class M_TDHMJSetting extends CreateRoomSettingBase {
    public GetSetting() {
    ...
    private Init(): void {
           const tempdata=new M_TDHMJ_GameData();
    ...
    private onCreateTable(): CreateRoomStruct {
        const createTable = new M_TDHMJ_GameData();
