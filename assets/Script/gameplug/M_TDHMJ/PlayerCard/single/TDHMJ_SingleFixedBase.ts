...
@ccclass
export default class TDHMJ_SingleFixedBase extends TDHMJ_SingleCardBase {
     ...
     * */
    public showCard(card: number,fixedType: enFixedCardType,index:number,type:number,pos?:number,_lqmj = TDHMJ.ins.iclass): void {
