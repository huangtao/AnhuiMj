import HZMJ_VideoActiveBase from "./HZMJ_VideoActiveBase";
import { HZMJ } from "../../ConstDef/HZMJMahjongDef";

const { ccclass, property } = cc._decorator;

@ccclass
export default class HZMJ_OppoVideoActive extends HZMJ_VideoActiveBase {
    ...
    //     //起始位置
    //     var startPos: number = HZMJ_OppoVideoActive.ArrangeStartPos_lie[this.fixedCardNum];
    ...
    protected refreshHandCard(): void {
        if(HZMJ.ins.iclass.is2D()){
            //起始位置
            let startPos: number = HZMJ_OppoVideoActive.ArrangeStartPos_lie[this.fixedCardNum];
            ...
            //起始位置
            let startPos: number = HZMJ_OppoVideoActive.ArrangeStartPos3D_lie[this.fixedCardNum];
            this.resetZ();
