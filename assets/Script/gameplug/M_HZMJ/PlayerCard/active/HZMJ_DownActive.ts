...
@ccclass
export default class HZMJ_DownActive extends HZMJ_OtherActive {
    ...
    protected refreshHandCard(): void {
        ...
        if(HZMJ.ins.iclass.is2D()){
            if(this.isLie){
            //起始位置
            var startPos: number = HZMJ_DownActive.ArrangeStartPos_lie[this.fixedCardNum];
            ...
            //起始位置
            var startPos: number = HZMJ_DownActive.ArrangeStartPos_stand[this.fixedCardNum];
            ...
            if(this.isLie){
                //起始位置
                let startPos: number = HZMJ_DownActive.ArrangeStartPos3D_lie[this.fixedCardNum];
                ...
                //起始位置
                let startPos: number = HZMJ_DownActive.ArrangeStartPos3D_stand[this.fixedCardNum];
