...
@ccclass
export default class BBMJ_SelfSingleFixed extends BBMJ_SingleFixedBase {
        ...
        if(BBMJ.ins.iclass.is2D()){
            ...
            switch(this.fixedType) {
                case enFixedCardType.FixedCardType_AGang: {
                    ...
                    this.bmp_cardbackAry[0].spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("shoupaipg_back@2x");
                    this.bmp_cardbackAry[1].spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("shoupaipg_back@2x");
                    this.bmp_cardbackAry[2].spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("shoupaipg_back@2x");
                    this.bmp_cardbackAry[3].spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("shoupaipg@2x");
                ...
                case enFixedCardType.FixedCardType_BGang: {
                    ...
                    this.bmp_cardbackAry[0].spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("shoupaipg@2x");
                    this.bmp_cardbackAry[1].spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("shoupaipg@2x");
                    this.bmp_cardbackAry[2].spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("shoupaipg@2x");
                    this.bmp_cardbackAry[3].spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("shoupaipg@2x");
            ...
            switch(this.fixedType) {
                case enFixedCardType.FixedCardType_AGang: {
                    ...
                    if(this._cardIndex==1){
                        this.bmp_cardbackAry[0].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_btm_mj_bm_01");
                        this.bmp_cardbackAry[1].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_btm_mj_bm_02");
                        this.bmp_cardbackAry[2].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_btm_mj_bm_03");
                        this.bmp_cardbackAry[3].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_btm_mj_bg_02");
                        this.bmp_cardcolorAry[1].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                    }else if(this._cardIndex==2){
                        this.bmp_cardbackAry[0].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_btm_mj_bm_04");
                        this.bmp_cardbackAry[1].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_btm_mj_bm_05");
                        this.bmp_cardbackAry[2].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_btm_mj_bm_06");
                        this.bmp_cardbackAry[3].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_btm_mj_bg_05");
                        this.bmp_cardcolorAry[1].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                    }else if(this._cardIndex==3){
                        this.bmp_cardbackAry[0].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_btm_mj_bm_07");
                        this.bmp_cardbackAry[1].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_btm_mj_bm_07");
                        this.bmp_cardbackAry[2].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_btm_mj_bm_06");
                        this.bmp_cardbackAry[3].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_btm_mj_bg_07");
                        this.bmp_cardcolorAry[1].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                    }else if(this._cardIndex==4){
                        this.bmp_cardbackAry[0].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_btm_mj_bm_05");
                        this.bmp_cardbackAry[1].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_btm_mj_bm_04");
                        this.bmp_cardbackAry[2].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_btm_mj_bm_03");
                        this.bmp_cardbackAry[3].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_btm_mj_bg_04");
                        this.bmp_cardcolorAry[1].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                    }else{
                ...
                case enFixedCardType.FixedCardType_BGang: {
                    ...
                    if(this._cardIndex==1){
                        this.bmp_cardbackAry[0].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_btm_mj_bg_01");
                        this.bmp_cardbackAry[1].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_btm_mj_bg_02");
                        this.bmp_cardbackAry[2].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_btm_mj_bg_03");
                        this.bmp_cardbackAry[3].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_btm_mj_bg_02");
                        this.bmp_cardcolorAry[0].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[1].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[2].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                    }else if(this._cardIndex==2){
                        this.bmp_cardbackAry[0].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_btm_mj_bg_04");
                        this.bmp_cardbackAry[1].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_btm_mj_bg_05");
                        this.bmp_cardbackAry[2].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_btm_mj_bg_06");
                        this.bmp_cardbackAry[3].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_btm_mj_bg_05");
                        this.bmp_cardcolorAry[0].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[1].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[2].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                    }else if(this._cardIndex==3){
                        this.bmp_cardbackAry[0].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_btm_mj_bg_07");
                        this.bmp_cardbackAry[1].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_btm_mj_bg_07");
                        this.bmp_cardbackAry[2].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_btm_mj_bg_06");
                        this.bmp_cardbackAry[3].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_btm_mj_bg_07");
                        this.bmp_cardcolorAry[0].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[1].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        ...
                        this.bmp_cardbackAry[0].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_btm_mj_bg_05");
                        this.bmp_cardbackAry[1].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_btm_mj_bg_04");
                        this.bmp_cardbackAry[2].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_btm_mj_bg_03");
                        this.bmp_cardbackAry[3].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_btm_mj_bg_04");
                        this.bmp_cardcolorAry[0].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[1].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
    ...
    private set3DSize(){
        ...
        switch(this._cardIndex){
            ...
            case 3:{
                ...
                this.bmp_cardbackAry[3].node.height=106;
                this.bmp_cardbackAry[3].node.zIndex = (4);
                this.bmp_cardbackAry[3].node.scaleX=-1;
                ...
                this.bmp_cardcolorAry[0].node.scaleY=0.65;
                this.bmp_cardcolorAry[0].node.skewX=0;
                this.bmp_cardcolorAry[0].node.zIndex = (5);
