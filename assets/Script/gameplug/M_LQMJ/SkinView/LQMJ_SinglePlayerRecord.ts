...
@ccclass
export default class LQMJ_SinglePlayerRecord extends cc.Component {
    ...
    //股票数据
    private _data: M_LQMJ_GameMessage.GameRecordResult;
    //索引
    private _idx:number;
     ...
     * @param idx 
     */
    public Init(data: M_LQMJ_GameMessage.GameRecordResult,idx:number):void{
        this._data=data;
        this._idx=idx;
    }
