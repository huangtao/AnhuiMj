...
@ccclass
export default class M_LQMJSetting extends CreateRoomSettingBase {
    public GetSetting() {
    ...
    private Init(): void {
           const tempdata=new M_LQMJ_GameData();
    ...
    private onCreateTable(): CreateRoomStruct {
        const createTable = new M_LQMJ_GameData();
