...
@ccclass
export default class LQMJ_UpActive extends LQMJ_OtherActive {
    ...
    protected refreshHandCard(): void {
        ...
        if(LQMJ.ins.iclass.is2D()){
            if(this.isLie) {
            //起始位置
            var startPos: number = LQMJ_UpActive.ArrangeStartPos_lie[this.fixedCardNum];
            ...
            //起始位置
            var startPos: number = LQMJ_UpActive.ArrangeStartPos_stand[this.fixedCardNum];
