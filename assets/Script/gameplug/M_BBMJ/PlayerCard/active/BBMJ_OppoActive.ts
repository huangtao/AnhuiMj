...
@ccclass
export default class BBMJ_OppoActive extends BBMJ_OtherActive {
    ...
    //
        ...
        if(BBMJ.ins.iclass.is2D()){
            if(this.isLie) {
                ...
                var startPos: number = BBMJ_OppoActive.ArrangeStartPos_lie[this.fixedCardNum];
                ...
                //起始位置
                var startPos: number = BBMJ_OppoActive.ArrangeStartPos_stand[this.fixedCardNum];
            ...
            if(this.isLie) {
            //起始位置
                let startPos: number = BBMJ_OppoActive.ArrangeStartPos3D_lie[this.fixedCardNum];
                this.resetZ();
                ...
                //起始位置
                let startPos: number = BBMJ_OppoActive.ArrangeStartPos3D_stand[this.fixedCardNum];
