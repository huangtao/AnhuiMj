...
const { ccclass, property } = cc._decorator;
    ...
    export interface IJZMJClass {
        ...
        getTableConfig():JZMJTableConfig;
    ...
    export class JZMJ{
        ...
        private static _ins:JZMJ=null;
        private _icalss:IJZMJClass=null;
        private _iview:IJZMJView=null;
         ...
         * 逻辑
         * */
        public get iclass():IJZMJClass{
            return this._icalss;
        }
        public set iclass(value:IJZMJClass){
            this._icalss = value;
        }
         ...
         * 视图
         * */
        public get iview():IJZMJView{
            return this._iview;
        }
        public set iview(value:IJZMJView){
            this._iview = value;
        }
    }


	export class JZMJMahjongDef {

        public static gameID:number=104;
        /// <summary>
        /// 花色掩码
        /// </summary>
    ...
    export class JZMJTableConfig{
        ...
        //点炮包分
        private _dianPaoBaoFen:boolean;       
        //死不靠 活不靠
        private _buKao:number;

        private _tableWhere:number;
        //gps
        private _checkGps:boolean;
        //跑嘴
        private _paoZui:number;
        ...
        public constructor(){    
            ...
            this._tableCreatorChair = JZMJMahjongDef.gInvalidChar;
            ...
            this._realGameNum = 0;
            this._qiangGangHu = true;
            this._dianPaoBaoFen = false;
            this._buKao = 0;
        ...
        public init(
            ...
            this._dianPaoBaoFen = dianPaoBaoFen;
            this._buKao = buKao;
        ...
        //是否抢杠胡
        public get ifQiangGangHu(){
            return this._qiangGangHu;
        }
        //是否点炮包分
        public get ifDianPaoBaoFen(){
            return this._dianPaoBaoFen;
        }
        //跑嘴类型
        public get paoType(){
            return this._paoZui;
        ...
        public isPlayEnoughGameNum(addNum:number):boolean{
            ...
            if(this._setGameNum == 1)
                jushu = 16;
            return this._gameNum >= jushu*addNum;
        }
        ...
        public get cellScore():number{
            if(JZMJ.ins.iclass.isCreateRoom()){
                return this._cellScore;
                       ...
                       if(JZMJ.ins.iclass.getRoomData()){
                return JZMJ.ins.iclass.getRoomData().BaseMoney;
            }
            else{
    ...
    export class JZMJTimer{
        ...
        public clear():void{
            ...
            this._curTime=0;
            this._triggerTime=0;
            this._chair = JZMJMahjongDef.gInvalidChar;
     ...
     * 合肥麻将打牌玩家
     * */
    export class JZMJOutCardPlayer{
        private _chair:number;
         ...
         * */
        public get isValid():boolean{
            if((JZMJMahjongDef.gInvalidChar != this._chair) && (JZMJMahjongDef.gInvalidMahjongValue != this._card)){
                return true;
            }
            return false;
        }
        ...
        public clear():void{
            this._chair = JZMJMahjongDef.gInvalidChar;
            this._card = JZMJMahjongDef.gInvalidMahjongValue;
        }
    }
    ...
    export class JZMJRecordCard{
        ...
        public getCardLeftNum(card:number,checkAry:Array<number> = null):number{
            var logicValue: number = JZMJMahjongAlgorithm.GetMahjongLogicValue(card);
    ...
    export class clsParseTriple
    {
        ...
        public Clear():void
        {
            this.cTokenCard = JZMJMahjongDef.gInvalidMahjongValue;
        ...
        public GetTokenNum():number
        {
            ...
            return (wBaseNum + JZMJMahjongAlgorithm.GetMahjongLogicValue(this.cTokenCard));
        }
        ...
        public get isValid():boolean
        {
                if ((JZMJMahjongDef.gInvalidMahjongValue != this.cTokenCard) && (enTripleType.TripleType_Unknown != this.enTripleType)){
                    return true;
                }
                return false;
        }
   ...
   /// <summary>
    ...
    export class clsNormalParseStruct
    {
        ...
        public Clear():void
        {
            this.pair = JZMJMahjongDef.gInvalidMahjongValue;
        ...
        public get isValid():boolean
        {
            ...
            return this.pair != JZMJMahjongDef.gInvalidMahjongValue;
    ...
    export class clsParseResult
    {
        ...
        public Clear():void
        {
            this.isValid = false;
            this.is7Pair = false;
            this.huCard = JZMJMahjongDef.gInvalidMahjongValue;
    ...
    export class clsSingleFixedCard
    {
	    ...
	    public Clear():void
	    {
            this.card = JZMJMahjongDef.gInvalidMahjongValue;
    ...
    export class clsPairTripleWrapper
    {
        ...
        public Clear():void
        {
            this.cPair = JZMJMahjongDef.gInvalidMahjongValue;
            this.wTripleCount = 0;
