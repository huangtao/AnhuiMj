...
@ccclass
export default class LQMJ_DownSingleFixed extends LQMJ_SingleFixedBase {
        ...
        if(_lqmj.is2D()){
            ...
            switch(this.fixedType) {
                case enFixedCardType.FixedCardType_AGang: {
                    ...
                    this.bmp_cardbackAry[0].spriteFrame=_lqmj.getMahjongPaiBeiRes("zuoyou_back@2x");
                    this.bmp_cardbackAry[1].spriteFrame=_lqmj.getMahjongPaiBeiRes("zuoyou_back@2x");
                    this.bmp_cardbackAry[2].spriteFrame=_lqmj.getMahjongPaiBeiRes("zuoyou_back@2x");
                    this.bmp_cardbackAry[3].spriteFrame=_lqmj.getMahjongPaiBeiRes("zuoyoupg@2x");
                ...
                case enFixedCardType.FixedCardType_BGang: {
                    url=`gameres/gameCommonRes/Texture/Mahjong/PaiBei3/pb3_showcard_left_right_1280`;
                    this.bmp_cardbackAry[0].spriteFrame=_lqmj.getMahjongPaiBeiRes("zuoyoupg@2x");
                    this.bmp_cardbackAry[1].spriteFrame=_lqmj.getMahjongPaiBeiRes("zuoyoupg@2x");
                    this.bmp_cardbackAry[2].spriteFrame=_lqmj.getMahjongPaiBeiRes("zuoyoupg@2x");
                    this.bmp_cardbackAry[3].spriteFrame=_lqmj.getMahjongPaiBeiRes("zuoyoupg@2x");
            ...
            switch(this.fixedType) {
                case enFixedCardType.FixedCardType_AGang: {                   
                    ...
                    if(this._cardIndex==1){
                        this.bmp_cardbackAry[0].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_right_2_17");
                        this.bmp_cardbackAry[1].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_right_2_16");
                        this.bmp_cardbackAry[2].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_right_2_15");
                        this.bmp_cardbackAry[3].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_right_1_16");
                        ...
                        this.bmp_cardbackAry[0].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_right_2_14");
                        this.bmp_cardbackAry[1].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_right_2_13");
                        this.bmp_cardbackAry[2].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_right_2_12");
                        this.bmp_cardbackAry[3].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_right_1_13");
                        ...
                        this.bmp_cardbackAry[0].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_right_2_11");
                        this.bmp_cardbackAry[1].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_right_2_10");
                        this.bmp_cardbackAry[2].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_right_2_9");
                        this.bmp_cardbackAry[3].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_right_1_10");
                        ...
                        this.bmp_cardbackAry[0].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_right_2_8");
                        this.bmp_cardbackAry[1].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_right_2_7");
                        this.bmp_cardbackAry[2].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_right_2_6");
                        this.bmp_cardbackAry[3].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_right_1_7");
                ...
                case enFixedCardType.FixedCardType_BGang: {
                    ...
                    if(this._cardIndex==1){
                        this.bmp_cardbackAry[0].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_right_1_17");
                        this.bmp_cardbackAry[1].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_right_1_16");
                        this.bmp_cardbackAry[2].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_right_1_15");
                        this.bmp_cardbackAry[3].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_right_1_16");
                        this.bmp_cardcolorAry[0].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[1].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[2].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue);
                        ...
                        this.bmp_cardbackAry[0].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_right_1_14");
                        this.bmp_cardbackAry[1].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_right_1_13");
                        this.bmp_cardbackAry[2].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_right_1_12");
                        this.bmp_cardbackAry[3].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_right_1_13");
                        this.bmp_cardcolorAry[0].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[1].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[2].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue);
                        ...
                        this.bmp_cardbackAry[0].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_right_1_11");
                        this.bmp_cardbackAry[1].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_right_1_10");
                        this.bmp_cardbackAry[2].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_right_1_9");
                        this.bmp_cardbackAry[3].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_right_1_10");
                        this.bmp_cardcolorAry[0].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[1].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[2].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue);
                        ...
                        this.bmp_cardbackAry[0].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_right_1_8");
                        this.bmp_cardbackAry[1].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_right_1_7");
                        this.bmp_cardbackAry[2].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_right_1_6");
                        this.bmp_cardbackAry[3].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_right_1_7");
                        this.bmp_cardcolorAry[0].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[1].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[2].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue);
