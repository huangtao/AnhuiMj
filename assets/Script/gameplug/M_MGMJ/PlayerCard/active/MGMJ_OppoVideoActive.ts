...
@ccclass
export default class MGMJ_OppoVideoActive extends MGMJ_VideoActiveBase {
    ...
    //     //起始位置
    //     var startPos: number = MGMJ_OppoVideoActive.ArrangeStartPos_lie[this.fixedCardNum];
    ...
    protected refreshHandCard(): void {
        if(MGMJ.ins.iclass.is2D()){
            //起始位置
            let startPos: number = MGMJ_OppoVideoActive.ArrangeStartPos_lie[this.fixedCardNum];
            ...
            //起始位置
            let startPos: number = MGMJ_OppoVideoActive.ArrangeStartPos3D_lie[this.fixedCardNum];
            this.resetZ();
