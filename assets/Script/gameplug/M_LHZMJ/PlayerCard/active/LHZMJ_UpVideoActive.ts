...
@ccclass
export default class LHZMJ_UpVideoActive extends LHZMJ_VideoActiveBase {
    ...
    protected refreshHandCard(): void {
        //起始位置
        var startPos: number = LHZMJ_UpVideoActive.ArrangeStartPos_lie[this.fixedCardNum];

        //开始排版
        
        if(LHZMJ.ins.iclass.is2D()){
            //起始位置
            let startPos: number = LHZMJ_UpVideoActive.ArrangeStartPos_lie[this.fixedCardNum];
