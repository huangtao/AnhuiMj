import { NiuNiu } from "./INiuNiuClass";
import { VoicePath, CommonVoicePath } from "./GameHelp";
...
export default class VoicePlayer {
    ...
    public static PlayChatVoice(value: number, gender: number) {
        ...
        NiuNiu.ins.iclass.PlayGameSound(path, AudioType.Effect, false);
    }
    /**
     * 播放牌型音效
     */
    ...
    public static PlayBgm() {
        var path = cc.url.raw(VoicePath + "niuniu_bgm.mp3");
        NiuNiu.ins.iclass.PlayGameSound(path, AudioType.Music, true);
    }
}
