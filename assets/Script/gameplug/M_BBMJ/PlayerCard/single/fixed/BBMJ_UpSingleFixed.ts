...
@ccclass
export default class BBMJ_UpSingleFixed extends BBMJ_SingleFixedBase {
        ...
        if(BBMJ.ins.iclass.is2D()){
            ...
            switch(this.fixedType) {
                case enFixedCardType.FixedCardType_AGang: {
                    ...
                    this.bmp_cardbackAry[0].spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("zuoyou_back@2x");
                    this.bmp_cardbackAry[1].spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("zuoyou_back@2x");
                    this.bmp_cardbackAry[2].spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("zuoyou_back@2x");
                    this.bmp_cardbackAry[3].spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("zuoyoupg@2x");
                ...
                case enFixedCardType.FixedCardType_BGang: {
                    ...
                    this.bmp_cardbackAry[0].spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("zuoyoupg@2x");
                    this.bmp_cardbackAry[1].spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("zuoyoupg@2x");
                    this.bmp_cardbackAry[2].spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("zuoyoupg@2x");
                    this.bmp_cardbackAry[3].spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("zuoyoupg@2x");
            ...
            switch(this.fixedType) {
                case enFixedCardType.FixedCardType_AGang: {
                    ...
                    if(this._cardIndex==1){
                        this.bmp_cardbackAry[0].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_bm_bg_01");
                        this.bmp_cardbackAry[1].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_bm_bg_02");
                        this.bmp_cardbackAry[2].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_bm_bg_03");
                        this.bmp_cardbackAry[3].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_mj_bg_02");
                        this.bmp_cardcolorAry[1].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                    }else if(this._cardIndex==2){
                        this.bmp_cardbackAry[0].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_bm_bg_04");
                        this.bmp_cardbackAry[1].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_bm_bg_05");
                        this.bmp_cardbackAry[2].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_bm_bg_06");
                        this.bmp_cardbackAry[3].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_mj_bg_05");
                        this.bmp_cardcolorAry[1].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                    }else if(this._cardIndex==3){
                        this.bmp_cardbackAry[0].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_bm_bg_07");
                        this.bmp_cardbackAry[1].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_bm_bg_08");
                        this.bmp_cardbackAry[2].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_bm_bg_09");
                        this.bmp_cardbackAry[3].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_mj_bg_08");
                        this.bmp_cardcolorAry[1].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                    }else if(this._cardIndex==4){
                        this.bmp_cardbackAry[0].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_bm_bg_10");
                        this.bmp_cardbackAry[1].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_bm_bg_11");
                        this.bmp_cardbackAry[2].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_bm_bg_12");
                        this.bmp_cardbackAry[3].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_mj_bg_11");
                        this.bmp_cardcolorAry[1].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                    }else{
                ...
                case enFixedCardType.FixedCardType_BGang: {
                    ...
                    if(this._cardIndex==1){
                        this.bmp_cardbackAry[0].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_mj_bg_01");
                        this.bmp_cardbackAry[1].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_mj_bg_02");
                        this.bmp_cardbackAry[2].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_mj_bg_03");
                        this.bmp_cardbackAry[3].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_mj_bg_02");
                        this.bmp_cardcolorAry[0].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[1].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[2].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                    }else if(this._cardIndex==2){
                        this.bmp_cardbackAry[0].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_mj_bg_04");
                        this.bmp_cardbackAry[1].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_mj_bg_05");
                        this.bmp_cardbackAry[2].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_mj_bg_06");
                        this.bmp_cardbackAry[3].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_mj_bg_05");
                        this.bmp_cardcolorAry[0].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[1].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[2].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                    }else if(this._cardIndex==3){
                        this.bmp_cardbackAry[0].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_mj_bg_07");
                        this.bmp_cardbackAry[1].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_mj_bg_08");
                        this.bmp_cardbackAry[2].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_mj_bg_09");
                        this.bmp_cardbackAry[3].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_mj_bg_08");
                        this.bmp_cardcolorAry[0].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[1].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[2].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                    }else if(this._cardIndex==4){
                        this.bmp_cardbackAry[0].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_mj_bg_10");
                        this.bmp_cardbackAry[1].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_mj_bg_11");
                        this.bmp_cardbackAry[2].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_mj_bg_12");
                        this.bmp_cardbackAry[3].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_mj_bg_11");
                        this.bmp_cardcolorAry[0].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[1].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[2].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                ...
                case enFixedCardType.FixedCardType_Peng: {
                    ...
                    if(this._cardIndex==1){
                        ...
                        this.bmp_cardbackAry[1].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_mj_bg_02");
                        this.bmp_cardbackAry[2].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_mj_bg_03");
                        // this.bmp_cardbackAry[3].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_mj_bg_13");
                        //this.bmp_cardbackAry[3].spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("pb3_showcard_self_1280");
                        this.bmp_cardcolorAry[0].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[1].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[2].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        ...
                        this.bmp_cardbackAry[1].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_mj_bg_05");
                        this.bmp_cardbackAry[2].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_mj_bg_06");
                        // this.bmp_cardbackAry[3].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_mj_bg_10");
                        //this.bmp_cardbackAry[3].spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("pb3_showcard_self_1280");
                        this.bmp_cardcolorAry[0].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[1].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[2].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        ...
                        this.bmp_cardbackAry[1].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_mj_bg_08");
                        this.bmp_cardbackAry[2].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_mj_bg_09");
                        // this.bmp_cardbackAry[3].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_mj_bg_07");
                        //this.bmp_cardbackAry[3].spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("pb3_showcard_self_1280");
                        this.bmp_cardcolorAry[0].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[1].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[2].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        ...
                        this.bmp_cardbackAry[1].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_mj_bg_11");
                        this.bmp_cardbackAry[2].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_mj_bg_12");
                        // this.bmp_cardbackAry[3].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_left_mj_bg_04");
                        //this.bmp_cardbackAry[3].spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("pb3_showcard_self_1280");
                        this.bmp_cardcolorAry[0].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[1].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[2].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
    ...
    private set3DSize(){
        switch(this._cardIndex){
            case 1:{
                ...
                this.bmp_cardcolorAry[2].node.zIndex = (5);
                ...
                this.bmp_cardbackAry[3].node.zIndex = (6);
                this.bmp_cardbackAry[3].node.scaleX=1;    
