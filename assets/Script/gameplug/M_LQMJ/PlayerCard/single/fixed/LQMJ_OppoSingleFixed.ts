...
@ccclass
export default class LQMJ_OppoSingleFixed extends LQMJ_SingleFixedBase {
    onLoad() {
        // init logic
        ...
        if(_lqmj.is2D()){
            ...
            switch(this.fixedType) {
                case enFixedCardType.FixedCardType_AGang: {
                    ...
                    this.bmp_cardbackAry[0].spriteFrame=_lqmj.getMahjongPaiBeiRes("shangdp_fan@2x");
                    this.bmp_cardbackAry[1].spriteFrame=_lqmj.getMahjongPaiBeiRes("shangdp_fan@2x");
                    this.bmp_cardbackAry[2].spriteFrame=_lqmj.getMahjongPaiBeiRes("shangdp_fan@2x");
                    this.bmp_cardbackAry[3].spriteFrame=_lqmj.getMahjongPaiBeiRes("shangdp_back@2x");
                ...
                case enFixedCardType.FixedCardType_BGang: {
                    url=`gameres/gameCommonRes/Texture/Mahjong/PaiBei3/pb3_showcard_oppo_1280`;
                    this.bmp_cardbackAry[0].spriteFrame=_lqmj.getMahjongPaiBeiRes("shangdp_back@2x");
                    this.bmp_cardbackAry[1].spriteFrame=_lqmj.getMahjongPaiBeiRes("shangdp_back@2x");
                    this.bmp_cardbackAry[2].spriteFrame=_lqmj.getMahjongPaiBeiRes("shangdp_back@2x");
                    this.bmp_cardbackAry[3].spriteFrame=_lqmj.getMahjongPaiBeiRes("shangdp_back@2x");
                ...
                case enFixedCardType.FixedCardType_Chi: {
                    ...
                    this.bmp_cardbackAry[1].spriteFrame=_lqmj.getMahjongPaiBeiRes("shangdp_back@2x");
                    this.bmp_cardbackAry[2].spriteFrame=_lqmj.getMahjongPaiBeiRes("shangdp_back@2x");
                    this.bmp_cardcolorAry[0].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue + this._chiType);
                    this.bmp_cardcolorAry[1].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue + this._chiType - 1);
                    this.bmp_cardcolorAry[2].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue + this._chiType - 2);
            ...
            switch(this.fixedType) {
                case enFixedCardType.FixedCardType_AGang: {
                    if(this._cardIndex==1){
                        this.bmp_cardbackAry[0].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_oppo_2_15");
                        this.bmp_cardbackAry[1].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_oppo_2_16");
                        this.bmp_cardbackAry[2].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_oppo_2_17");
                        this.bmp_cardbackAry[3].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_oppo_1_16");
                        this.bmp_cardcolorAry[3].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[3].node.scaleX = 0.4;
                        this.bmp_cardcolorAry[3].node.scaleY = 0.38;
                    }else if(this._cardIndex==2){
                        this.bmp_cardbackAry[0].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_oppo_2_12");
                        this.bmp_cardbackAry[1].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_oppo_2_13");
                        this.bmp_cardbackAry[2].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_oppo_2_14");
                        this.bmp_cardbackAry[3].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_oppo_1_13");
                        this.bmp_cardcolorAry[3].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[3].node.scaleX = 0.4;
                        this.bmp_cardcolorAry[3].node.scaleY = 0.38;
                    }else if(this._cardIndex==3){
                        this.bmp_cardbackAry[0].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_oppo_2_9");
                        this.bmp_cardbackAry[1].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_oppo_2_10");
                        this.bmp_cardbackAry[2].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_oppo_2_11");
                        this.bmp_cardbackAry[3].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_oppo_1_10");
                        this.bmp_cardcolorAry[3].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[3].node.scaleX = 0.4;
                        this.bmp_cardcolorAry[3].node.scaleY = 0.38;
                    }else if(this._cardIndex==4){
                        this.bmp_cardbackAry[0].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_oppo_2_6");
                        this.bmp_cardbackAry[1].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_oppo_2_7");
                        this.bmp_cardbackAry[2].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_oppo_2_8");
                        this.bmp_cardbackAry[3].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_oppo_1_7");
                        this.bmp_cardcolorAry[3].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[3].node.scaleX = 0.4;
                        this.bmp_cardcolorAry[3].node.scaleY = 0.38;
                    }else{
                ...
                case enFixedCardType.FixedCardType_BGang: {
                    if(this._cardIndex==1){
                        this.bmp_cardbackAry[0].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_oppo_1_15");
                        this.bmp_cardbackAry[1].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_oppo_1_16");
                        this.bmp_cardbackAry[2].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_oppo_1_17");
                        this.bmp_cardbackAry[3].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_oppo_1_16");
                        this.bmp_cardcolorAry[0].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[1].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[2].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue);
                        ...
                        this.bmp_cardbackAry[0].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_oppo_1_12");
                        this.bmp_cardbackAry[1].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_oppo_1_13");
                        this.bmp_cardbackAry[2].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_oppo_1_14");
                        this.bmp_cardbackAry[3].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_oppo_1_13");
                        this.bmp_cardcolorAry[0].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[1].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[2].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue);
                        ...
                        this.bmp_cardbackAry[0].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_oppo_1_9");
                        this.bmp_cardbackAry[1].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_oppo_1_10");
                        this.bmp_cardbackAry[2].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_oppo_1_11");
                        this.bmp_cardbackAry[3].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_oppo_1_10");
                        this.bmp_cardcolorAry[0].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[1].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[2].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue);
                        ...
                        this.bmp_cardbackAry[0].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_oppo_1_6");
                        this.bmp_cardbackAry[1].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_oppo_1_7");
                        this.bmp_cardbackAry[2].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_oppo_1_8");
                        this.bmp_cardbackAry[3].spriteFrame=_lqmj.getMahjong3DPaiBeiRes("chi_oppo_1_7");
                        this.bmp_cardcolorAry[0].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[1].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[2].spriteFrame=_lqmj.getMahjongPaiHuaRes(this.cardValue);
