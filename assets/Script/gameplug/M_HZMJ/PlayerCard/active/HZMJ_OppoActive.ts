...
@ccclass
export default class HZMJ_OppoActive extends HZMJ_OtherActive {
    ...
    //
        ...
        if(HZMJ.ins.iclass.is2D()){
            if(this.isLie) {
                //起始位置
                var startPos: number = HZMJ_OppoActive.ArrangeStartPos_lie[this.fixedCardNum];
                ...
                //起始位置
                var startPos: number = HZMJ_OppoActive.ArrangeStartPos_stand[this.fixedCardNum];
            ...
            if(this.isLie) {
            //起始位置
                let startPos: number = HZMJ_OppoActive.ArrangeStartPos3D_lie[this.fixedCardNum];
                this.resetZ();
                ...
                //起始位置
                let startPos: number = HZMJ_OppoActive.ArrangeStartPos3D_stand[this.fixedCardNum];
