    ...
    public showGang(gangCard: Array<number>): void {
        ...
        if(2 == this._gangCard.length){
            ...
            for(var i:number = 0;i<4;i++){
                this.img_0[i].spriteFrame = MGMJ.ins.iclass.getMahjongPaiHuaRes(this._gangCard[0]);
                this.img_1[i].spriteFrame = MGMJ.ins.iclass.getMahjongPaiHuaRes(this._gangCard[1]);
            }                  
        }
        if(3 == this._gangCard.length){
            ...
            for(var i:number = 0;i<4;i++){
                this.img_0[i].spriteFrame = MGMJ.ins.iclass.getMahjongPaiHuaRes(this._gangCard[0]);
                this.img_1[i].spriteFrame = MGMJ.ins.iclass.getMahjongPaiHuaRes(this._gangCard[1]);
                this.img_2[i].spriteFrame = MGMJ.ins.iclass.getMahjongPaiHuaRes(this._gangCard[2]);
            }
        }
        ...
        //    //     this.img_2.spriteFrame=MGMJ.ins.iclass.getMahjongPaiHuaRes(this._gangCard[2]);
        //     }
        //    // this.img_0.spriteFrame=MGMJ.ins.iclass.getMahjongPaiHuaRes(this._gangCard[0]);

        //    // this.img_1.spriteFrame=MGMJ.ins.iclass.getMahjongPaiHuaRes(this._gangCard[1]);
        //     this.node.active = true;
        // }
    }
}
