...
import { allZhi } from "../ConstDef/TDHMJMahjongDef";
import { enTinType, enFixedCardType } from "../ConstDef/TDHMJMahjongDef";
import M_TDHMJView from "../M_TDHMJView";

const { ccclass, property } = cc._decorator;

	export class TDHMJMahjongAlgorithm {
        ...
        public static GetMahjongColor(card:number):number{
            return (card & TDHMJMahjongDef.gCardMask_color) >> 4;
        }
        /**
         * 取花色数值,0x00万,0x10筒,0x20条
         * */
        public static GetMahjongColorValue(card:number):number{
            return (card & TDHMJMahjongDef.gCardMask_color);
        }
        /**
         * 取麻将牌值,1~9,一万==一筒==一条
         * */
        public static GetMahjongValue(card):number{
            return (card & TDHMJMahjongDef.gCardMask_value);
        }
        /**
         * 取麻将牌逻辑数值,取牌逻辑值:万<筒<条<字<花
         * */
        public static GetMahjongLogicValue(card):number{
            return TDHMJMahjongAlgorithm.GetMahjongColor(card) * 10 + TDHMJMahjongAlgorithm.GetMahjongValue(card);
        }
        ...
        public static CheckVoteRight_Chi(voteRight:number):boolean{
            return (voteRight & TDHMJMahjongDef.gVoteRightMask_Chi) > 0;
        }
        /**
         * 检查是否可以碰
         * */
        public static CheckVoteRight_Peng(voteRight:number):boolean{
            return (voteRight & TDHMJMahjongDef.gVoteRightMask_Peng) > 0;
        }
        /**
         * 检查是否可以杠
         * */
        public static CheckVoteRight_Gang(voteRight: number): boolean {
            return (voteRight & TDHMJMahjongDef.gVoteRightMask_Gang) > 0;
        }
        /**
         * 检查是否可以豹
         * */
        public static CheckVoteRight_Bao(voteRight:number):boolean{
            return (voteRight & TDHMJMahjongDef.gVoteRightMask_Bao) > 0;
        }
        /**
         * 检查是否可以胡
         * */
        public static CheckVoteRight_Hu(voteRight: number): boolean {
            return (voteRight & TDHMJMahjongDef.gVoteRightMask_Hu) > 0;
        }
        ...
        public static checkHaveColor(handCard: Array<number>,color:number):boolean{
            for(var i:number=0; i<handCard.length; i++){
                if(color == TDHMJMahjongAlgorithm.GetMahjongColor(handCard[i])){
                    return true;
                }
            }
            return false;
        ...
        public static spiltHandCard(handCard:Array<number>,wan:Array<number>,tong:Array<number>,tiao:Array<number>,zhi:Array<number>):void{
            ...
            for(var i:number=0; i<handCard.length; i++){
                if(TDHMJMahjongDef.gInvalidMahjongValue != handCard[i]){
                    switch(TDHMJMahjongAlgorithm.GetMahjongColor(handCard[i])){
                        case TDHMJMahjongDef.gMahjongColor_Wan:{
                            if(null != wan){
                                wan.push(handCard[i]);
                            }
                            break;
                        }
                        case TDHMJMahjongDef.gMahjongColor_Tong:{
                            if(null != tong){
                                tong.push(handCard[i]);
                            }
                            break;
                        }
                        case TDHMJMahjongDef.gMahjongColor_Tiao:{
                            if(null != tiao){
                                tiao.push(handCard[i]);
                            }
                            break;
                        }
                        case TDHMJMahjongDef.gMahjongColor_Zhi:{
                            if(null != zhi){
                                zhi.push(handCard[i]);
                            }
                        }
        ...
        public static GetLastCardToTing(srcAry:Array<number>):Array<number>{       
            ...
            //不排序，排序会打乱对应
            //TDHMJMahjongAlgorithm.sortCardAry(vectorChuCard);
        }
        /**
		 * 检查是否听牌
		 */
        public static CheckIfCanTingCardArray(srcAry:Array<number>):Boolean{
            ...
            for(var i:number=0;i<srcAry.length;i++)
            {
                if(TDHMJMahjongDef.gInvalidMahjongValue!=srcAry[i])
                    cardAry.push(srcAry[i]);
            }
            if(1 != (cardAry.length % 3)) {
                return false;
            }
            TDHMJMahjongAlgorithm.sortCardAry(cardAry);
     ...
     */
        private static CheckIfCanSpecialTing(vSrc:Array<number>):boolean{
            //听七对
            if(!TDHMJMahjongAlgorithm.isCanHu7Dui){
                return false;
            }
        ...
        public static CheckIfTingShiSanLan(vSrc:Array<number>):boolean
        {
            ...
            TDHMJMahjongAlgorithm.spiltHandCard(handCard, vWanCard, vTongCard, vTiaoCard, vZhiCard);
        ...
        private static CheckIfTingSevenPair(vSrc:Array<number>):boolean{
            ...
            TDHMJMahjongAlgorithm.sortCardAry(vSrc);
        ...
        public static GetTwo2ModelTinCards(vectorCard1: Array<number>,vectorCard2: Array<number>): Array<number> {
            ...
            if(this.GetMahjongColor(vectorCard1[0]) < TDHMJMahjongDef.gMahjongColor_Zhi)//万,筒,条
            {
            ...
            if(this.GetMahjongColor(vectorCard2[0]) < TDHMJMahjongDef.gMahjongColor_Zhi)//万,筒,条
            {
        ...
        public static Get2ModelTinCards(vectorCard: Array<number>): Array<number> {
            ...
            if(this.GetMahjongColor(vectorCard[0]) < TDHMJMahjongDef.gMahjongColor_Zhi)//万,筒,条
            {
                //2张
                if(vectorCard.length == 2) {
        ...
        public static Get1ModelTinCards(cardVector: Array<number>): Array<number> {
            ...
            if(this.GetMahjongColor(cardVector[0]) < TDHMJMahjongDef.gMahjongColor_Zhi)//万,筒,条
            {
                //1张
