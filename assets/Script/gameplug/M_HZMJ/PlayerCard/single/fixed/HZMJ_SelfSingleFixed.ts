...
@ccclass
export default class HZMJ_SelfSingleFixed extends HZMJ_SingleFixedBase {
        ...
        if(HZMJ.ins.iclass.is2D()){
            ...
            switch(this.fixedType) {
                case enFixedCardType.FixedCardType_AGang: {
                    ...
                    this.bmp_cardbackAry[0].spriteFrame=HZMJ.ins.iclass.getMahjongPaiBeiRes("pb3_backcard_self_1280");
                    this.bmp_cardbackAry[1].spriteFrame=HZMJ.ins.iclass.getMahjongPaiBeiRes("pb3_backcard_self_1280");
                    this.bmp_cardbackAry[2].spriteFrame=HZMJ.ins.iclass.getMahjongPaiBeiRes("pb3_backcard_self_1280");
                    this.bmp_cardbackAry[3].spriteFrame=HZMJ.ins.iclass.getMahjongPaiBeiRes("pb3_showcard_self_1280");
                ...
                case enFixedCardType.FixedCardType_BGang: {
                    ...
                    this.bmp_cardbackAry[0].spriteFrame=HZMJ.ins.iclass.getMahjongPaiBeiRes("pb3_showcard_self_1280");
                    this.bmp_cardbackAry[1].spriteFrame=HZMJ.ins.iclass.getMahjongPaiBeiRes("pb3_showcard_self_1280");
                    this.bmp_cardbackAry[2].spriteFrame=HZMJ.ins.iclass.getMahjongPaiBeiRes("pb3_showcard_self_1280");
                    this.bmp_cardbackAry[3].spriteFrame=HZMJ.ins.iclass.getMahjongPaiBeiRes("pb3_showcard_self_1280");
            ...
            switch(this.fixedType) {
                case enFixedCardType.FixedCardType_AGang: {
                    ...
                    if(this._cardIndex==1){
                        this.bmp_cardbackAry[0].spriteFrame=HZMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_self_2_17");
                        this.bmp_cardbackAry[1].spriteFrame=HZMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_self_2_16");
                        this.bmp_cardbackAry[2].spriteFrame=HZMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_self_2_15");
                        this.bmp_cardbackAry[3].spriteFrame=HZMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_self_1_16");
                       ...
                       this.bmp_cardbackAry[0].node.x=32;
                        ...
                        this.bmp_cardbackAry[2].node.y=30;
                        this.bmp_cardbackAry[3].node.x=71;
                        this.bmp_cardbackAry[3].node.y=36;
                                            
                        this.bmp_cardcolorAry[0].node.x=0;
                        this.bmp_cardcolorAry[0].node.y=2;
                        this.bmp_cardcolorAry[1].node.x=0;
                        ...
                        this.bmp_cardcolorAry[3].node.y=2;

                        for(var i=0;i<4;i++){
                            this.bmp_cardcolorAry[i].node.scaleX = 0.37;
                            this.bmp_cardcolorAry[i].node.scaleY = 0.40;
                            this.bmp_cardcolorAry[i].node.skewX = 5;
                        }
                    }else if(this._cardIndex==2){
                        this.bmp_cardbackAry[0].spriteFrame=HZMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_self_2_14");
                        this.bmp_cardbackAry[1].spriteFrame=HZMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_self_2_13");
                        this.bmp_cardbackAry[2].spriteFrame=HZMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_self_2_12");
                        this.bmp_cardbackAry[3].spriteFrame=HZMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_self_1_13");
                        this.bmp_cardcolorAry[3].spriteFrame=HZMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        ...
                        this.bmp_cardbackAry[1].node.y=30;
                        this.bmp_cardbackAry[2].node.x=31;
                        this.bmp_cardbackAry[2].node.y=28;
                        ...
                        this.bmp_cardbackAry[0].spriteFrame=HZMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_self_2_11");
                        this.bmp_cardbackAry[1].spriteFrame=HZMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_self_2_10");
                        this.bmp_cardbackAry[2].spriteFrame=HZMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_self_2_9");
                        this.bmp_cardbackAry[3].spriteFrame=HZMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_self_1_10");
                        this.bmp_cardcolorAry[3].spriteFrame=HZMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        
                        this.bmp_cardbackAry[0].node.x=-155;
                        this.bmp_cardbackAry[0].node.y=30;
                        this.bmp_cardbackAry[1].node.x=-109;
                        this.bmp_cardbackAry[1].node.y=29;
                        this.bmp_cardbackAry[2].node.x=-64;
                        this.bmp_cardbackAry[2].node.y=29;
                        this.bmp_cardbackAry[3].node.x=-110;
                        this.bmp_cardbackAry[3].node.y=36;
                        ...
                        this.bmp_cardbackAry[0].spriteFrame=HZMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_self_2_8");
                        this.bmp_cardbackAry[1].spriteFrame=HZMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_self_2_7");
                        this.bmp_cardbackAry[2].spriteFrame=HZMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_self_2_6");
                        this.bmp_cardbackAry[3].spriteFrame=HZMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_self_1_7");
                        this.bmp_cardcolorAry[3].spriteFrame=HZMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        
                         this.bmp_cardbackAry[0].node.x=-245;
                        this.bmp_cardbackAry[0].node.y=28;
                        this.bmp_cardbackAry[1].node.x=-199;
                        this.bmp_cardbackAry[1].node.y=27;
                        this.bmp_cardbackAry[2].node.x=-154;
                        this.bmp_cardbackAry[2].node.y=27;
                        this.bmp_cardbackAry[3].node.x=-198;
                        this.bmp_cardbackAry[3].node.y=33;
                ...
                case enFixedCardType.FixedCardType_MGang: {
                    if(this._cardIndex==1){
                        this.bmp_cardbackAry[0].spriteFrame=HZMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_self_1_17");
                        this.bmp_cardbackAry[1].spriteFrame=HZMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_self_1_16");
                        this.bmp_cardbackAry[2].spriteFrame=HZMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_self_1_15");
                        this.bmp_cardbackAry[3].spriteFrame=HZMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_self_1_16");
                        this.bmp_cardcolorAry[0].spriteFrame=HZMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[1].spriteFrame=HZMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[2].spriteFrame=HZMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        ...
                        this.bmp_cardcolorAry[3].node.y=5;
                        ...
                        this.bmp_cardcolorAry[0].node.scaleX = 0.58;
                        this.bmp_cardcolorAry[0].node.scaleY = 0.61;
                    }else if(this._cardIndex==2){
                        this.bmp_cardbackAry[0].spriteFrame=HZMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_self_1_14");
                        this.bmp_cardbackAry[1].spriteFrame=HZMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_self_1_13");
                        this.bmp_cardbackAry[2].spriteFrame=HZMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_self_1_12");
                        this.bmp_cardbackAry[3].spriteFrame=HZMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_self_1_13");
                        this.bmp_cardcolorAry[0].spriteFrame=HZMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[1].spriteFrame=HZMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[2].spriteFrame=HZMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        ...
                        this.bmp_cardbackAry[2].node.x=31;
                        this.bmp_cardbackAry[2].node.y=28;
                        this.bmp_cardbackAry[3].node.x=-22;
                        this.bmp_cardbackAry[3].node.y=36; 
                        ...
                        this.bmp_cardbackAry[0].spriteFrame=HZMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_self_1_11");
                        this.bmp_cardbackAry[1].spriteFrame=HZMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_self_1_10");
                        this.bmp_cardbackAry[2].spriteFrame=HZMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_self_1_9");
                        this.bmp_cardbackAry[3].spriteFrame=HZMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_self_1_10");
                        this.bmp_cardcolorAry[0].spriteFrame=HZMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[1].spriteFrame=HZMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[2].spriteFrame=HZMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        ...
                        this.bmp_cardbackAry[0].spriteFrame=HZMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_self_1_8");
                        this.bmp_cardbackAry[1].spriteFrame=HZMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_self_1_7");
                        this.bmp_cardbackAry[2].spriteFrame=HZMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_self_1_6");
                        this.bmp_cardbackAry[3].spriteFrame=HZMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_self_1_7");
                        this.bmp_cardcolorAry[0].spriteFrame=HZMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[1].spriteFrame=HZMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[2].spriteFrame=HZMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                ...
                case enFixedCardType.FixedCardType_Peng: {                  
                    ...
                    if(this._cardIndex==1){
                        ...
                        this.bmp_cardbackAry[0].spriteFrame=HZMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_self_1_7");
                        this.bmp_cardbackAry[1].spriteFrame=HZMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_self_1_6");
                        this.bmp_cardbackAry[2].spriteFrame=HZMJ.ins.iclass.getMahjong3DPaiBeiRes("chi_self_1_5");
                        //this.bmp_cardbackAry[3].spriteFrame=HZMJ.ins.iclass.getMahjongPaiBeiRes("pb3_showcard_self_1280");
                        this.bmp_cardcolorAry[0].spriteFrame=HZMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[1].spriteFrame=HZMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[2].spriteFrame=HZMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
