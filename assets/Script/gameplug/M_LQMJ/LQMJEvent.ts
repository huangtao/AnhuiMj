...
export default class LQMJEvent extends cc.Event.EventCustom {


    /**
         * 消息标识
         * */
        public static LQMJ_EVENT_TYPE: string = "event_hnmj_event_type";
        ...
        public constructor(msgCode: number,parm?: any,data?: any) {
            ...
            super(LQMJEvent.LQMJ_EVENT_TYPE,true);
         ...
         * 克隆一个
         * */
        public clone(): LQMJEvent {
            return new LQMJEvent(this._msgCode,this._parm,this.getUserData());
        }
}
