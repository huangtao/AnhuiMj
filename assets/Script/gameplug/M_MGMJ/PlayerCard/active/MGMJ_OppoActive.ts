...
@ccclass
export default class MGMJ_OppoActive extends MGMJ_OtherActive {
    ...
    //
        ...
        if(MGMJ.ins.iclass.is2D()){
            if(this.isLie) {
                //起始位置
                var startPos: number = MGMJ_OppoActive.ArrangeStartPos_lie[this.fixedCardNum];
                ...
                //起始位置
                var startPos: number = MGMJ_OppoActive.ArrangeStartPos_stand[this.fixedCardNum];
            ...
            if(this.isLie) {
            //起始位置
                let startPos: number = MGMJ_OppoActive.ArrangeStartPos3D_lie[this.fixedCardNum];
                //this.resetZ();
                ...
                //起始位置
                let startPos: number = MGMJ_OppoActive.ArrangeStartPos3D_stand[this.fixedCardNum];
