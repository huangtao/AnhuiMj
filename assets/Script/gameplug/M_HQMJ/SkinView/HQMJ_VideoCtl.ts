...
@ccclass
export default class HQMJ_VideoCtl extends cc.Component {
    ...
    onLoad() {
        ...
        this.btn_exit.node.on("click", () => {
            M_HQMJVideoClass.ins.exit();    
        },this);
        
        this.btn_play.node.on("click", () => {
            M_HQMJVideoClass.ins.Resume();
