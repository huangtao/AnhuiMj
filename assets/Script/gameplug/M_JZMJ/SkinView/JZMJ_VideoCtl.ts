...
@ccclass
export default class JZMJ_VideoCtl extends cc.Component {
    ...
    onLoad() {
        ...
        this.btn_exit.node.on("click", () => {
            M_JZMJVideoClass.ins.exit();    
        },this);
        
        this.btn_play.node.on("click", () => {
            M_JZMJVideoClass.ins.Resume();
