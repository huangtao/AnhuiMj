...
@ccclass
export default class LQMJ_VideoCtl extends cc.Component {
    ...
    onLoad() {
        ...
        this.btn_exit.node.on("click", () => {
            M_LQMJVideoClass.ins.exit();    
        },this);
        
        this.btn_play.node.on("click", () => {
            M_LQMJVideoClass.ins.Resume();
