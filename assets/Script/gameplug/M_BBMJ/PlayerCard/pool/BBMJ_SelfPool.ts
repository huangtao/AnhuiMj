...
@ccclass
export default class BBMJ_SelfPool extends BBMJ_PoolBase {
    ...
    private resetZ(){
        if(this._poolCard.length<=5){
            ...
            for(let i: number = 5;i < 9;i++){
                this._poolCard[i].node.zIndex = (9-i);
            }
            ...
            for(let i: number = 5;i < 10;i++){
                this._poolCard[i].node.zIndex = (10-i);
            }
            for(let i: number = 10;i < 15;i++){
                this._poolCard[i].node.zIndex = (i);
            }
            for(let i: number = 15;i < this._poolCard.length;i++){
                this._poolCard[i].node.zIndex = (10+this._poolCard.length-i);
            }
            ...
            for(let i: number = 15;i < 20;i++){
                this._poolCard[i].node.zIndex = (20-i+10);
            }
            ...
            for(let i: number = 25;i < this._poolCard.length;i++){
                this._poolCard[i].node.zIndex = (20+this._poolCard.length-i);
            }
        }
    }
}
