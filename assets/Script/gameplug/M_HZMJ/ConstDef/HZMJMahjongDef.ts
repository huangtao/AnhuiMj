...
const { ccclass, property } = cc._decorator;
    ...
    export interface IHZMJClass {
        ...
        getTableConfig():HZMJTableConfig;
    ...
    export class HZMJ{
        ...
        private static _ins:HZMJ=null;
        private _icalss:IHZMJClass=null;
        private _iview:IHZMJView=null;
         ...
         * 逻辑
         * */
        public get iclass():IHZMJClass{
            return this._icalss;
        }
        public set iclass(value:IHZMJClass){
            this._icalss = value;
        }
         ...
         * 视图
         * */
        public get iview():IHZMJView{
            return this._iview;
        }
        public set iview(value:IHZMJView){
            this._iview = value;
        }
    }


	export class HZMJMahjongDef {
	...
	export class HZMJSoundDef{
         ...
         * 音频路径
         */
        public static VoicePath: string = "resources/gameres/gameCommonRes/Voice/MJ_Voice";
        /**
         * 公共音频路径
         */
        public static CommonVoicePath: string = "resources/gameres/gameCommonRes/Voice/";
	}
    ...
    export class HZMJTableConfig{
        ...
        //是否房主买单
        private _tableCreatorPay:boolean;
        //房费
        ...
        public constructor(){    
            ...
            this._tableCreatorChair = HZMJMahjongDef.gInvalidChar;
            this._tableCode = "";
            this._setGameNum=1;
        ...
        */
        ...
        public get cellScore():number{
            if(HZMJ.ins.iclass.isCreateRoom()){
                return this._cellScore;
                       ...
                       if(HZMJ.ins.iclass.getRoomData()){
                return HZMJ.ins.iclass.getRoomData().BaseMoney;
            }
            else{
        ...
        public get shareContext():string{
          ...
          if(this._ifCanSameIP) {
            ...
            //
             context+=`${this._isLaPaoZuo?"最多跑一，":""}`;
             context+=`${this._ifGangLeJiuYou?"最多跑二，":""}`;
         //    context+=`${this._isGangKai?"杠上开花双倍，":"杠上开花四倍"}`;
             context+=`${this._isBuKao?"无风牌，":""}`;
            // context+=`${this._isYiPaoDuoXiang?"一炮多响":"不带一炮多响"}。`;
    ...
    export class HZMJTimer{
        ...
        public clear():void{
            ...
            this._curTime=0;
            this._triggerTime=0;
            this._chair = HZMJMahjongDef.gInvalidChar;
     ...
     * 合肥麻将打牌玩家
     * */
    export class HZMJOutCardPlayer{
        private _chair:number;
         ...
         * */
        public get isValid():boolean{
            if((HZMJMahjongDef.gInvalidChar != this._chair) && (HZMJMahjongDef.gInvalidMahjongValue != this._card)){
                return true;
            }
            return false;
        }
        ...
        public clear():void{
            this._chair = HZMJMahjongDef.gInvalidChar;
            this._card = HZMJMahjongDef.gInvalidMahjongValue;
        }
    }
    ...
    export class HZMJRecordCard{
        ...
        public getCardLeftNum(card:number,checkAry:Array<number> = null):number{
            var logicValue: number = HZMJMahjongAlgorithm.GetMahjongLogicValue(card);
    ...
    export class clsParseTriple
    {
        ...
        public Clear():void
        {
            this.cTokenCard = HZMJMahjongDef.gInvalidMahjongValue;
        ...
        public GetTokenNum():number
        {
            ...
            return (wBaseNum + HZMJMahjongAlgorithm.GetMahjongLogicValue(this.cTokenCard));
        }
        ...
        public get isValid():boolean
        {
                if ((HZMJMahjongDef.gInvalidMahjongValue != this.cTokenCard) && (enTripleType.TripleType_Unknown != this.enTripleType)){
                    return true;
                }
                return false;
        }
   ...
   /// <summary>
    ...
    export class clsNormalParseStruct
    {
        ...
        public Clear():void
        {
            this.pair = HZMJMahjongDef.gInvalidMahjongValue;
        ...
        public get isValid():boolean
        {
            ...
            return this.pair != HZMJMahjongDef.gInvalidMahjongValue;
    ...
    export class clsParseResult
    {
        ...
        public Clear():void
        {
            this.isValid = false;
            this.is7Pair = false;
            this.huCard = HZMJMahjongDef.gInvalidMahjongValue;
    ...
    export class clsSingleFixedCard
    {
	    ...
	    public Clear():void
	    {
            this.card = HZMJMahjongDef.gInvalidMahjongValue;
    ...
    export class clsPairTripleWrapper
    {
        ...
        public Clear():void
        {
            this.cPair = HZMJMahjongDef.gInvalidMahjongValue;
            this.wTripleCount = 0;
