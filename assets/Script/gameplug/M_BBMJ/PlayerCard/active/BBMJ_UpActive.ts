...
@ccclass
export default class BBMJ_UpActive extends BBMJ_OtherActive {
    ...
    protected refreshHandCard(): void {
        ...
        if(BBMJ.ins.iclass.is2D()){
            ...
            if(this.isLie) {
            //起始位置
            var startPos: number = BBMJ_UpActive.ArrangeStartPos_lie[this.fixedCardNum];
            ...
            //起始位置
            var startPos: number = BBMJ_UpActive.ArrangeStartPos_stand[this.fixedCardNum];
