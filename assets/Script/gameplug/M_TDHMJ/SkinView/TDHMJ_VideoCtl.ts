...
@ccclass
export default class TDHMJ_VideoCtl extends cc.Component {
    ...
    onLoad() {
        ...
        this.btn_exit.node.on("click", () => {
            M_TDHMJVideoClass.ins.exit();    
        },this);
        
        this.btn_play.node.on("click", () => {
            M_TDHMJVideoClass.ins.Resume();
