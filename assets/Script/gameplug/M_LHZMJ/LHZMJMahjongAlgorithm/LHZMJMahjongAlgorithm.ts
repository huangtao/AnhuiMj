...
import { enTinType, enFixedCardType } from "../ConstDef/LHZMJMahjongDef";
import M_LHZMJView from "../M_LHZMJView";

const { ccclass, property } = cc._decorator;

	export class LHZMJMahjongAlgorithm {
        ...
        public static GetMahjongLogicValue(card):number{
            return LHZMJMahjongAlgorithm.GetMahjongColor(card) * 10 + LHZMJMahjongAlgorithm.GetMahjongValue(card);
        }
        ...
        public static checkHaveColor(handCard: Array<number>,color:number):boolean{
            for(var i:number=0; i<handCard.length; i++){
                if(color == LHZMJMahjongAlgorithm.GetMahjongColor(handCard[i])){
                    return true;
                }
            }
            return false;
        ...
        public static spiltHandCard(handCard:Array<number>,wan:Array<number>,tong:Array<number>,tiao:Array<number>,zhi:Array<number>):void{
            ...
            for(var i:number=0; i<handCard.length; i++){
                if(LHZMJMahjongDef.gInvalidMahjongValue != handCard[i]){
                    switch(LHZMJMahjongAlgorithm.GetMahjongColor(handCard[i])){
        ...
        public static GetLastCardToTing(srcAry:Array<number>):Array<number>{       
            ...
            //不排序，排序会打乱对应
            //LHZMJMahjongAlgorithm.sortCardAry(vectorChuCard);
        }
       ...
       /// <summary>
        ...
        public static CheckIfCanTingCardArray(srcAry:Array<number>):Boolean{
            ...
            LHZMJMahjongAlgorithm.sortCardAry(cardAry);
     ...
     */
        ...
        public static CheckIfTingShiSanLan(vSrc:Array<number>):boolean
        {
            ...
            LHZMJMahjongAlgorithm.spiltHandCard(handCard, vWanCard, vTongCard, vTiaoCard, vZhiCard);
        ...
        private static CheckIfTingSevenPair(vSrc:Array<number>):boolean{
            ...
            LHZMJMahjongAlgorithm.sortCardAry(vSrc);
