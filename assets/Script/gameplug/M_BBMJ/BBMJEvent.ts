...
export default class BBMJEvent extends cc.Event.EventCustom {


    /**
         * 消息标识
         * */
        public static BBMJ_EVENT_TYPE: string = "event_hnmj_event_type";
        ...
        public constructor(msgCode: number,parm?: any,data?: any) {
            ...
            super(BBMJEvent.BBMJ_EVENT_TYPE,true);
         ...
         * 克隆一个
         * */
        public clone(): BBMJEvent {
            return new BBMJEvent(this._msgCode,this._parm,this.getUserData());
        }
}
