...
@ccclass
export default class M_HQMJSetting extends CreateRoomSettingBase {
    public GetSetting() {
    ...
    private Init(): void {
           const tempdata=new M_HQMJ_GameData();
    ...
    private onCreateTable(): CreateRoomStruct {
        const createTable = new M_HQMJ_GameData();
