...
@ccclass
export default class MGMJ_DownVideoActive extends MGMJ_VideoActiveBase {
    ...
    protected refreshHandCard(): void {   
        ...
        if(MGMJ.ins.iclass.is2D()){
            //起始位置
            let startPos: number = MGMJ_DownVideoActive.ArrangeStartPos_lie[this.fixedCardNum];
            ...
            //起始位置
            let startPos: number = MGMJ_DownVideoActive.ArrangeStartPos3D_lie[this.fixedCardNum];
