import BBMJ_SingleFixedBase from "../BBMJ_SingleFixedBase";
import { enFixedCardType, BBMJ } from "../../../ConstDef/BBMJMahjongDef";
import { SetTextureRes } from "../../../../MJCommon/MJ_Function";

const { ccclass, property } = cc._decorator;

@ccclass
export default class BBMJ_OppoSingleFixed extends BBMJ_SingleFixedBase {
    ...
    //             this.bmp_cardbackAry[0].spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("pb3_showcardback_oppo_self_1280");
    //             this.bmp_cardbackAry[1].spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("pb3_showcardback_oppo_self_1280");
    //             this.bmp_cardbackAry[2].spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("pb3_showcardback_oppo_self_1280");
    //             this.bmp_cardbackAry[3].spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("pb3_showcard_oppo_1280");
    //             this.bmp_cardcolorAry[1].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
    ...
    //             this.bmp_cardbackAry[0].spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("pb3_showcard_oppo_1280");
    //             this.bmp_cardbackAry[1].spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("pb3_showcard_oppo_1280");
    //             this.bmp_cardbackAry[2].spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("pb3_showcard_oppo_1280");
    //             this.bmp_cardbackAry[3].spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("pb3_showcard_oppo_1280");
    //             this.bmp_cardcolorAry[0].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
    //             this.bmp_cardcolorAry[1].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
    //             this.bmp_cardcolorAry[2].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
        ...
        if(BBMJ.ins.iclass.is2D()){
            ...
            switch(this.fixedType) {
                case enFixedCardType.FixedCardType_AGang: {
                    ...
                    this.bmp_cardbackAry[0].spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("shangdp_fan@2x");
                    this.bmp_cardbackAry[1].spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("shangdp_fan@2x");
                    this.bmp_cardbackAry[2].spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("shangdp_fan@2x");
                    this.bmp_cardbackAry[3].spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("shangdp_back@2x");
                    this.bmp_cardcolorAry[1].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                ...
                case enFixedCardType.FixedCardType_BGang: {
                    ...
                    // SetTextureRes(url,this.bmp_cardcolorAry[1]);
                    // SetTextureRes(url,this.bmp_cardcolorAry[2]);
                    this.bmp_cardbackAry[0].spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("shangdp_back@2x");
                    this.bmp_cardbackAry[1].spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("shangdp_back@2x");
                    this.bmp_cardbackAry[2].spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("shangdp_back@2x");
                    this.bmp_cardbackAry[3].spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("shangdp_back@2x");
                    this.bmp_cardcolorAry[0].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                    this.bmp_cardcolorAry[1].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                    this.bmp_cardcolorAry[2].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
            ...
            switch(this.fixedType) {
                case enFixedCardType.FixedCardType_AGang: {
                    ...
                    // this.bmp_cardbackAry[0].spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("pb3_backcard_self_1280");
                    // this.bmp_cardbackAry[1].spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("pb3_backcard_self_1280");
                    // this.bmp_cardbackAry[2].spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("pb3_backcard_self_1280");
                    // this.bmp_cardbackAry[3].spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("pb3_showcard_self_1280");
                    // this.bmp_cardcolorAry[1].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                    // this.bmp_cardcolorAry[1].node.y = 30;
                    
                    if(this._cardIndex==1){
                        this.bmp_cardbackAry[0].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_top_bm_bg_03");
                        this.bmp_cardbackAry[1].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_top_bm_bg_02");
                        this.bmp_cardbackAry[2].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_top_bm_bg_01");
                        this.bmp_cardbackAry[3].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_top_mj_bg_02");
                        this.bmp_cardcolorAry[1].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                    }else if(this._cardIndex==2){
                        this.bmp_cardbackAry[0].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_top_bm_bg_06");
                        this.bmp_cardbackAry[1].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_top_bm_bg_05");
                        this.bmp_cardbackAry[2].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_top_bm_bg_04");
                        this.bmp_cardbackAry[3].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_top_mj_bg_05");
                        this.bmp_cardcolorAry[1].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                    }else if(this._cardIndex==3){
                        this.bmp_cardbackAry[0].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_top_bm_bg_06");
                        this.bmp_cardbackAry[1].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_top_bm_bg_07");
                        this.bmp_cardbackAry[2].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_top_bm_bg_07");
                        this.bmp_cardbackAry[3].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_top_mj_bg_07");
                        this.bmp_cardcolorAry[1].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                    }else if(this._cardIndex==4){
                        this.bmp_cardbackAry[0].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_top_bm_bg_03");
                        this.bmp_cardbackAry[1].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_top_bm_bg_04");
                        this.bmp_cardbackAry[2].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_top_bm_bg_05");
                        this.bmp_cardbackAry[3].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_top_mj_bg_04");
                        this.bmp_cardcolorAry[1].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                    }else{
                ...
                case enFixedCardType.FixedCardType_BGang: {
                    ...
                    // // SetTextureRes(url,this.bmp_cardcolorAry[1]);
                    // // SetTextureRes(url,this.bmp_cardcolorAry[2]);
                    // this.bmp_cardbackAry[0].spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("pb3_showcard_self_1280");
                    // this.bmp_cardbackAry[1].spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("pb3_showcard_self_1280");
                    // this.bmp_cardbackAry[2].spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("pb3_showcard_self_1280");
                    // this.bmp_cardbackAry[3].spriteFrame=BBMJ.ins.iclass.getMahjongPaiBeiRes("pb3_showcard_self_1280");
                    // this.bmp_cardcolorAry[0].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                    // this.bmp_cardcolorAry[1].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                    // this.bmp_cardcolorAry[2].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                    ...
                    // this.bmp_cardcolorAry[1].node.y = 30;
                    if(this._cardIndex==1){
                        this.bmp_cardbackAry[0].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_top_mj_bg_03");
                        this.bmp_cardbackAry[1].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_top_mj_bg_02");
                        this.bmp_cardbackAry[2].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_top_mj_bg_01");
                        this.bmp_cardbackAry[3].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_top_mj_bg_02");
                        this.bmp_cardcolorAry[0].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[1].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[2].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                    }else if(this._cardIndex==2){
                        this.bmp_cardbackAry[0].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_top_mj_bg_06");
                        this.bmp_cardbackAry[1].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_top_mj_bg_05");
                        this.bmp_cardbackAry[2].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_top_mj_bg_04");
                        this.bmp_cardbackAry[3].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_top_mj_bg_05");
                        this.bmp_cardcolorAry[0].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[1].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[2].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        ...
                        this.bmp_cardbackAry[0].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_top_mj_bg_06");
                        this.bmp_cardbackAry[1].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_top_mj_bg_07");
                        this.bmp_cardbackAry[2].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_top_mj_bg_07");
                        this.bmp_cardbackAry[3].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_top_mj_bg_07");
                        this.bmp_cardcolorAry[0].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[1].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[2].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        ...
                        this.bmp_cardbackAry[0].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_top_mj_bg_03");
                        this.bmp_cardbackAry[1].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_top_mj_bg_04");
                        this.bmp_cardbackAry[2].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_top_mj_bg_05");
                        this.bmp_cardbackAry[3].spriteFrame=BBMJ.ins.iclass.getMahjong3DPaiBeiRes("d_top_mj_bg_04");
                        this.bmp_cardcolorAry[0].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[1].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[2].spriteFrame=BBMJ.ins.iclass.getMahjongPaiHuaRes(this.cardValue);
    ...
    private set3DSize(){
        ...
        switch(this._cardIndex){
            case 1:{
                ...
                this.bmp_cardbackAry[2].node.zIndex = (1);
                this.bmp_cardbackAry[2].node.scaleX=1;
                ...
                this.bmp_cardbackAry[1].node.zIndex = (2);
                this.bmp_cardbackAry[1].node.scaleX=1;
                ...
                this.bmp_cardbackAry[0].node.zIndex = (3);
                this.bmp_cardbackAry[0].node.scaleX=1;
                ...
                this.bmp_cardcolorAry[2].node.zIndex = (4);
                ...
                this.bmp_cardbackAry[3].node.zIndex = (5);
                this.bmp_cardbackAry[3].node.scaleX=1;
                ...
                this.bmp_cardcolorAry[0].node.zIndex = (6);
                ...
                this.bmp_cardcolorAry[1].node.zIndex = (7);
            ...
            case 3:{
                ...
                this.bmp_cardbackAry[0].node.width=48;
                this.bmp_cardbackAry[0].node.height=56;
                this.bmp_cardbackAry[0].node.zIndex = (1);
                this.bmp_cardbackAry[0].node.scaleX=-1;
                ...
                this.bmp_cardbackAry[2].node.height=56;
                this.bmp_cardbackAry[2].node.zIndex = (2);
                this.bmp_cardbackAry[2].node.scaleX=1;
                ...
                this.bmp_cardbackAry[1].node.height=56;
                this.bmp_cardbackAry[1].node.zIndex = (3);
                this.bmp_cardbackAry[1].node.scaleX=-1;
            ...
            case 4:{
                ...
                this.bmp_cardbackAry[2].node.height=56;
                this.bmp_cardbackAry[2].node.zIndex = (3);
                this.bmp_cardbackAry[2].node.scaleX=-1;
                ...
                this.bmp_cardcolorAry[0].node.zIndex = (4);
                ...
                this.bmp_cardcolorAry[1].node.zIndex = (6);
                ...
                this.bmp_cardcolorAry[2].node.zIndex = (7);
        ...
        this.bmp_cardHideAry[0].node.zIndex = (8);
        this.bmp_cardHideAry[1].node.zIndex = (9);
        this.bmp_cardHideAry[2].node.zIndex = (10);
