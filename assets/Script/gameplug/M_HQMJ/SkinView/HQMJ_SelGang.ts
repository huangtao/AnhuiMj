...
@ccclass
export default class HQMJ_SelGang extends cc.Component {
     ...
     */
    private Gang_1(){
        // this.btn_gang_0.node.dispatchEvent(new HQMJEvent(HQMJEvent.msg_gangCard, this._gangCard[0]));
        M_HQMJClass.ins.OnGangSel(this._gangCard[0]);
        this.node.active = false;
    }
     ...
     */
    private Gang_2(){
        // this.btn_gang_1.node.dispatchEvent(new HQMJEvent(HQMJEvent.msg_gangCard, this._gangCard[1]));
        M_HQMJClass.ins.OnGangSel(this._gangCard[1]);
        this.node.active = false;
    }
     ...
     */
    private Gang_3(){
        // this.btn_gang_0.node.dispatchEvent(new HQMJEvent(HQMJEvent.msg_gangCard, this._gangCard[2]));
        M_HQMJClass.ins.OnGangSel(this._gangCard[2]);
        this.node.active = false;
    }
    ...
    public showGang(gangCard: Array<number>): void {
        ...
        for (var i: number = 0; i < gangCard.length; i++) {
            if (HQMJMahjongDef.gInvalidMahjongValue != gangCard[i]) {
        ...
        if(2 == this._gangCard.length){
            ...
            for(var i:number = 0;i<4;i++){
                this.img_0[i].spriteFrame = HQMJ.ins.iclass.getMahjongPaiHuaResOut(this._gangCard[0]);
                this.img_1[i].spriteFrame = HQMJ.ins.iclass.getMahjongPaiHuaResOut(this._gangCard[1]);
            }                  
        }
        if(3 == this._gangCard.length){
            ...
            for(var i:number = 0;i<4;i++){
                this.img_0[i].spriteFrame = HQMJ.ins.iclass.getMahjongPaiHuaResOut(this._gangCard[0]);
                this.img_1[i].spriteFrame = HQMJ.ins.iclass.getMahjongPaiHuaResOut(this._gangCard[1]);
                this.img_2[i].spriteFrame = HQMJ.ins.iclass.getMahjongPaiHuaResOut(this._gangCard[2]);
            }
        }
        ...
        //     if(3 == this._gangCard.length){
        //         // url=HQMJ.ins.iclass.getMahjongResName(this._gangCard[2]);
        //         // SetTextureRes(url,this.img_2);
        //    //     this.img_2.spriteFrame=HQMJ.ins.iclass.getMahjongPaiHuaResOut(this._gangCard[2]);
        //     }
        //    // this.img_0.spriteFrame=HQMJ.ins.iclass.getMahjongPaiHuaResOut(this._gangCard[0]);

        //    // this.img_1.spriteFrame=HQMJ.ins.iclass.getMahjongPaiHuaResOut(this._gangCard[1]);
        //     this.node.active = true;
        // }
    }
}
