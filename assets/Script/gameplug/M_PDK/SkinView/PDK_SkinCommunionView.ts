...
import SkinChatBox from "./PDK_SkinChatBox";
import SkinVoicePlay from "./PDK_SkinVoicePlay";
...
export default class SkinCommunionView extends cc.Component {
    ...
    onLoad() {
        this.skinChatBox = new Array(MaxPlayerCount);
        ...
        this.skinVoicePlay = new Array(MaxPlayerCount);
