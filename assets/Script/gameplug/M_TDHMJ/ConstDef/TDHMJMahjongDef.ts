...
const { ccclass, property } = cc._decorator;
    ...
    export interface ITDHMJClass {
        ...
        getTableConfig():TDHMJTableConfig;
    ...
    export class TDHMJ{
        ...
        private static _ins:TDHMJ=null;
        private _icalss:ITDHMJClass=null;
        private _iview:ITDHMJView=null;
         ...
         * 静态单例
         * */
        public static get ins():TDHMJ{
            if(null == TDHMJ._ins){
                TDHMJ._ins = new TDHMJ();
            }
            return TDHMJ._ins;
        }
         ...
         * 逻辑
         * */
        public get iclass():ITDHMJClass{
            return this._icalss;
        }
        public set iclass(value:ITDHMJClass){
            this._icalss = value;
        }
         ...
         * 视图
         * */
        public get iview():ITDHMJView{
            return this._iview;
        }
        public set iview(value:ITDHMJView){
            this._iview = value;
        }
    }


	export class TDHMJMahjongDef {

        public static gameID:number=108;
        /// <summary>
        /// 花色掩码
        /// </summary>
    ...
    export class TDHMJTableConfig{
        ...
        public constructor(){    
            ...
            this._tableCreatorChair = TDHMJMahjongDef.gInvalidChar;
            this._tableCode = "";
            this._setGameNum=1;
        ...
        public get cellScore():number{
            if(TDHMJ.ins.iclass.isCreateRoom()){
                return this._cellScore;
                       ...
                       if(TDHMJ.ins.iclass.getRoomData()){
                return TDHMJ.ins.iclass.getRoomData().BaseMoney;
            }
            else{
    ...
    export class TDHMJTimer{
        ...
        public clear():void{
            ...
            this._curTime=0;
            this._triggerTime=0;
            this._chair = TDHMJMahjongDef.gInvalidChar;
     ...
     * 合肥麻将打牌玩家
     * */
    export class TDHMJOutCardPlayer{
        private _chair:number;
         ...
         * */
        public get isValid():boolean{
            if((TDHMJMahjongDef.gInvalidChar != this._chair) && (TDHMJMahjongDef.gInvalidMahjongValue != this._card)){
                return true;
            }
            return false;
        }
        ...
        public clear():void{
            this._chair = TDHMJMahjongDef.gInvalidChar;
            this._card = TDHMJMahjongDef.gInvalidMahjongValue;
        }
    }
    ...
    export class TDHMJRecordCard{
        ...
        public getCardLeftNum(card:number,checkAry:Array<number> = null):number{
            var logicValue: number = TDHMJMahjongAlgorithm.GetMahjongLogicValue(card);
    ...
    export class clsParseTriple
    {
        ...
        public Clear():void
        {
            this.cTokenCard = TDHMJMahjongDef.gInvalidMahjongValue;
        ...
        public GetTokenNum():number
        {
            ...
            return (wBaseNum + TDHMJMahjongAlgorithm.GetMahjongLogicValue(this.cTokenCard));
        }
        ...
        public get isValid():boolean
        {
                if ((TDHMJMahjongDef.gInvalidMahjongValue != this.cTokenCard) && (enTripleType.TripleType_Unknown != this.enTripleType)){
                    return true;
                }
                return false;
        }
   ...
   /// <summary>
    ...
    export class clsNormalParseStruct
    {
        ...
        public Clear():void
        {
            this.pair = TDHMJMahjongDef.gInvalidMahjongValue;
        ...
        public get isValid():boolean
        {
            ...
            return this.pair != TDHMJMahjongDef.gInvalidMahjongValue;
    ...
    export class clsParseResult
    {
        ...
        public Clear():void
        {
            this.isValid = false;
            this.is7Pair = false;
            this.huCard = TDHMJMahjongDef.gInvalidMahjongValue;
    ...
    export class clsSingleFixedCard
    {
	    ...
	    public Clear():void
	    {
            this.card = TDHMJMahjongDef.gInvalidMahjongValue;
    ...
    export class clsPairTripleWrapper
    {
        ...
        public Clear():void
        {
            this.cPair = TDHMJMahjongDef.gInvalidMahjongValue;
            this.wTripleCount = 0;
