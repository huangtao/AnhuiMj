...
export default class LHZMJEvent extends cc.Event.EventCustom {


    /**
         * 消息标识
         * */
        public static LHZMJ_EVENT_TYPE: string = "event_hnmj_event_type";
        ...
        public constructor(msgCode: number,parm?: any,data?: any) {
            ...
            super(LHZMJEvent.LHZMJ_EVENT_TYPE,true);
         ...
         * 克隆一个
         * */
        public clone(): LHZMJEvent {
            return new LHZMJEvent(this._msgCode,this._parm,this.getUserData());
        }
}
